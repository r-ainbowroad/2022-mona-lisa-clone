...
`
    ...
    selectColor(e) {
      ...
      if (!n) return;
      const i = parseInt(n);
      isFinite(i) && this.dispatchEvent(g("select-color", { color: i }));
    }
    renderContent() {
      var e, t;
      const n =
        ...
        null == r
          ...
          : r.map((e) => {
              ...
              return le` <div class="color-container" style="${Xu({
                ...
                e.index
              }" @click="${this.selectColor}"> <div style="${Xu({
...
`
  ...
  //# sourceMappingURL=index-1328023a.js.map
}
/*
     FILE ARCHIVED ON 21:30:29 Apr 03, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 04:14:07 Aug 21, 2022.
...
/*
playback timings (ms):
  captures_list: 417.591
  exclusion.robots: 321.551
  exclusion.robots.policy: 321.541
  xauthn.identify: 63.41
  xauthn.chkprivs: 257.866
  cdx.remote: 0.066
  esindex: 0.008
  LoadShardBlock: 59.267 (3)
  PetaboxLoader3.datanode: 58.012 (4)
  CDXLines.iter: 12.303 (3)
  load_resource: 80.163
  PetaboxLoader3.resolve: 34.975
*/
