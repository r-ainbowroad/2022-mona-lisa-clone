...
}
{
  ...
  class B extends HTMLElement {
    ...
    requestUpdate(e, t, n) {
      let i = !0;
      void 0 !== e &&
        (((n = n || this.constructor.getPropertyOptions(e)).hasChanged || q)(
          this[e],
          t
        )
  ...
  class me {
    constructor({ strings: e, _$litType$: t }, n) {
      ...
      const s = e.length - 1,
        ...
        [c, l] = ((e, t) => {
          ...
          for (let t = 0; t < n; t++) {
            ...
            for (
              ;
              u < n.length && ((s.lastIndex = u), (c = s.exec(n)), null !== c);
            ...
            o +=
              s === te
                ? n + Y
                : l >= 0
                ? (i.push(a), n.slice(0, l) + "$lit$" + n.slice(l) + W + h)
      ...
      if (
        ((this.el = me.createElement(c, n)),
        (ve.currentNode = this.el.content),
        2 === t)
      ) {
      ...
      for (; null !== (i = ve.nextNode()) && a.length < s; ) {
        if (1 === i.nodeType) {
          ...
          if (i.data === K) a.push({ type: 2, index: r });
            ...
            let e = -1;
            for (; -1 !== (e = i.data.indexOf(W, e + 1)); )
              a.push({ type: 7, index: r }), (e += W.length - 1);
          }
        r++;
      }
    }
    ...
    return (
      (null == c ? void 0 : c.constructor) !== l &&
        ...
        void 0 !== i
          ...
          : (n._$Cu = c)),
      void 0 !== c && (t = ye(e, c._$AS(e, t.values), c, i)),
      t
    );
  }
  class ge {
  ...
  class be {
    ...
    $(e) {
      this._$AH !== de && Z(this._$AH)
        ? (this._$AA.nextSibling.data = e)
        : this.S(J.createTextNode(e)),
        (this._$AH = e);
    }
    T(e) {
      var t;
      const { values: n, _$litType$: i } = e,
        r =
          "number" == typeof i
            ? this._$AC(e)
            : (void 0 === i.el && (i.el = me.createElement(i.h, this.options)),
              i);
    ...
    A(e) {
      ...
      for (const r of e)
        i === t.length
          ? t.push((n = new be(this.M(X()), this.M(X()), this, this.options)))
          : (n = t[i]),
          n._$AI(r),
          i++;
  ...
  class Ee extends we {
    ...
    k(e) {
      e && e !== de
        ? this.element.setAttribute(this.name, _e)
        : this.element.removeAttribute(this.name);
    }
  }
  class Se extends we {
    ...
    _$AI(e, t = this) {
      var n;
      if (
        (e = null !== (n = ye(this, e, t, 0)) && void 0 !== n ? n : de) === he
      )
        return;
      const i = this._$AH,
        r =
  ...
  var Ce, Oe;
  null == Te || Te(me, be),
    (null !== (Q = globalThis.litHtmlVersions) && void 0 !== Q
      ? Q
  ...
  class Ae extends B {
    ...
    update(e) {
      ...
      this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
        super.update(e),
        (this._$Dt = fe(t, this.renderRoot, this.renderOptions));
    }
    connectedCallback() {
      var e;
  ...
  (Ae.finalized = !0),
    (Ae._$litElement$ = !0),
    null === (Ce = globalThis.litElementHydrateSupport) ||
      void 0 === Ce ||
      Ce.call(globalThis, { LitElement: Ae });
  const Ie = globalThis.litElementPolyfillSupport;
  null == Ie || Ie({ LitElement: Ae }),
  ...
  let Pe = class extends (function (e) {
    ...
    class n extends e {
      constructor(...e) {
        super(...e),
          (this._alertReporterHandleRegister = (e) => {
          ...
          (this._alertReporterHandleAlert = (e) => {
            ...
            if (n)
              for (const i of n)
                if (i.shouldDisplayAlert(t))
                  return e.stopImmediatePropagation(), void i.displayAlert(t);
          }),
      ...
      connectedCallback() {
        super.connectedCallback && super.connectedCallback(),
          this.addEventListener(
            "_faceplate-register-alert-display",
            this._alertReporterHandleRegister
          ),
          this.addEventListener(
            "faceplate-alert",
            this._alertReporterHandleAlert
          );
      }
      disconnectedCallback() {
  ...
  const Ne = (function (e) {
    ...
    class t extends e {
      constructor() {
        super(...arguments),
          (this.csrfProviderToken = ""),
          (this._csrfManagerHandleRequest = (e) => {
      ...
      connectedCallback() {
        super.connectedCallback && super.connectedCallback(),
          this.addEventListener(
            "faceplate-request",
            this._csrfManagerHandleRequest
          ),
          this.addEventListener(
            "faceplate-update-csrf",
            this._csrfManagerHandleUpdateCsrf
          );
      }
      disconnectedCallback() {
        super.disconnectedCallback && super.disconnectedCallback(),
  ...
  r([u({ type: String, noAccessor: !0 })], Re.prototype, "token", void 0),
    (Re = r([c("faceplate-csrf-provider")], Re));
  class Le {
    constructor(e, t) {
    ...
    define(e, t, n) {
      ...
      if (
        (n ? this._events.set(e, [t, n]) : this._events.set(e, t),
        this._isConnected)
      ) {
  ...
  let Fe = class extends Ae {
    constructor() {
      super(...arguments),
        ...
        (this.dismissable = !1),
        (this.fading = !1),
        (this._events = new Le(this)),
        (this._onAnimationEnd = this._events.define("transitionend", () => {
          if (this.fading) {
    ...
    render() {
      return le` ${
        this.dismissable
          ? le` <icon-close fill @click="${this._handleDismiss}" @keydown="${this._handleDismissKey}" tabindex="0" role="button" aria-pressed="false">X</icon-close> `
          : void 0
      } <slot></slot> `;
    }
  };
  r([u({ type: String, reflect: !0 })], Fe.prototype, "level", void 0),
    r([u({ type: Boolean, reflect: !0 })], Fe.prototype, "dismissable", void 0),
    r([u({ type: Boolean, reflect: !0 })], Fe.prototype, "fading", void 0),
    (Fe = r([c("faceplate-toast")], Fe));
  class je {
    constructor(e, t) {
      (this._batchTimer = 0),
        (this._batchDisplay = () => {
          if (
            ((this._batchTimer = 0),
            !this._batchQueue || !this._batchQueue.length)
          )
            return;
          const e = (function (e, t = O) {
            ...
            e.sort(
              (e, t) =>
                (void 0 === e.level ? b.none : e.level) -
                (void 0 === t.level ? b.none : t.level)
            );
            let i = {},
              r = e[0].level,
              o = 0;
    ...
    hostDisconnected() {
      this._reporter &&
        (E.unregister(this._reporter, this), (this._reporter = void 0)),
  ...
  let ze = class extends Ae {
    constructor() {
      super(...arguments),
        ...
        (this.min = b.error),
        (this.max = b.info),
        (this._alertsCtrl = new je(this, {
          batchWindow: 100,
          onAlert: (e) => {
            const { level: t } = e,
              n = (function (e, t) {
                const { level: n, name: i, message: r, count: o } = t,
                  s = document.createElement("faceplate-toast"),
                  a = o && o > 1 ? `(${o}) ` : "",
                  c = i ? le` <strong>${i}</strong><br> ` : "";
  ...
  r(
    [u({ type: String, reflect: !0, attribute: "aria-live" })],
    ze.prototype,
    "ariaLive",
    void 0
  ),
    r([u({ attribute: "min", converter: C })], ze.prototype, "min", void 0),
    r([u({ attribute: "max", converter: C })], ze.prototype, "max", void 0),
    (ze = r([c("faceplate-toaster")], ze));
  const qe = (e) => {
    const t = {
      state: e,
      listeners: [],
      ...
      updateState: (e) => {
        t.state !== e &&
          ((t.state = e), t.listeners.forEach((e) => e.requestUpdate()));
      },
      subscribe: (e) => (
  ...
  function Ge() {
    return { min: nt.getState() ? Be.FarOut : Be.Min, max: Be.Max };
  }
  function We() {
    const e = st.getState();
    return (e / 10).toFixed(e >= 1 ? 1 : 2).replace(/\.0$/, "");
  }
  !(function (e) {
    (e.CX = "cx"),
      (e.CY = "cy"),
    ...
    (function (e) {
      (e[(e.FarOut = 0.1)] = "FarOut"),
        (e[(e.Min = 1)] = "Min"),
        (e[(e.Optimal = 20)] = "Optimal"),
        (e[(e.Max = 50)] = "Max");
    })(Be || (Be = {}));
  const Ke = qe({ camera: !1, canvas: !1, cooldown: !1 });
  function Ye() {
    return Object.values(Ke.getState()).every((e) => e);
  }
  const Je = qe(He().fullscreen),
    Xe = qe(!1),
    Ze = qe(!1),
    et = qe(null),
    tt = qe(null),
  ...
  const vt = (e, t) => new ft(e, t),
    mt = (e, t) => navigator.sendBeacon(e, t),
    yt = (e, t) =>
      fetch(e, {
        body: t,
  ...
  function _t() {
    (wt = []), bt && clearTimeout(bt), (bt = void 0);
  }
  function Et(e) {
    var t, n;
    if ("number" == typeof e)
      return null ===
        (n =
          null === (t = ct.getState()) || void 0 === t
            ? void 0
            : t.colorPalette.colors.find((t) => t.index === e)) || void 0 === n
        ? void 0
        : n.hex;
  }
  const St = {
  ...
  function Mt(e) {
    return "string" == typeof e && It.test(e);
  }
  for (var Pt = [], Dt = 0; Dt < 256; ++Dt)
    Pt.push((Dt + 256).toString(16).substr(1));
  function Nt(e, t, n) {
    ...
    return (function (e) {
      ...
      if (!Mt(n)) throw TypeError("Stringified UUID is invalid");
      return n;
    })(i);
  }
  var Rt =
  ...
  class Ut extends Vt {
    ...
    close() {
      this.sendMessage($t.Close);
    }
    refreshAuth() {
      this.sendMessage($t.RefreshAuth);
    }
    signIn() {
      this.sendMessage($t.SignIn);
    }
    share(e) {
      this.sendMessage(
        JSON.stringify({
    ...
    openProfile({ profileName: e }) {
      this.sendMessage(JSON.stringify({ type: $t.OpenProfile, userName: e }));
    }
  }
  class Bt extends Vt {
    sendMessage(e) {
      const t = (function () {
        const e =
            parent !== window ? document.referrer : document.location.origin,
    ...
    close() {
      this.sendMessage({ type: $t.Close });
    }
    refreshAuth() {
      this.sendMessage({ type: $t.RefreshAuth });
    }
    signIn(e) {
      this.sendMessage({ type: $t.SignIn, dest: e });
    }
    syncCoordinates(e) {
      this.sendMessage({ type: $t.SyncCoordinates, data: e });
    }
    openProfile(e) {
      this.sendMessage({ type: $t.OpenProfile, data: e });
    }
  }
  function Qt() {
    return !!window.hot_potato_native;
  ...
  const Kt = () => {
      const e = jt.get("session_tracker"),
        { domain: t, url: n } = Jt();
    ...
    Zt = ({ source: e, action: t, noun: n }, r = {}) =>
      Object.assign(
        Object.assign(
          { source: e, action: t, noun: n, uuid: Nt(), request: Xt() },
          (() => {
            const e = tt.getState() || {},
              { app: t } = e,
              n = i(e, ["app"]);
            return Object.assign(Object.assign({}, n), {
              ...
              referrer: n.referrer || Jt(),
              session: n.session || Kt(),
              user: n.user || Yt(),
            });
          })()
        ),
  ...
  const rn = Symbol("mixins/with-tracking");
  function on(e) {
    if (rn in e) return e;
    class t extends e {
      constructor() {
        super(...arguments),
          (this.trackEvent = (e) => {
            const t = g("track-event", { details: e });
  ...
  const sn = R`:host{display:inline-block;fill:currentColor;vertical-align:middle;line-height:1em}svg{fill:currentColor;height:1em;width:auto}`;
  function an(e, t, n, i = sn) {
    if (n) {
      class o extends Ae {
        constructor() {
      ...
      r([u({ type: Boolean })], o.prototype, "fill", void 0),
  ...
  an(
    "icon-meme",
    ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M20.125 6.875h-1V1.4a1.125 1.125 0 00-1.716-.961L13.421 2.9a11.408 11.408 0 00-6.842 0L2.592.44a1.125 1.125 0 00-1.717.96v7.007A6.969 6.969 0 00.375 11a7.5 7.5 0 002.86 5.783A10.55 10.55 0 0010 19.125a10.55 10.55 0 006.765-2.342 7.668 7.668 0 002.758-4.658h.6zm-13.7-2.6l.282-.1a10.118 10.118 0 016.584 0l.282.1 4.3-2.656v5.256h-5v1h-1.75v-1H3.875v1H2.082l.043-6.254zm9.538 11.546A9.3 9.3 0 0110 17.875a9.3 9.3 0 01-5.964-2.052A6.272 6.272 0 011.625 11a5.717 5.717 0 01.323-1.875h1.927v3h7.25v-3h1.75v3h5.38a6.5 6.5 0 01-2.291 3.698z"/><path d="M6.6 13.554l-.874.893A6.127 6.127 0 0010 16.125a6.458 6.458 0 001.661-.215l-.322-1.21A5.1 5.1 0 016.6 13.554z"/></svg>`,
    ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M3.875 7.875v-1h7.25v1h1.75v-1h6.25V1.4a1.125 1.125 0 00-1.716-.961L13.421 2.9a11.408 11.408 0 00-6.842 0L2.592.44a1.125 1.125 0 00-1.717.96v6.475zM12.875 12.125v-3h-1.75v3h-7.25v-3H.636A6.939 6.939 0 00.375 11a7.5 7.5 0 002.86 5.783A10.55 10.55 0 0010 19.125a10.55 10.55 0 006.765-2.342 7.668 7.668 0 002.758-4.658zm-2.875 4a6.127 6.127 0 01-4.27-1.678l.874-.893a5.1 5.1 0 004.735 1.146l.322 1.208a6.458 6.458 0 01-1.661.217z"/></svg>`
  );
  const cn = on(Ae);
  let ln = class extends cn {
    constructor() {
      super(),
        (this.debug = !1),
        (this.routeName = ""),
        (this.isFullScreen = vt(this, Je)),
        (this._events = new Le(this)),
        ...
        (this._onPageHide = () => {
          !(function (e) {
            ...
            Zt(
              { source: en.Global, action: tn.Left, noun: nn.Screen },
              { action_info: { page_type: "place_editor" } }
            ),
          ]);
        }),
        vt(this, Ke);
...
`
    ...
    updated(e) {
      this.isFullScreen.state() &&
        ...
        this.trackEvent(
          Zt(
            { source: en.Global, action: tn.View, noun: nn.Screen },
            { action_info: { page_type: "place_editor" } }
          )
        ),
        super.updated(e);
  ...
  function un(e, t, n, i) {
    ...
    function c() {
      ...
      o ||
        ...
        void 0 === i && d > e
          ? p()
          : !0 !== t && (r = setTimeout(i ? f : p, void 0 === i ? e - d : e)));
    }
    return (
  ...
  function hn(e, t, n) {
    return void 0 === n ? un(e, t, !1) : un(e, n, !1 !== t);
  }
  r([u({ type: Boolean })], ln.prototype, "debug", void 0),
    r([u({ type: String })], ln.prototype, "routeName", void 0),
    (ln = r([c("mona-lisa-app")], ln)),
    Object.freeze({ shouldBindMethod: !1, useCapture: !1, useShadowRoot: !1 }),
    Object.freeze({ shouldBindMethod: !1, useCapture: !0, useShadowRoot: !1 });
  const dn = Symbol("mixins/events");
  const pn = (e) => (null != e ? e : de);
  function fn(...e) {
    Xe.getState() && console.info(e);
  }
  function vn(e, t, ...n) {
    console.error(e, t, ...n),
      t instanceof Error
    ...
    class extends bn {
      ...
      update(e, [t]) {
        ...
        if (void 0 === this.st) {
          ...
          for (const e in t)
            t[e] &&
              !(null === (n = this.et) || void 0 === n ? void 0 : n.has(e)) &&
              this.st.add(e);
          return this.render(t);
        }
        ...
        for (const e in t) {
          ...
          n === this.st.has(e) ||
            ...
            (n ? (r.add(e), this.st.add(e)) : (r.remove(e), this.st.delete(e)));
        }
        return he;
      }
    }
  ...
  r([u({ type: Number })], _n.prototype, "size", void 0),
    (_n = r([c("mona-lisa-loader")], _n));
  var En;
  !(function (e) {
    (e.Auth = "auth"),
      (e.GameOver = "gameOver"),
...
`
    ...
    reload() {
      const e = new URL(location.href);
      Je.getState()
        ? e.searchParams.set(Ue.FullScreen, "")
        : e.searchParams.delete(Ue.FullScreen),
        (location.href = e.toString());
    }
    render() {
      return this.type === En.GameOver
        ? le` <div> <h3> Oops, something went wrong. </h3> <div class="reload"> Press <mona-lisa-icon-button @click="${this.reload}"><icon-refresh></icon-refresh></mona-lisa-icon-button> to reload the page. </div> </div> `
        : this.type === En.Init || this.type === En.Auth
        ? le`<mona-lisa-loader size="${128}"></mona-lisa-loader>`
        : this.type === En.Sync
        ? le` <div> <h1> Sychronizing configuration </h1> <div class="gears"> <icon-settings></icon-settings> <div class="second-gear"><icon-settings></icon-settings></div> </div> </div> `
        : "";
    }
  };
  r([u({ type: String })], Sn.prototype, "type", void 0),
    (Sn = r([c("mona-lisa-overlay")], Sn));
  var kn = Object.setPrototypeOf,
    Tn =
      void 0 === kn
        ? function (e, t) {
  ...
  var An = ["debug", "log", "warn", "error", "silent"],
    In = An.indexOf("log");
  function Mn(e) {
    return function () {
      if (An.indexOf(e) >= In) {
  ...
  var Dn =
      ...
      Pn(function () {
        return Pn.constructor("return this")();
      }),
    Nn = "__",
    Rn = [Nn, Nn].join("DEV");
  var Ln = (function () {
  ...
  !jn ||
    ...
    (Object.defineProperty(jn, "process", {
  ...
  function Bn(e) {
    return Qn(e.source, Un(e.source, e.start));
  }
  function Qn(e, t) {
    ...
    if (h.length > 120) {
      for (
        var d = Math.floor(c / 80), p = c % 80, f = [], v = 0;
        v < h.length;
        v += 80
      )
        f.push(h.slice(v, v + 80));
      return (
        l +
        Hn(
          [["".concat(s), f[0]]].concat(
  ...
  function Yn(e, t) {
    return !t || ("object" !== Wn(t) && "function" != typeof t) ? Jn(e) : t;
  }
  function Jn(e) {
    if (void 0 === e)
  ...
  function Xn(e) {
    ...
    return (
      (Xn = function (e) {
        ...
        function i() {
          return Zn(e, arguments, ni(this).constructor);
        }
        return (
  ...
  var ii = (function (e) {
    ...
    function a(e, t, n, i, r, o, c) {
      ...
      !m &&
        v &&
        (m = null === (f = v[0].loc) || void 0 === f ? void 0 : f.source);
      var y,
        g = i;
      !g &&
        v &&
        ...
        i && n
          ...
          : v &&
            (y = v.reduce(function (e, t) {
              return t.loc && e.push(Un(t.loc.source, t.loc.start)), e;
            }, []));
      var b,
        w = c;
      if (null == w && null != o) {
        var x = o.extensions;
        "object" == Vn((b = x)) && null !== b && (w = x);
      }
      return (
        Object.defineProperties(Jn(p), {
          ...
          positions: { value: null !== (h = g) && void 0 !== h ? h : void 0 },
        ...
        null != o && o.stack
          ? (Object.defineProperty(Jn(p), "stack", {
              value: o.stack,
              writable: !0,
              configurable: !0,
            }),
          ...
          : (Error.captureStackTrace
              ? Error.captureStackTrace(Jn(p), a)
              : Object.defineProperty(Jn(p), "stack", {
                  value: Error().stack,
                  writable: !0,
                  configurable: !0,
  ...
  function ri(e, t, n) {
    return new ii("Syntax Error: ".concat(n), void 0, e, [t]);
  }
      ...
      case "object":
        return null === e
          ...
          : (function (e, t) {
              ...
              if (void 0 !== i) {
                var r = i.call(e);
                if (r !== e) return "string" == typeof r ? r : fi(r, n);
      ...
      var t =
        ...
        n =
          arguments.length > 2 && void 0 !== arguments[2]
            ...
            : { line: 1, column: 1 };
      "string" == typeof e ||
        vi(0, "Body must be a string. Received: ".concat(pi(e), ".")),
        (this.body = e),
        (this.name = t),
        (this.locationOffset = n),
        this.locationOffset.line > 0 ||
          vi(0, "line in locationOffset is 1-indexed and must be positive."),
        this.locationOffset.column > 0 ||
          vi(0, "column in locationOffset is 1-indexed and must be positive.");
    }
    var t, n, i;
    return (
      (t = e),
  ...
  function wi(e) {
    ...
    for (var r = 0; r < t.length && xi(t[r]); ) ++r;
    for (var o = t.length; o > r && xi(t[o - 1]); ) --o;
  ...
  var _i = (function () {
    function e(e) {
      var t = new li(hi.SOF, 0, 0, 0, 0, null);
      (this.source = e),
        (this.lastToken = t),
        (this.token = t),
        (this.line = 1),
  ...
  function Si(e, t) {
    for (var n = e.source, i = n.body, r = i.length, o = t.end; o < r; ) {
      ...
      switch (s) {
        ...
        case 10:
          ...
          continue;
        case 13:
          10 === i.charCodeAt(o + 1) ? (o += 2) : ++o,
            ++e.line,
            (e.lineStart = o);
          continue;
        case 33:
          return new li(hi.BANG, o, o + 1, a, c, t);
        case 35:
          return Ti(n, o, a, c, t);
        case 36:
          return new li(hi.DOLLAR, o, o + 1, a, c, t);
        case 38:
          return new li(hi.AMP, o, o + 1, a, c, t);
        case 40:
          return new li(hi.PAREN_L, o, o + 1, a, c, t);
        case 41:
          return new li(hi.PAREN_R, o, o + 1, a, c, t);
        case 46:
          if (46 === i.charCodeAt(o + 1) && 46 === i.charCodeAt(o + 2))
            return new li(hi.SPREAD, o, o + 3, a, c, t);
          break;
        case 58:
          return new li(hi.COLON, o, o + 1, a, c, t);
        case 61:
          return new li(hi.EQUALS, o, o + 1, a, c, t);
        case 64:
          return new li(hi.AT, o, o + 1, a, c, t);
        case 91:
          return new li(hi.BRACKET_L, o, o + 1, a, c, t);
        case 93:
          return new li(hi.BRACKET_R, o, o + 1, a, c, t);
        case 123:
          return new li(hi.BRACE_L, o, o + 1, a, c, t);
        case 124:
          return new li(hi.PIPE, o, o + 1, a, c, t);
        case 125:
          return new li(hi.BRACE_R, o, o + 1, a, c, t);
        case 34:
    ...
    var l = e.line,
      u = 1 + o - e.lineStart;
    return new li(hi.EOF, r, r, l, u, t);
  }
  function ki(e) {
    return e < 32 && 9 !== e && 10 !== e && 13 !== e
      ? "Cannot contain the invalid character ".concat(Ei(e), ".")
      : 39 === e
      ? "Unexpected single quote character ('), did you mean to use a double quote (\")?"
      : "Cannot parse the unexpected character ".concat(Ei(e), ".");
  }
  function Ti(e, t, n, i, r) {
    ...
    return new li(hi.COMMENT, t, a, n, i, r, s.slice(t + 1, a));
  }
    ...
    if ((45 === a && (a = s.charCodeAt(++c)), 48 === a)) {
      if ((a = s.charCodeAt(++c)) >= 48 && a <= 57)
        throw ri(
          e,
          c,
          "Invalid number, unexpected digit after 0: ".concat(Ei(a), ".")
        );
    } else (c = Oi(e, c, a)), (a = s.charCodeAt(c));
    if (
      (46 === a &&
        ((l = !0),
        (a = s.charCodeAt(++c)),
      ...
      throw ri(
        e,
        c,
        "Invalid number, expected digit but got: ".concat(Ei(a), ".")
      );
    return new li(l ? hi.FLOAT : hi.INT, t, c, i, r, o, s.slice(t, c));
  }
  function Oi(e, t, n) {
    var i = e.body,
      r = t,
    ...
    throw ri(
      e,
      r,
      "Invalid number, expected digit but got: ".concat(Ei(o), ".")
    );
  }
  function Ai(e, t, n, i, r) {
    for (
      ...
      if (34 === c)
        return (l += o.slice(a, s)), new li(hi.STRING, t, s + 1, n, i, r, l);
      if (c < 32 && 9 !== c)
        throw ri(e, s, "Invalid character within String: ".concat(Ei(c), "."));
      if ((++s, 92 === c)) {
          ...
          case 117:
            ...
            if (u < 0) {
              ...
              throw ri(
                e,
                s,
                "Invalid character escape sequence: \\u".concat(h, ".")
              );
            }
    ...
    throw ri(e, s, "Unterminated string.");
  }
  function Ii(e, t, n, i, r, o) {
    for (
      var s = e.body, a = t + 3, c = a, l = 0, u = "";
      a < s.length && !isNaN((l = s.charCodeAt(a)));

    ) {
      if (34 === l && 34 === s.charCodeAt(a + 1) && 34 === s.charCodeAt(a + 2))
        return (
          (u += s.slice(c, a)),
          new li(hi.BLOCK_STRING, t, a + 3, n, i, r, wi(u))
        );
      if (l < 32 && 9 !== l && 10 !== l && 13 !== l)
        throw ri(e, a, "Invalid character within String: ".concat(Ei(l), "."));
      10 === l
    ...
    throw ri(e, a, "Unterminated string.");
  }
  function Mi(e, t, n, i) {
    return (Pi(e) << 12) | (Pi(t) << 8) | (Pi(n) << 4) | Pi(i);
  }
  function Pi(e) {
    return e >= 48 && e <= 57
      ? e - 48
  ...
  function Di(e, t, n, i, r) {
    for (
      ...
      ++a;
    return new li(hi.NAME, t, a, n, i, r, o.slice(t, a));
  }
  var Ni = (function () {
    function e(e, t) {
      var n = (function (e) {
        ...
        ? e
        : new gi(e);
      (this._lexer = new _i(n)), (this._options = t);
    }
    var t = e.prototype;
    return (
      (t.parseName = function () {
        var e = this.expectToken(hi.NAME);
        return { kind: oi.NAME, value: e.value, loc: this.loc(e) };
      }),
      (t.parseDocument = function () {
        var e = this._lexer.token;
        return {
          kind: oi.DOCUMENT,
          definitions: this.many(hi.SOF, this.parseDefinition, hi.EOF),
          loc: this.loc(e),
        };
      }),
      (t.parseDefinition = function () {
        if (this.peek(hi.NAME))
          ...
          if (this.peek(hi.BRACE_L)) return this.parseOperationDefinition();
      ...
      (t.parseOperationDefinition = function () {
        var e = this._lexer.token;
        if (this.peek(hi.BRACE_L))
          return {
            kind: oi.OPERATION_DEFINITION,
            operation: "query",
            name: void 0,
            variableDefinitions: [],
            directives: [],
        ...
        return (
          this.peek(hi.NAME) && (t = this.parseName()),
          {
            kind: oi.OPERATION_DEFINITION,
            operation: n,
            name: t,
      ...
      (t.parseVariableDefinition = function () {
        var e = this._lexer.token;
        return {
          kind: oi.VARIABLE_DEFINITION,
          variable: this.parseVariable(),
          type: (this.expectToken(hi.COLON), this.parseTypeReference()),
          defaultValue: this.expectOptionalToken(hi.EQUALS)
      ...
      (t.parseVariable = function () {
        var e = this._lexer.token;
        return (
          this.expectToken(hi.DOLLAR),
          { kind: oi.VARIABLE, name: this.parseName(), loc: this.loc(e) }
        );
      }),
      (t.parseSelectionSet = function () {
        var e = this._lexer.token;
        return {
          kind: oi.SELECTION_SET,
          selections: this.many(hi.BRACE_L, this.parseSelection, hi.BRACE_R),
          loc: this.loc(e),
        };
      }),
      (t.parseSelection = function () {
        return this.peek(hi.SPREAD) ? this.parseFragment() : this.parseField();
      }),
      (t.parseField = function () {
        var e,
          ...
          i = this.parseName();
        return (
          this.expectOptionalToken(hi.COLON)
            ...
            : (t = i),
          {
            ...
            directives: this.parseDirectives(!1),
            selectionSet: this.peek(hi.BRACE_L)
      ...
      (t.parseArguments = function (e) {
        ...
        return this.optionalMany(hi.PAREN_L, t, hi.PAREN_R);
      }),
      (t.parseArgument = function () {
        var e = this._lexer.token,
          t = this.parseName();
        return (
          this.expectToken(hi.COLON),
          {
            kind: oi.ARGUMENT,
            name: t,
      ...
      (t.parseConstArgument = function () {
        ...
        return {
          kind: oi.ARGUMENT,
          name: this.parseName(),
          value: (this.expectToken(hi.COLON), this.parseValueLiteral(!0)),
          loc: this.loc(e),
        };
      }),
      (t.parseFragment = function () {
        var e = this._lexer.token;
        this.expectToken(hi.SPREAD);
        var t = this.expectOptionalKeyword("on");
        return !t && this.peek(hi.NAME)
          ? {
              kind: oi.FRAGMENT_SPREAD,
              name: this.parseFragmentName(),
              directives: this.parseDirectives(!1),
              loc: this.loc(e),
            }
          : {
              kind: oi.INLINE_FRAGMENT,
      ...
      (t.parseValueLiteral = function (e) {
        ...
        switch (t.kind) {
          ...
          case hi.INT:
            return (
              this._lexer.advance(),
              { kind: oi.INT, value: t.value, loc: this.loc(t) }
            );
          case hi.FLOAT:
            return (
              this._lexer.advance(),
              { kind: oi.FLOAT, value: t.value, loc: this.loc(t) }
            );
          case hi.STRING:
          case hi.BLOCK_STRING:
            return this.parseStringLiteral();
          case hi.NAME:
            switch ((this._lexer.advance(), t.value)) {
              case "true":
                return { kind: oi.BOOLEAN, value: !0, loc: this.loc(t) };
              case "false":
                return { kind: oi.BOOLEAN, value: !1, loc: this.loc(t) };
              case "null":
                return { kind: oi.NULL, loc: this.loc(t) };
              default:
                return { kind: oi.ENUM, value: t.value, loc: this.loc(t) };
            }
          case hi.DOLLAR:
      ...
      (t.parseDirectives = function (e) {
        for (var t = []; this.peek(hi.AT); ) t.push(this.parseDirective(e));
        return t;
      }),
      (t.parseDirective = function (e) {
        var t = this._lexer.token;
        return (
          this.expectToken(hi.AT),
          {
            kind: oi.DIRECTIVE,
            name: this.parseName(),
      ...
      (t.parseTypeReference = function () {
        var e,
          t = this._lexer.token;
        return (
          this.expectOptionalToken(hi.BRACKET_L)
            ? ((e = this.parseTypeReference()),
              this.expectToken(hi.BRACKET_R),
              (e = { kind: oi.LIST_TYPE, type: e, loc: this.loc(t) }))
            : (e = this.parseNamedType()),
          this.expectOptionalToken(hi.BANG)
            ? { kind: oi.NON_NULL_TYPE, type: e, loc: this.loc(t) }
            : e
        );
      }),
      ...
      (t.peekDescription = function () {
        return this.peek(hi.STRING) || this.peek(hi.BLOCK_STRING);
      }),
      ...
      (t.parseOperationTypeDefinition = function () {
        ...
        return {
          kind: oi.OPERATION_TYPE_DEFINITION,
          operation: t,
          type: n,
          loc: this.loc(e),
        };
      ...
      (t.parseScalarTypeDefinition = function () {
        ...
        return {
          kind: oi.SCALAR_TYPE_DEFINITION,
          description: t,
          name: n,
          directives: i,
          loc: this.loc(e),
      ...
      (t.parseObjectTypeDefinition = function () {
        ...
        return {
          kind: oi.OBJECT_TYPE_DEFINITION,
          description: t,
          name: n,
          interfaces: i,
          directives: r,
      ...
      (t.parseImplementsInterfaces = function () {
        ...
        if (
          ...
          var t = [];
          this.expectOptionalToken(hi.AMP);
          do {
            t.push(this.parseNamedType());
          } while (this.expectOptionalToken(hi.AMP) || this.peek(hi.NAME));
          return t;
        }
        return this.delimitedMany(hi.AMP, this.parseNamedType);
      }),
      (t.parseFieldsDefinition = function () {
        ...
        return !0 ===
          ...
          this.peek(hi.BRACE_L) &&
          this._lexer.lookahead().kind === hi.BRACE_R
      ...
      (t.parseInputValueDef = function () {
        ...
        this.expectOptionalToken(hi.EQUALS) && (i = this.parseValueLiteral(!0));
        var o = this.parseDirectives(!0);
        return {
          kind: oi.INPUT_VALUE_DEFINITION,
          description: t,
          name: n,
          type: r,
          defaultValue: i,
      ...
      (t.parseInterfaceTypeDefinition = function () {
        ...
        var n = this.parseName(),
          ...
          o = this.parseFieldsDefinition();
        return {
          kind: oi.INTERFACE_TYPE_DEFINITION,
          description: t,
          name: n,
          interfaces: i,
          directives: r,
      ...
      (t.parseUnionMemberTypes = function () {
        return this.expectOptionalToken(hi.EQUALS)
          ? this.delimitedMany(hi.PIPE, this.parseNamedType)
          : [];
      }),
      ...
      (t.parseInputObjectTypeDefinition = function () {
        ...
        return {
          kind: oi.INPUT_OBJECT_TYPE_DEFINITION,
          description: t,
          name: n,
          directives: i,
          fields: r,
      ...
      (t.parseInterfaceTypeExtension = function () {
        ...
        if (0 === n.length && 0 === i.length && 0 === r.length)
          throw this.unexpected();
        return {
          kind: oi.INTERFACE_TYPE_EXTENSION,
          name: t,
          interfaces: n,
          directives: i,
          fields: r,
      ...
      (t.parseInputObjectTypeExtension = function () {
        ...
        if (0 === n.length && 0 === i.length) throw this.unexpected();
        return {
          kind: oi.INPUT_OBJECT_TYPE_EXTENSION,
          name: t,
          directives: n,
          fields: i,
          loc: this.loc(e),
      ...
      (t.parseDirectiveDefinition = function () {
        var e = this._lexer.token,
          t = this.parseDescription();
        this.expectKeyword("directive"), this.expectToken(hi.AT);
        var n = this.parseName(),
          i = this.parseArgumentDefs(),
      ...
      (t.parseDirectiveLocations = function () {
        return this.delimitedMany(hi.PIPE, this.parseDirectiveLocation);
      }),
      (t.parseDirectiveLocation = function () {
        var e = this._lexer.token,
          t = this.parseName();
        if (void 0 !== bi[t.value]) return t;
        throw this.unexpected(e);
      }),
      (t.loc = function (e) {
        var t;
        if (
          ...
          return new ci(e, this._lexer.lastToken, this._lexer.source);
      }),
      (t.peek = function (e) {
      ...
      (t.expectToken = function (e) {
        ...
        throw ri(
          this._lexer.source,
          t.start,
          "Expected ".concat(Li(e), ", found ").concat(Ri(t), ".")
        );
      }),
      ...
      (t.expectKeyword = function (e) {
        var t = this._lexer.token;
        if (t.kind !== hi.NAME || t.value !== e)
          throw ri(
            this._lexer.source,
            t.start,
            'Expected "'.concat(e, '", found ').concat(Ri(t), ".")
          );
        this._lexer.advance();
      }),
      (t.expectOptionalKeyword = function (e) {
        var t = this._lexer.token;
        return (
          t.kind === hi.NAME && t.value === e && (this._lexer.advance(), !0)
        );
      }),
  ...
  function Ri(e) {
    var t = e.value;
    return Li(e.kind) + (null != t ? ' "'.concat(t, '"') : "");
  }
  function Li(e) {
    return (function (e) {
      return (
  ...
  var Fi = {
    ...
    ji = Object.freeze({});
  function $i(e, t) {
    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Fi,
      i = void 0,
      r = Array.isArray(e),
      o = [e],
      s = -1,
    ...
    do {
      ...
      if (f) {
        if (
          ((l = 0 === d.length ? void 0 : h[h.length - 1]),
          (c = u),
          (u = d.pop()),
          v)
        ) {
        ...
        if (((l = u ? (r ? s : o[s]) : void 0), null == (c = u ? u[l] : p)))
          continue;
        u && h.push(l);
      }
      var S,
        k = void 0;
      if (!Array.isArray(c)) {
        if (!ui(c)) throw new Error("Invalid AST Node: ".concat(pi(c), "."));
        var T = zi(t, c.kind, f);
        if (T) {
          if ((k = T.call(t, c, l, u, h, d)) === ji) break;
          if (!1 === k) {
            if (!f) {
              h.pop();
              continue;
  ...
  var qi = {
    ...
    Document: function (e) {
      return Bi(e.definitions, "\n\n") + "\n";
    },
    OperationDefinition: function (e) {
      var t = e.operation,
        n = e.name,
        i = Hi("(", Bi(e.variableDefinitions, ", "), ")"),
        r = Bi(e.directives, " "),
        o = e.selectionSet;
      return n || r || i || "query" !== t ? Bi([t, Bi([n, i]), r, o], " ") : o;
    },
    ...
    FragmentSpread: function (e) {
      return "..." + e.name + Hi(" ", Bi(e.directives, " "));
    },
    InlineFragment: function (e) {
      var t = e.typeCondition,
        n = e.directives,
        i = e.selectionSet;
      return Bi(["...", Hi("on ", t), Bi(n, " "), i], " ");
    },
    FragmentDefinition: function (e) {
      var t = e.name,
        ...
        o = e.selectionSet;
      return (
        "fragment ".concat(t).concat(Hi("(", Bi(i, ", "), ")"), " ") +
        "on ".concat(n, " ").concat(Hi("", Bi(r, " "), " ")) +
        o
      );
    },
    IntValue: function (e) {
    ...
    Directive: function (e) {
      return "@" + e.name + Hi("(", Bi(e.arguments, ", "), ")");
    },
    ...
    SchemaDefinition: Ui(function (e) {
      var t = e.directives,
        n = e.operationTypes;
      return Bi(["schema", Bi(t, " "), Qi(n)], " ");
    }),
    OperationTypeDefinition: function (e) {
      return e.operation + ": " + e.type;
    },
    ScalarTypeDefinition: Ui(function (e) {
      return Bi(["scalar", e.name, Bi(e.directives, " ")], " ");
    }),
    ObjectTypeDefinition: Ui(function (e) {
      var t = e.name,
        n = e.interfaces,
        i = e.directives,
        r = e.fields;
      return Bi(
        ["type", t, Hi("implements ", Bi(n, " & ")), Bi(i, " "), Qi(r)],
        " "
      );
    }),
    FieldDefinition: Ui(function (e) {
      var t = e.name,
        n = e.arguments,
        i = e.type,
        r = e.directives;
    ...
    InputValueDefinition: Ui(function (e) {
      var t = e.name,
        n = e.type,
        i = e.defaultValue,
        r = e.directives;
      return Bi([t + ": " + n, Hi("= ", i), Bi(r, " ")], " ");
    }),
    InterfaceTypeDefinition: Ui(function (e) {
      var t = e.name,
        n = e.interfaces,
        i = e.directives,
        r = e.fields;
      return Bi(
        ["interface", t, Hi("implements ", Bi(n, " & ")), Bi(i, " "), Qi(r)],
        " "
      );
    }),
    UnionTypeDefinition: Ui(function (e) {
      var t = e.name,
        n = e.directives,
        i = e.types;
      return Bi(
    ...
    EnumTypeDefinition: Ui(function (e) {
      var t = e.name,
        n = e.directives,
        i = e.values;
      return Bi(["enum", t, Bi(n, " "), Qi(i)], " ");
    }),
    EnumValueDefinition: Ui(function (e) {
      return Bi([e.name, Bi(e.directives, " ")], " ");
    }),
    InputObjectTypeDefinition: Ui(function (e) {
      var t = e.name,
        n = e.directives,
        i = e.fields;
      return Bi(["input", t, Bi(n, " "), Qi(i)], " ");
    }),
    DirectiveDefinition: Ui(function (e) {
      var t = e.name,
        n = e.arguments,
        i = e.repeatable,
        r = e.locations;
    ...
    SchemaExtension: function (e) {
      var t = e.directives,
        n = e.operationTypes;
      return Bi(["extend schema", Bi(t, " "), Qi(n)], " ");
    },
    ScalarTypeExtension: function (e) {
      return Bi(["extend scalar", e.name, Bi(e.directives, " ")], " ");
    },
    ObjectTypeExtension: function (e) {
      var t = e.name,
        ...
        r = e.fields;
      return Bi(
        ["extend type", t, Hi("implements ", Bi(n, " & ")), Bi(i, " "), Qi(r)],
        " "
      );
    },
    ...
    EnumTypeExtension: function (e) {
      var t = e.name,
        n = e.directives,
        i = e.values;
      return Bi(["extend enum", t, Bi(n, " "), Qi(i)], " ");
    },
    InputObjectTypeExtension: function (e) {
      var t = e.name,
        n = e.directives,
        i = e.fields;
      return Bi(["extend input", t, Bi(n, " "), Qi(i)], " ");
    },
  };
  function Ui(e) {
    return function (t) {
      return Bi([t.description, e(t)], "\n");
    };
  }
  function Bi(e) {
    var t,
  ...
  function Ki(e) {
    return null != e && e.some(Wi);
  }
  var Yi = Object.freeze({ __proto__: null, print: Vi });
  var Ji = Object.freeze({
    ...
    getOperationAST: function (e, t) {
      for (var n = null, i = 0, r = e.definitions; i < r.length; i++) {
        var o,
          s = r[i];
        if (s.kind === oi.OPERATION_DEFINITION)
          if (null == t) {
            if (n) return null;
            n = s;
          } else if (
            (null === (o = s.name) || void 0 === o ? void 0 : o.value) === t
          )
            return s;
      }
      return n;
        ...
        e &&
          ...
          e.forEach(function (e) {
            if (
              ...
              __DEV__
                ? On(
                    r.name && "if" === r.name.value,
                    "Invalid argument for the @".concat(i, " directive.")
                  )
                : On(r.name && "if" === r.name.value, 39);
              var o = r.value;
              __DEV__
                ? On(
  ...
  function er(e) {
    return e && Zi(["client"], e) && Zi(["export"], e);
  }
  function tr(e, t) {
    var i = t,
      r = [];
          ...
          [
            {
              ...
              selectionSet: {
                kind: "SelectionSet",
                selections: [
                  { kind: "FragmentSpread", name: { kind: "Name", value: i } },
                ],
              },
            },
          ],
  ...
  function ir(e, t) {
    switch (e.kind) {
      ...
      case "FragmentSpread":
        ...
        return (
          __DEV__
            ? On(n, "No fragment named ".concat(e.name.value, "."))
            : On(n, 43),
          n
        );
      default:
  ...
  zn(),
    __DEV__ ? On("boolean" == typeof Ln, Ln) : On("boolean" == typeof Ln, 36);
  var cr = ["connection", "include", "skip", "client", "rest", "export"],
    lr = Object.assign(
      function (e, t, n) {
        if (t && n && n.connection && n.connection.key) {
          if (n.connection.filter && n.connection.filter.length > 0) {
            ...
            return (
              ...
              "".concat(n.connection.key, "(").concat(ur(r), ")")
            );
          }
  ...
  function fr(e, t, n) {
    ...
    for (var i = 0, r = t.selections; i < r.length; i++) {
      var o = r[i];
      if (vr(o)) {
        if ("__typename" === o.name.value) return e[pr(o)];
      } else {
        var s = fr(e, ir(o, n).selectionSet, n);
  ...
  function xr(e) {
    ...
    return (
      __DEV__
        ? On(t && "query" === t.operation, "Must contain a query definition.")
        : On(t && "query" === t.operation, 47),
      t
    );
  }
  function _r(e) {
    ...
    return (
      n &&
        ...
        n.forEach(function (e) {
          e.defaultValue && ar(t, e.variable.name, e.defaultValue);
        }),
      t
    );
  }
  ...
  var kr = { kind: "Field", name: { kind: "Name", value: "__typename" } };
  function Tr(e, t) {
    return e.selectionSet.selections.every(function (e) {
      return "FragmentSpread" === e.kind && Tr(t[e.name.value], t);
    });
  }
  function Cr(e) {
    return Tr(
      gr(e) ||
        (function (e) {
          __DEV__
            ...
            : On("Document" === e.kind, 48),
            __DEV__
              ? On(
                  e.definitions.length <= 1,
                  "Fragment must have exactly one definition."
                )
              : On(e.definitions.length <= 1, 49);
          ...
          return (
            __DEV__
              ...
              : On("FragmentDefinition" === t.kind, 50),
            t
          );
        })(e),
      nr(wr(e))
            ...
            enter: function (t) {
              if (
                ...
                return (
                  ...
                  t.selectionSet &&
                    Pr(t.selectionSet).forEach(function (e) {
  ...
  function Pr(e) {
    ...
    return (
      e.selections.forEach(function (e) {
        (vr(e) || mr(e)) && e.selectionSet
          ? Pr(e.selectionSet).forEach(function (e) {
              return t.push(e);
            })
  ...
  function Lr(e) {
    var t = e[0] || {},
      n = e.length;
    if (n > 1) for (var i = new jr(), r = 1; r < n; ++r) t = i.merge(t, e[r]);
    return t;
  }
      ...
      return (
        ...
        (e.prototype.shallowCopyForMerge = function (e) {
          if (rr(e)) {
            ...
            (e = Array.isArray(e)
              ? e.slice(0)
              : n({ __proto__: Object.getPrototypeOf(e) }, e)),
  ...
  var Ur = function () {
    ...
    Br = function (e) {
      return Ur() && Boolean(Symbol[e]);
    },
    Qr = function (e) {
      return Br(e) ? Symbol[e] : "@@" + e;
    };
  Ur() && !Br("observable") && (Symbol.observable = Symbol("observable"));
  var Hr = Qr("iterator"),
    Gr = Qr("observable"),
    Wr = Qr("species");
  function Kr(e, t) {
              ...
              return (function (e) {
                ...
                if (t) {
                  ...
                  for (
                    var n = 0;
                    n < t.length &&
                    (no(e, t[n].type, t[n].value), "closed" !== e._state);
                    ++n
                  );
                }
              })(e);
  ...
  var ro = (function () {
      ...
      return (
        (e.prototype.unsubscribe = function () {
          "closed" !== this._state && (to(this), eo(this));
        }),
        qr(e, [
          {
            key: "closed",
    ...
    oo = (function () {
      ...
      return (
        (t.next = function (e) {
          io(this._subscription, "next", e);
        }),
        (t.error = function (e) {
          io(this._subscription, "error", e);
        }),
        (t.complete = function () {
          io(this._subscription, "complete");
        }),
        qr(e, [
          {
            key: "closed",
      ...
      return (
        ...
        (e.from = function (t) {
          ...
          if (i) {
            ...
            return Jr(r) && r.constructor === n
              ? r
              : new n(function (e) {
                  return r.subscribe(e);
                });
          }
          if (Br("iterator") && (i = Kr(t, Hr)))
            return new n(function (e) {
              Zr(function () {
                if (!e.closed) {
                  for (var n, r = $r(i.call(t)); !(n = r()).done; ) {
                    var o = n.value;
  ...
  Ur() &&
    Object.defineProperty(so, Symbol("extensions"), {
      value: { symbol: Gr, hostReportError: Xr },
      configurable: !0,
    }),
    (function (e) {
      var t,
  ...
  var mo =
    ...
    yo = "function" == typeof WeakSet,
    go = "function" == typeof Symbol && "function" == typeof Symbol.for;
  function bo(e) {
    function t(t) {
      Object.defineProperty(e, t, { value: so });
    }
    return go && Symbol.species && t(Symbol.species), t("@@species"), e;
  }
  function wo(e) {
    ...
    function n(t) {
      ...
      return (
        ...
        (n.handlers = {
          next: function (e) {
            null !== n.sub &&
              ((n.latest = ["next", e]), fo(n.observers, "next", e));
          },
          error: function (e) {
            var t = n.sub;
            null !== t &&
  ...
  function Io(e) {
    return "function" == typeof e ? new Do(e) : e;
  }
  function Mo(e) {
    ...
    Do = (function () {
      ...
      return (
        ...
        (e.split = function (t, n, i) {
          ...
          return Mo(r) && Mo(o)
            ? new e(function (e) {
                return t(e) ? r.request(e) || so.of() : o.request(e) || so.of();
              })
            : new e(function (e, n) {
                return t(e)
                  ? r.request(e, n) || so.of()
                ...
                (function (e) {
                  ...
                  (function (e) {
                    for (
                      ...
                      if (t.indexOf(r) < 0)
                        throw __DEV__
                          ? new Cn("illegal argument: ".concat(r))
                          : new Cn(24);
                    }
                    return e;
                  })(t)
        ...
        (e.concat = function (t, n) {
          ...
          return Mo(r)
            ...
            : new e(function (e, t) {
                return (
                  i.request(e, function (e) {
                    return r.request(e, t) || so.of();
                  }) || so.of()
                );
              });
        }),
        (e.prototype.split = function (t, n, i) {
          return this.concat(e.split(t, n, i || new e(Ao)));
        }),
        (e.prototype.concat = function (t) {
          return e.concat(this, t);
        }),
        (e.prototype.request = function (e, t) {
          throw __DEV__ ? new Cn("request is not implemented") : new Cn(19);
        }),
  ...
  function zo(e, t) {
    ...
    i.forEach(function (e) {
      (o = n(n(n({}, o), e.options), {
        headers: n(n({}, o.headers), Vo(e.headers)),
      })),
    ...
    var a = e.operationName,
      ...
      l = e.variables,
      u = e.query,
      h = { operationName: a, variables: l };
    return (
      s.includeExtensions && (h.extensions = c),
      s.includeQuery && (h.query = t(u, Vi)),
      { options: o, body: h }
    );
  }
  function Vo(e) {
  ...
  var qo = Pn(function () {
        ...
        if (
          ...
          var S = (function (e, t) {
              ...
              if (
                ...
                var r = void 0;
                try {
                  r = Fo(t.variables, "Variables map");
                } catch (e) {
                  return { parseError: e };
                }
                i("variables", r);
              ...
              if (t.extensions) {
                var o = void 0;
                try {
                  o = Fo(t.extensions, "Extensions map");
                } catch (e) {
                  return { parseError: e };
                }
                i("extensions", o);
    ...
    Bo = (function (e) {
      function n(t) {
        void 0 === t && (t = {});
        var n = e.call(this, Uo(t).request) || this;
  ...
  function Jo(e, t) {
    ...
    switch (o) {
      ...
      case "[object Object]":
        ...
        for (var l = 0; l < c; ++l) if (!Go.call(t, s[l])) return !1;
        for (l = 0; l < c; ++l) {
          var u = s[l];
          if (!Jo(e[u], t[u])) return !1;
        }
        return !0;
      case "[object Error]":
      ...
      case "[object DataView]":
        var y = e.byteLength;
        if (y === t.byteLength) for (; y-- && e[y] === t[y]; );
        return -1 === y;
      ...
      case "[object Function]":
        ...
        return (
          g === Wo.call(t) &&
          ((i = es),
          !((r = (n = g).length - i.length) >= 0 && n.indexOf(i, r) === r))
        );
    }
    return !1;
  }
  function Xo(e) {
    return Object.keys(e).filter(Zo, e);
  }
  function Zo(e) {
    ...
    ss = (function () {
      ...
      return (
        ...
        (e.prototype.lookupArray = function (e) {
          var t = this;
          return (
            rs.call(e, function (e) {
              return (t = t.getChildTrie(e));
            }),
            t.data || (t.data = this.makeData(os.call(e)))
          );
        }),
  ...
  var as = null,
    ...
    hs =
      ...
      (function () {
        var e = (function () {
          ...
          return (
            (e.prototype.hasValue = function () {
              for (var e = as; e; e = e.parent)
                if (this.id in e.slots) {
                  var t = e.slots[this.id];
                  if (t === cs) break;
                  return e !== as && (as.slots[this.id] = t), !0;
                }
              return as && (as.slots[this.id] = cs), !1;
            }),
            (e.prototype.getValue = function () {
              if (this.hasValue()) return as.slots[this.id];
            }),
            ...
            (e.bind = function (e) {
              ...
              return function () {
                var n = as;
                try {
                  return (as = t), e.apply(this, arguments);
                } finally {
                  as = n;
                }
              };
            ...
            (e.noContext = function (e, t, n) {
              if (!as) return e.apply(n, t);
              var i = as;
              try {
                return (as = null), e.apply(n, t);
              } finally {
                as = i;
              }
            }),
        ...
        try {
          Object.defineProperty(us, "@wry/context:Slot", {
            value: (us["@wry/context:Slot"] = e),
            enumerable: !1,
            writable: !1,
            configurable: !1,
          });
  ...
  var _s = (function () {
    ...
    return (
      (e.prototype.peek = function () {
        if (1 === this.value.length && !ks(this))
          return Es(this), this.value[0];
      }),
      (e.prototype.recompute = function (e) {
        return (
          ws(!this.recomputing, "already recomputing"),
          Es(this),
          ks(this)
            ? (function (e, t) {
                Ps(e),
                  vs.withValue(e, Ss, [e, t]),
                  (function (e, t) {
                    if ("function" == typeof e.subscribe)
                      try {
                        gs(e), (e.unsubscribe = e.subscribe.apply(null, t));
                      } catch (t) {
                        return e.setDirty(), !1;
                      }
                    return !0;
      ...
      (e.prototype.setDirty = function () {
        this.dirty ||
          ((this.dirty = !0), (this.value.length = 0), Ts(this), gs(this));
      }),
      (e.prototype.dispose = function () {
        var e = this;
        this.setDirty(),
          Ps(this),
          Os(this, function (t, n) {
            t.setDirty(), Ds(t, e);
          });
      }),
      ...
      (e.prototype.dependOn = function (e) {
        e.add(this),
          this.deps || (this.deps = bs.pop() || new Set()),
          this.deps.add(e);
      }),
      (e.prototype.forgetDeps = function () {
        var e = this;
        this.deps &&
          (ys(this.deps).forEach(function (t) {
            return t.delete(e);
          }),
          this.deps.clear(),
          bs.push(this.deps),
  ...
  function Os(e, t) {
    ...
    if (n) for (var i = ys(e.parents), r = 0; r < n; ++r) t(i[r], e);
  }
  function As(e, t) {
    ws(e.childValues.has(t)), ws(ks(t));
    var n = !ks(e);
    if (e.dirtyChildren) {
      if (e.dirtyChildren.has(t)) return;
    } else e.dirtyChildren = bs.pop() || new Set();
    e.dirtyChildren.add(t), n && Ts(e);
  }
  function Is(e, t) {
    ws(e.childValues.has(t)), ws(!ks(t));
  ...
  function Ms(e, t) {
    ...
    n &&
      (n.delete(t),
      0 === n.size &&
        (bs.length < 100 && bs.push(n), (e.dirtyChildren = null)));
  }
  function Ps(e) {
    e.childValues.size > 0 &&
      ...
      e.forgetDeps(),
      ws(null === e.dirtyChildren);
  }
  function Ds(e, t) {
    t.parents.delete(e), e.childValues.delete(t), Ms(e, t);
  }
  var Ns = { setDirty: !0, dispose: !0, forget: !0 };
  function Rs(e) {
    var t = new Map(),
      n = e && e.subscribe;
    function i(e) {
      ...
      if (i) {
        ...
        r || t.set(e, (r = new Set())),
          i.dependOn(r),
          "function" == typeof n && (gs(r), (r.unsubscribe = n(e)));
      }
    }
    return (
      (i.dirty = function (e, n) {
        var i = t.get(e);
        if (i) {
          var r = n && ms.call(Ns, n) ? n : "setDirty";
          ys(i).forEach(function (e) {
            return e[r]();
          }),
            t.delete(e),
            gs(i);
  ...
  function Ls() {
    var e = new ss("function" == typeof WeakMap);
    return function () {
  ...
  function js(e, t) {
    ...
    var n = new fs(t.max || Math.pow(2, 16), function (e) {
        return e.dispose();
      }),
      i = t.keyArgs,
      r = t.makeCacheKey || Ls(),
      ...
      return (
        ...
        (e.prototype.readQuery = function (e, t) {
          return (
            ...
            this.read(
              n(n({}, e), { rootId: e.id || "ROOT_QUERY", optimistic: t })
            )
          );
        }),
        ...
        (e.prototype.updateFragment = function (e, t) {
          return this.batch({
            update: function (i) {
              ...
              return null == o
                ? r
                : (i.writeFragment(n(n({}, e), { data: o })), o);
            },
          });
        }),
        e
  ...
  function qs(e, t) {
    ...
    if (
      ...
      (t &&
        (t.keyObject =
          void 0 !== i ? { id: i } : void 0 !== r ? { _id: r } : void 0),
      void 0 === i && (i = r),
      void 0 !== i)
    )
      return ""
        .concat(n, ":")
        .concat(
          "number" == typeof i || "string" == typeof i ? i : JSON.stringify(i)
        );
  }
  var Us = {
    dataIdFromObject: qs,
  ...
  function Bs(e) {
    ...
    return void 0 === t ? Us.canonizeResults : t;
  }
      ...
      (Array.isArray(t)
        ...
        : e.selections.every(function (e) {
            if (vr(e) && Xi(e, n)) {
              ...
              return (
                Vs.call(t, i) &&
                (!e.selectionSet || Gs(e.selectionSet, t[i], n))
              );
            }
            return !0;
          }))
  ...
  function Ws(e) {
    return rr(e) && !sr(e) && !Array.isArray(e);
  }
    ...
    Xs = (function () {
      function e(e, t) {
        ...
        (this.policies = e),
          ...
          (this.getFieldValue = function (e, t) {
            return po(sr(e) ? n.get(e.__ref, t) : e && e[t]);
          }),
          (this.canRead = function (e) {
            return sr(e) ? n.has(e.__ref) : "object" == typeof e;
          }),
          (this.toReference = function (e, t) {
            if ("string" == typeof e) return or(e);
            if (sr(e)) return e;
      ...
      return (
        ...
        (e.prototype.get = function (e, t) {
          ...
          return "__typename" === t &&
            Vs.call(this.policies.rootTypenamesById, e)
        ...
        (e.prototype.merge = function (e, t) {
          var n,
            i = this;
          sr(e) && (e = e.__ref), sr(t) && (t = t.__ref);
          var r = "string" == typeof e ? this.lookup((n = e)) : e,
            o = "string" == typeof t ? this.lookup((n = t)) : t;
          if (o) {
            __DEV__
              ? On("string" == typeof n, "store.merge expects a string ID")
              : On("string" == typeof n, 1);
            var s = new jr(ra).merge(r, o);
            if (
              ((this.data[n] = s),
              s !== r && (delete this.refs[n], this.group.caching))
            ) {
              ...
              r || (a.__exists = 1),
                Object.keys(o).forEach(function (e) {
                  if (!r || r[e] !== s[e]) {
                    ...
                    var t = Hs(e);
                    t === e ||
                      i.policies.hasKeyArgs(s.__typename, t) ||
                      (a[t] = 1),
                      void 0 !== s[e] || i instanceof na || delete s[e];
                  }
                }),
                !a.__typename ||
                  (r && r.__typename) ||
            ...
            var o = Object.create(null),
              ...
              c = {
                ...
                readField: function (t, n) {
                  return i.policies.readField(
                    "string" == typeof t
                      ? { fieldName: t, from: n || or(e) }
                      : t,
                    { store: i }
                  );
                },
            ...
            var o = this.getFieldValue(r, "__typename"),
              s =
                t && n
                  ...
                  : t;
            return this.modify(e, s ? (((i = {})[s] = Ys), i) : Ys);
          }
          return !1;
        }),
        ...
        (e.prototype.gc = function () {
          ...
          t.forEach(function (i) {
            Vs.call(n, i) &&
              (Object.keys(e.findChildRefIds(i)).forEach(t.add, t),
              delete n[i]);
          });
          var i = Object.keys(n);
          if (i.length) {
            for (var r = this; r instanceof na; ) r = r.parent;
            i.forEach(function (e) {
              return r.delete(e);
            });
          }
    ...
    Zs = (function () {
      ...
      return (
        (e.prototype.resetCaching = function () {
          (this.d = this.caching ? Rs() : null), (this.keyMaker = new ss(mo));
        }),
        ...
        (e.prototype.dirty = function (e, t) {
          this.d &&
            this.d.dirty(ea(e, t), "__exists" === t ? "forget" : "setDirty");
        }),
        e
      );
    })();
  ...
  function ta(e, t) {
    oa(e) && e.group.depend(t, "__exists");
  }
  !(function (e) {
    var n = (function (e) {
      function n(t) {
        var n = t.policies,
          ...
          r = void 0 === i || i,
          o = t.seed,
          s = e.call(this, n, new Zs(r)) || this;
        return (
          (s.stump = new ia(s)),
          (s.storageTrie = new ss(mo)),
          o && s.replace(o),
          s
        );
      }
  ...
  var na = (function (e) {
      function i(t, n, i, r) {
        ...
        return (
          (o.id = t), (o.parent = n), (o.replay = i), (o.group = r), i(o), o
        );
      }
      return (
        t(i, e),
        (i.prototype.addLayer = function (e, t) {
        ...
        (i.prototype.findChildRefIds = function (t) {
          ...
          return Vs.call(this.data, t)
            ? n(n({}, i), e.prototype.findChildRefIds.call(this, t))
            : i;
        }),
      ...
      function n(t) {
        return (
          e.call(
            ...
            t,
            function () {},
            new Zs(t.group.caching, t.group)
          ) || this
        );
      }
      return (
  ...
  function oa(e) {
    return !!(e instanceof Xs && e.group.caching);
  }
  var sa,
    aa,
    ca = (function () {
      function e() {
        (this.known = new (yo ? WeakSet : Set)()),
          (this.pool = new ss(mo)),
          ...
          if (rr(e)) {
            ...
            switch (Object.getPrototypeOf(e)) {
              case Array.prototype:
                ...
                return (
                  (a = this.pool.lookupArray(i)).array ||
                    (this.known.add((a.array = i)),
                    __DEV__ && Object.freeze(i)),
                  a.array
                );
              case null:
        ...
        (e.prototype.sortedKeys = function (e) {
          ...
          if (!n.keys) {
            ...
            (n.keys = this.keysByJSON.get(i)) ||
              this.keysByJSON.set(i, (n.keys = { sorted: t, json: i }));
          }
          return n.keys;
        }),
        e
    ...
    la = Object.assign(
      function (e) {
        if (rr(e)) {
          ...
          var t = sa.admit(e),
            n = aa.get(t);
          return void 0 === n && aa.set(t, (n = JSON.stringify(t))), n;
        }
        return JSON.stringify(e);
      },
      { reset: ua }
  ...
  function ua() {
    (sa = new ca()), (aa = new (mo ? WeakMap : Map)());
  }
  function ha(e) {
    return [
      e.selectionSet,
  ...
  var da = (function () {
    function e(e) {
      var t = this;
      (this.knownResults = new (mo ? WeakMap : Map)()),
        (this.config = So(e, {
          addTypename: !1 !== e.addTypename,
          canonizeResults: Bs(e),
        })),
        (this.canon = e.canon || new ca()),
        (this.executeSelectionSet = js(
          function (e) {
            var i,
            ...
            return s
              ? r
                ? n(n({}, s), { result: t.canon.admit(s.result) })
                : s
              : (ta(e.context.store, e.enclosingRef.__ref),
        ...
        (this.executeSubSelectedArray = js(
          function (e) {
            return (
              ta(e.context.store, e.enclosingRef.__ref),
          ...
          },
          {
            ...
            makeCacheKey: function (e) {
              var t = e.field,
                n = e.array,
                i = e.context;
              if (oa(i.store)) return i.store.makeCacheKey(t, n, i.varString);
            },
          }
        ));
    }
    return (
      ...
      (e.prototype.diffQueryAgainstStore = function (e) {
        ...
        var d,
          ...
          v = this.executeSelectionSet({
            selectionSet: _r(i).selectionSet,
            objectOrReference: p,
            enclosingRef: p,
            context: {
              store: t,
        ...
        if (v.missing && ((d = [new zs(pa(v.missing), v.missing, i, s)]), !c))
          throw d[0];
        return { result: v.result, complete: !d, missing: d };
      }),
      (e.prototype.isFresh = function (e, t, n, i) {
        if (oa(i.store) && this.knownResults.get(e) === n) {
      ...
      (e.prototype.execSelectionSetImpl = function (e) {
        ...
        function h(e, t) {
          var n;
          return (
            e.missing && (s = o.merge(s, (((n = {})[t] = e.missing), n))),
            e.result
          );
        }
        ...
        d.forEach(function (e) {
          ...
          if (Xi(e, a))
            if (vr(e)) {
              ...
              var m = ir(e, o.fragmentMap);
              m &&
                c.fragmentMatches(m, l) &&
                m.selectionSet.selections.forEach(d.add, d);
            }
        });
        var p = { result: u, missing: s },
          f = o.canonizeResults ? this.canon.admit(p) : po(p);
      ...
      (e.prototype.execSubSelectedArrayImpl = function (e) {
        ...
        function a(e, n) {
          var i;
          return (
            e.missing && (t = s.merge(t, (((i = {})[n] = e.missing), i))),
            e.result
          );
        }
        return (
  ...
  function ma(e) {
    var t = va.get(e);
    return t || va.set(e, (t = { vars: new Set(), dep: Rs() })), t;
  }
  function ya(e) {
    ma(e).vars.forEach(function (t) {
  ...
  function ga(e) {
    ...
    var r = (i.attachCache = function (e) {
      return t.add(e), ma(e).vars.add(i), i;
    });
    return (
  ...
  function xa(e) {
    ...
    return wa[t] || (wa[t] = Object.create(null));
  }
  function _a(e) {
    var t = xa(e);
    return (
      ...
      (t.keyFieldsFn = function (t, n) {
        var i = function (e, t) {
          ...
          r = (n.keyObject = Sa(e, function (e) {
            var r = Ca(n.storeObject, e, i);
            return (
              void 0 === r &&
                t !== n.storeObject &&
                Vs.call(t, e[0]) &&
              ...
              __DEV__
                ? On(
                    void 0 !== r,
                    "Missing field '"
                      .concat(e.join("."), "' while extracting keyFields from ")
  ...
  function Sa(e, t) {
    var n = new jr();
    return ka(e).reduce(function (e, i) {
      var r,
        o = t(i);
      if (void 0 !== o) {
  ...
  function ka(e) {
    ...
    if (!t.paths) {
      ...
      e.forEach(function (t, r) {
        Array.isArray(t)
          ? (ka(t).forEach(function (e) {
              return n.push(i.concat(e));
            }),
            (i.length = 0))
          : (i.push(t),
            Array.isArray(e[r + 1]) || (n.push(i.slice(0)), (i.length = 0)));
      });
    }
    return t.paths;
  }
  ...
  function Oa(e) {
    return rr(e)
      ? Array.isArray(e)
        ? e.map(Oa)
        : Sa(Object.keys(e).sort(), function (t) {
            return Ca(e, t);
          })
      : e;
  }
    ...
    Na = (function () {
      function e(e) {
        (this.config = e),
          ...
          (this.config = n({ dataIdFromObject: qs }, e)),
          ...
          s(i, t.merge),
            ...
            o &&
              Object.keys(o).forEach(function (t) {
                ...
                i.read && i.merge && (i.keyFn = i.keyFn || Ma);
              });
        }),
                        ...
                        (n[e.name.value] = {}),
                          e.arguments &&
                            e.arguments.forEach(function (i) {
                              var r = i.name,
                                o = i.value;
                              return ar(n[e.name.value], r, o, t);
                            });
                      }));
                    var i = null;
                    return (
          ...
          if (n && (e.field || e.fieldName)) {
            ...
            if (c) {
              var l = Ra(
                ...
                e,
                t,
                t.store.getStorage(sr(n) ? n.__ref : n, r)
              );
              return fa.withValue(this.cache, c, [s, l]);
            }
            return s;
          }
        }),
  ...
  function Ra(e, t, n, i, r) {
    ...
    return {
      ...
      canRead: u,
      readField: function () {
        return e.readField(La(arguments, t, i), i);
      },
      mergeObjects: Fa(i.store),
    };
  }
  function La(e, t, i) {
    var r,
    ...
    return (
      "string" == typeof a
        ? (r = { fieldName: a, from: l > 1 ? c : t })
        : ((r = n({}, a)), Vs.call(r, "from") || (r.from = t)),
      __DEV__ &&
        void 0 === r.from &&
        __DEV__ &&
        On.warn(
          "Undefined 'from' passed to readField with arguments ".concat(
            ((o = Array.from(e)),
            (s = To("stringifyForDisplay")),
            JSON.stringify(o, function (e, t) {
              return void 0 === t ? s : t;
            })
              .split(JSON.stringify(s))
              .join("<undefined>"))
          )
        ),
      void 0 === r.variables && (r.variables = i),
      r
    );
  }
  function Fa(e) {
    return function (t, i) {
      if (Array.isArray(t) || Array.isArray(i))
        throw __DEV__ ? new Cn("Cannot automatically merge arrays") : new Cn(4);
      if (rr(t) && rr(i)) {
        var r = e.getFieldValue(t, "__typename"),
          o = e.getFieldValue(i, "__typename");
        if (r && o && r !== o) return i;
        if (sr(t) && Ws(i)) return e.merge(t.__ref, i), t;
        if (Ws(t) && sr(i)) return e.merge(t, i.__ref), i;
        if (Ws(t) && Ws(i)) return n(n({}, t), i);
      }
      return i;
    };
  }
    ...
    return (
      o ||
        e.flavors.set(
          r,
          (o =
            e.clientOnly === t && e.deferred === i
              ? e
              : n(n({}, e), { clientOnly: t, deferred: i }))
        ),
      o
    );
  }
  var $a = (function () {
      ...
      return (
        (e.prototype.writeToStore = function (e, t) {
          ...
          if (!sr(d))
            throw __DEV__
              ? new Cn("Could not identify object ".concat(JSON.stringify(o)))
              : new Cn(6);
          return (
            h.incomingById.forEach(function (t, n) {
              var r = t.storeObject,
                o = t.mergeTree,
                s = t.fieldNodeSet,
                a = or(n);
        ...
        (e.prototype.processSelectionSet = function (e) {
          var t = this,
            ...
            u =
              (i && c.rootTypenamesById[i]) ||
              fr(r, o, s.fragmentMap) ||
              (i && s.store.get(i, "__typename"));
          "string" == typeof u && (l.__typename = u);
          var h = function () {
              var e = La(arguments, l, s.variables);
              if (sr(e.from)) {
                var t = s.incomingById.get(e.from.__ref);
                if (t) {
                  var i = c.readField(n(n({}, e), { from: t.storeObject }), s);
            ...
            if ((d.add(n), void 0 !== s)) {
              var p = c.getStoreFieldName({
                ...
                v = t.processFieldValue(
                  s,
                  n,
                  n.selectionSet ? ja(e, !1, !1) : e,
                  f
                ),
                m = void 0;
              n.selectionSet && (sr(v) || Ws(v)) && (m = h("__typename", v));
              var y = c.getMergeFunction(u, n.name.value, m);
              y ? (f.info = { field: n, typename: u, merge: y }) : Ba(a, p),
                (l = e.merge(l, (((i = {})[p] = v), i)));
            } else !__DEV__ || e.clientOnly || e.deferred || Ir.added(n) || c.getReadFunction(u, n.name.value) || (__DEV__ && On.error("Missing field '".concat(pr(n), "' while writing result ").concat(JSON.stringify(r, null, 2)).substring(0, 1e3)));
          });
          try {
            var p = c.identify(r, {
                typename: u,
          ...
          if ("string" == typeof i) {
            ...
            if ((y.push(o), this.reader && this.reader.isFresh(r, m, o, s)))
              return m;
            var g = s.incomingById.get(i);
            return (
              g
                ? ((g.storeObject = s.merge(g.storeObject, l)),
                  (g.mergeTree = qa(g.mergeTree, a)),
                  d.forEach(function (e) {
                    return g.fieldNodeSet.add(e);
                  }))
                : s.incomingById.set(i, {
                    storeObject: l,
                    mergeTree: Ua(a) ? void 0 : a,
                    fieldNodeSet: d,
                  }),
              m
            );
        ...
        (e.prototype.processFieldValue = function (e, t, n, i) {
          ...
          return t.selectionSet && null !== e
            ? Array.isArray(e)
              ? e.map(function (e, o) {
                  var s = r.processFieldValue(e, t, n, Va(i, o));
                  return Ba(i, o), s;
                })
        ...
        (e.prototype.flattenFields = function (e, t, n, i) {
          void 0 === i && (i = fr(t, e, n.fragmentMap));
          var r = new Map(),
                ...
                a.selections.forEach(function (s) {
                  if (Xi(s, n.variables)) {
                    ...
                    if (
                      ...
                      var u = r.get(s);
                      u && ((a = a && u.clientOnly), (l = l && u.deferred)),
                        r.set(s, ja(n, a, l));
                    } else {
                      var h = ir(s, n.fragmentMap);
                      h &&
                        o.fragmentMatches(h, i, t, n.variables) &&
                        e(h.selectionSet, ja(n, a, l));
                    }
                  }
                }));
            })(e, n),
        ...
        (e.prototype.applyMerges = function (e, t, i, r, o) {
          ...
          if (e.map.size && !sr(i)) {
            var c,
              l = Array.isArray(i) || (!sr(t) && !Ws(t)) ? void 0 : t,
              u = i;
            l && !o && (o = [sr(l) ? l.__ref : l]);
            var h = function (e, t) {
            ...
            e.map.forEach(function (e, t) {
              ...
              if (void 0 !== i) {
                ...
                s !== i && (c = c || new Map()).set(t, s),
                  o && On(o.pop() === t);
              }
            }),
              c &&
                ((i = Array.isArray(u) ? u.slice(0) : n({}, u)),
  ...
  function Va(e, t) {
    var n = e.map;
    return n.has(t) || n.set(t, za.pop() || { map: new Map() }), n.get(t);
  }
  function qa(e, t) {
    if (e === t || !t || Ua(t)) return e;
    if (!e || Ua(e)) return t;
    var i = e.info && t.info ? n(n({}, e.info), t.info) : e.info || t.info,
      r = e.map.size && t.map.size,
      o = { info: i, map: r ? new Map() : e.map.size ? e.map : t.map };
    if (r) {
      var s = new Set(t.map.keys());
      e.map.forEach(function (e, n) {
        o.map.set(n, qa(e, t.map.get(n))), s.delete(n);
      }),
        s.forEach(function (n) {
          o.map.set(n, qa(t.map.get(n), e.map.get(n)));
        });
    }
    return o;
  }
  ...
  var Ha = (function (e) {
    ...
    return (
      ...
      (i.prototype.resetResultCache = function (e) {
        var t = this,
          n = this.storeReader;
        (this.storeWriter = new $a(
          this,
          (this.storeReader = new da({
            cache: this,
            addTypename: this.addTypename,
            resultCacheMaxSize: this.config.resultCacheMaxSize,
            canonizeResults: Bs(this.config),
            canon: e ? void 0 : n && n.canon,
          }))
        )),
          (this.maybeBroadcastWatch = js(
            function (e, n) {
              ...
              makeCacheKey: function (e) {
                ...
                if (oa(n)) {
                  ...
                  return n.makeCacheKey(
                    e.query,
                    e.callback,
                    la({ optimistic: i, rootId: r, variables: o })
                  );
                }
              },
            }
      ...
      (i.prototype.watch = function (e) {
        ...
        return (
          ...
          function () {
            t.watches.delete(e) && !t.watches.size && ya(t),
      ...
      function n(t) {
        ...
        return (
          ...
          (u.message =
            c ||
            ((r = ""),
            (_o((i = u).graphQLErrors) || _o(i.clientErrors)) &&
              (i.graphQLErrors || [])
  ...
  var Ya = Object.assign,
    ...
    Za = (function (e) {
      ...
      return (
        t(i, e),
        Object.defineProperty(i.prototype, "variables", {
          get: function () {
        ...
        (i.prototype.getCurrentResult = function (e) {
          ...
          var t = this.getLastResult(!0),
            i =
              ...
              (t && t.networkStatus) ||
              Ga.ready,
            r = n(n({}, t), { loading: Ka(i), networkStatus: i }),
          ...
          if (
            ...
            (a.complete || this.options.returnPartialData) &&
              (r.data = a.result),
              Yo(r.data, {}) && (r.data = void 0),
              a.complete
                ? (delete r.partial,
                  !a.complete ||
                    r.networkStatus !== Ga.loading ||
                    ("cache-first" !== s && "cache-only" !== s) ||
                    ((r.networkStatus = Ga.ready), (r.loading = !1)))
                : (r.partial = !0),
              !__DEV__ ||
                a.complete ||
        ...
        (i.prototype.isDifferentFromLastResult = function (e) {
          return !this.last || !Yo(this.last.result, e);
        }),
        (i.prototype.getLast = function (e, t) {
          var n = this.last;
          if (n && n[e] && (!t || Yo(n.variables, this.variables))) return n[e];
        }),
        ...
        (i.prototype.refetch = function (e) {
          ...
          if (
            ((i.fetchPolicy =
              "cache-and-network" === r
                ...
                ? "no-cache"
                : "network-only"),
            __DEV__ && e && Ja.call(e, "variables"))
          ) {
            var o = xr(this.options.query),
          ...
          return (
            e &&
              !Yo(this.options.variables, e) &&
              (i.variables = this.options.variables =
                n(n({}, this.options.variables), e)),
            this.queryInfo.resetLastWrite(),
            this.reobserve(i, Ga.refetch)
          );
        }),
        (i.prototype.fetchMore = function (e) {
          ...
          return (
            i.notifyOnNetworkStatusChange &&
              ((this.queryInfo.networkStatus = Ga.fetchMore), this.observe()),
            this.queryManager
              .fetchQuery(r, i, Ga.fetchMore)
              .then(function (n) {
                var r = n.data,
                  o = e.updateQuery;
                return (
              ...
              .subscribe({
                ...
                error: function (t) {
                  e.onError
                    ? e.onError(t)
                    : __DEV__ &&
                      On.error("Unhandled GraphQL subscription error", t);
                },
              });
          return (
          ...
          if (!this.queryManager.ssrMode) {
            ...
            if (n) {
              if (!t || t.interval !== n) {
                ...
                var i = function () {
                    e.pollingInfo &&
                      (Ka(e.queryInfo.networkStatus)
                        ? r()
                        : e
                            .reobserve({ fetchPolicy: "network-only" }, Ga.poll)
                            .then(r, r));
                  },
                  r = function () {
                    var t = e.pollingInfo;
        ...
        (i.prototype.updateLastResult = function (e, t) {
          return (
            ...
            (this.last = n(n({}, this.last), {
              result: this.queryManager.assumeImmutableResults ? e : lo(e),
              variables: t,
            })),
            _o(e.errors) || delete this.last.error,
            this.last
          );
        }),
        (i.prototype.reobserve = function (e, t) {
          var i = this;
          this.isTornDown = !1;
          var r = t === Ga.refetch || t === Ga.fetchMore || t === Ga.poll,
            o = this.options.variables,
            s = r ? So(this.options, e) : Ya(this.options, So(e));
          r ||
            (this.updatePolling(),
            e &&
              e.variables &&
              !e.fetchPolicy &&
              !Yo(e.variables, o) &&
              ((s.fetchPolicy = this.initialFetchPolicy),
              void 0 === t && (t = Ga.setVariables)));
        ...
        (i.prototype.reportResult = function (e, t) {
          (this.getLastError() || this.isDifferentFromLastResult(e)) &&
            (this.updateLastResult(e, t), fo(this.observers, "next", e));
        }),
        (i.prototype.reportError = function (e, t) {
          var i = n(n({}, this.getLastResult()), {
            error: e,
            errors: e.graphQLErrors,
            networkStatus: Ga.error,
            loading: !1,
          });
          this.updateLastResult(i, t),
            fo(this.observers, "error", (this.last.error = e));
        }),
  ...
  function ec(e) {
    __DEV__ && On.error("Unhandled error", e.message, e.stack);
  }
  function tc(e) {
    __DEV__ &&
      e &&
      __DEV__ &&
      On.debug("Missing cache result fields: ".concat(JSON.stringify(e)), e);
  }
  bo(Za);
  var nc = (function () {
      function e(e) {
      ...
      return (
        (e.prototype.addResolvers = function (e) {
          ...
          (this.resolvers = this.resolvers || {}),
            Array.isArray(e)
              ? e.forEach(function (e) {
                  t.resolvers = Rr(t.resolvers, e);
                })
              : (this.resolvers = Rr(this.resolvers, e));
        }),
        ...
        (e.prototype.clientQuery = function (e) {
          return Zi(["client"], e) && this.resolvers ? e : null;
        }),
                    ...
                    enter: function (e) {
                      if (
                        ...
                        e.selectionSet.selections.every(function (e) {
                          return vr(e) && "__typename" === e.name.value;
                        })
                      )
                        return null;
                    },
            ...
            o(this, void 0, void 0, function () {
              ...
              return s(this, function (s) {
                return (
                  ...
                  (u = nr(l)),
                  (h = o.operation),
                  (d = h ? h.charAt(0).toUpperCase() + h.slice(1) : "Query"),
                  (f = (p = this).cache),
                  (v = p.client),
                  (m = {
                    fragmentMap: u,
                    context: n(n({}, i), { cache: f, client: v }),
                    variables: r,
                    fragmentMatcher: a,
                  ...
                  [
                    2,
                    this.resolveSelectionSet(o.selectionSet, t, m).then(
                      function (e) {
                        return {
                          result: e,
                          ...
                          : (mr(e)
                              ...
                              : ((o = i[e.name.value]),
                                __DEV__
                                  ? On(
                                      o,
                                      "No fragment named ".concat(e.name.value)
                                    )
                                  : On(o, 9)),
                            o &&
                            o.typeCondition &&
                            ((l = o.typeCondition.name.value),
                            n.fragmentMatcher(t, l, r))
                              ? [
                                  2,
            ...
            return s(this, function (s) {
              return (
                ...
                (n.onlyRunForcedResolvers && !this.shouldForceResolvers(e)) ||
                  ((u = t.__typename || n.defaultOperationType),
    ...
    ic = new (mo ? WeakMap : Map)();
  function rc(e, t) {
    var n = e[t];
    "function" == typeof n &&
      (e[t] = function () {
        return ic.set(e, (ic.get(e) + 1) % 1e15), n.apply(this, arguments);
      });
  }
  function oc(e) {
    e.notifyTimeout &&
  ...
  var sc = (function () {
    function e(e, t) {
      ...
      ic.has(n) ||
        (ic.set(n, 0), rc(n, "evict"), rc(n, "modify"), rc(n, "reset"));
    }
    return (
      (e.prototype.init = function (e) {
        var t = e.networkStatus || Ga.loading;
        return (
          this.variables &&
            this.networkStatus !== Ga.loading &&
            !Yo(this.variables, e.variables) &&
            (t = Ga.setVariables),
          Yo(e.variables, this.variables) || (this.lastDiff = void 0),
          Object.assign(this, {
            document: e.document,
            variables: e.variables,
            networkError: null,
      ...
      (e.prototype.reset = function () {
        oc(this), (this.lastDiff = void 0), (this.dirty = !1);
      }),
      (e.prototype.getDiff = function (e) {
        void 0 === e && (e = this.variables);
        var t = this.getDiffOptions(e);
        if (this.lastDiff && Yo(t, this.lastDiff.options))
      ...
      (e.prototype.updateWatch = function (e) {
        ...
        if (!i || "no-cache" !== i.options.fetchPolicy) {
          ...
          (this.lastWatch && Yo(r, this.lastWatch)) ||
            (this.cancel(),
      ...
      (e.prototype.shouldWrite = function (e, t) {
        ...
        return !(
          n &&
          n.dmCount === ic.get(this.cache) &&
          Yo(t, n.variables) &&
          Yo(e.data, n.result.data)
        );
      }),
      (e.prototype.markResult = function (e, t, n) {
        var i = this;
        (this.graphQLErrors = _o(e.errors) ? e.errors : []),
          this.reset(),
              ...
              (ac(e, t.errorPolicy)
                ? this.cache.performTransaction(function (r) {
                    ...
                    var o = i.getDiffOptions(t.variables),
                      s = r.diff(o);
                    i.stopped || i.updateWatch(t.variables),
      ...
      (e.prototype.markReady = function () {
        return (this.networkError = null), (this.networkStatus = Ga.ready);
      }),
      (e.prototype.markError = function (e) {
        return (
          (this.networkStatus = Ga.error),
          (this.lastWrite = void 0),
          this.reset(),
    ...
    lc = (function () {
      function e(e) {
        ...
        (this.clientAwareness = {}),
          ...
          (this.transformCache = new (mo ? WeakMap : Map)()),
          ...
          (this.localState = u || new nc({ cache: t })),
          (this.ssrMode = a),
      ...
      return (
        (e.prototype.stop = function () {
          ...
          this.queries.forEach(function (t, n) {
            ...
            this.cancelPendingFetches(
              __DEV__
                ? new Cn("QueryManager stopped while query was in flight")
                : new Cn(11)
            );
        }),
                ...
                case 0:
                  return (
                    ...
                    __DEV__
                      ...
                      : On("network-only" === y || "no-cache" === y, 13),
                    (e = this.generateMutationId()),
                    (t = this.transform(t).document),
                    (i = this.getVariables(t, i)),
                    this.transform(t).hasClientExports
                      ? [4, this.localState.addExportedVariables(t, i, b)]
                      : [3, 2]
                  );
                case 1:
                  (i = s.sent()), (s.label = 2);
                      ...
                      new Promise(function (s, u) {
                        return vo(
                          c.getObservableFromLink(
                            t,
                            n(n({}, b), { optimisticResponse: r }),
                            i,
                            !1
                          ),
                          function (s) {
                            if (Eo(s) && "none" === v)
                              throw new Wa({ graphQLErrors: s.errors });
                            o && ((o.loading = !1), (o.error = null));
                            var u = n({}, s);
                            return (
                              "function" == typeof l && (l = l(u)),
                              "ignore" === v && Eo(u) && delete u.errors,
                          ...
                          error: function (t) {
                            o && ((o.loading = !1), (o.error = t)),
                              r && c.cache.removeOptimistic(e),
                              c.broadcastQueries(),
                              u(
                                t instanceof Wa
                                  ? t
                                  : new Wa({ networkError: t })
                              );
                          },
                        });
                      }),
                ...
                updateCache: function (t) {
                  ...
                  if (a) {
                    if (!s) {
                      ...
                      c.complete && (r = n(n({}, r), { data: c.result }));
                    }
        ...
        (e.prototype.markMutationOptimistic = function (e, t) {
          ...
          return this.cache.recordOptimisticTransaction(function (e) {
            try {
              i.markMutationResult(n(n({}, t), { result: { data: r } }), e);
            } catch (e) {
              __DEV__ && On.error(e);
            }
          }, t.mutationId);
        ...
        (e.prototype.transform = function (e) {
          ...
          if (!i.has(e)) {
            var r = this.cache.transformDocument(e),
              o = ((t = this.cache.transformForLink(r)), Ar([Mr], yr(t))),
              s = this.localState.clientQuery(r),
              a = o && this.localState.serverQuery(o),
              c = {
                document: r,
                hasClientExports: er(r),
        ...
        (e.prototype.watchQuery = function (e) {
          ...
          var t = new sc(this),
            i = new Za({ queryManager: this, queryInfo: t, options: e });
          return (
            this.queries.set(i.queryId, t),
            t.init({
              document: e.query,
              observableQuery: i,
              variables: e.variables,
        ...
        (e.prototype.query = function (e, t) {
          ...
          return (
            ...
            __DEV__
              ...
              : On("Document" === e.query.kind, 15),
            __DEV__
              ? On(
                  !e.returnPartialData,
                  "returnPartialData option only supported on watchQuery."
                )
              : On(!e.returnPartialData, 16),
            __DEV__
              ? On(
                  !e.pollInterval,
                  "pollInterval option only supported on watchQuery."
                )
              : On(!e.pollInterval, 17),
        ...
        (e.prototype.clearStore = function (e) {
          return (
            ...
            this.queries.forEach(function (e) {
              e.observableQuery ? (e.networkStatus = Ga.loading) : e.stop();
            }),
            ...
            this.queries.forEach(function (t, n) {
              ...
              if (o) {
                ...
                if (
                  ...
                  return;
                ("active" === e || (a && r.has(a)) || (s && r.has(s))) &&
                  (i.set(n, o), a && r.set(a, !0), s && r.set(s, !0));
              }
            }),
            o.size &&
              o.forEach(function (e) {
                var r = To("legacyOneTimeQuery"),
                  o = t
                    .getQuery(r)
                  ...
                  s = new Za({
                    queryManager: t,
                    queryInfo: o,
                    options: n(n({}, e), { fetchPolicy: "network-only" }),
                  });
                On(s.queryId === r), o.setObservableQuery(s), i.set(r, s);
              }),
            __DEV__ &&
              r.size &&
          ...
          var c = function (e) {
            return t.getObservableFromLink(n, a, e).map(function (o) {
              if (
                ...
                throw new Wa({ graphQLErrors: o.errors });
              return o;
            });
          };
          ...
          if (c) {
            var l = this.inFlightLinkObservables,
              ...
              h = {
                query: c,
                variables: i,
                operationName: br(c) || void 0,
                context: this.prepareContext(n(n({}, t), { forceFetch: !r })),
              };
            if (((t = h.context), r)) {
            ...
            } else s = new xo([Ro(u, h)]);
          } else
            (s = new xo([so.of({ data: {} })])), (t = this.prepareContext(t));
            ...
            function (r) {
              ...
              if (i >= e.lastRequestId) {
                if (o && "none" === n.errorPolicy)
                  throw e.markError(new Wa({ graphQLErrors: r.errors }));
                e.markResult(r, n, t), e.markReady();
              }
              var s = {
                data: r.data,
                loading: !1,
                networkStatus: e.networkStatus || Ga.ready,
              };
              return (
                o && "ignore" !== n.errorPolicy && (s.errors = r.errors), s
              );
            },
            function (t) {
              ...
              i.fetchCancelFns.delete(e),
                (function (e) {
                  var t = e.fetchPolicy,
                    ...
                    i = e.nextFetchPolicy;
                  i &&
                    (e.fetchPolicy = "function" == typeof i ? i.call(e, n) : i);
                })(t);
            }),
            b
          );
        ...
        (e.prototype.refetchQueries = function (e) {
          var t = this,
            ...
            a = void 0 === s ? (o ? To("refetchQueries") : void 0) : s,
            c = e.onQueryUpdated,
            l = new Map();
          i &&
            ...
            n &&
              this.cache.batch({
                ...
                onWatchUpdated: function (e, t, n) {
                  var i = e.watcher instanceof sc && e.watcher.observableQuery;
                  if (i) {
                    if (c) {
                      l.delete(i.queryId);
                      var r = c(i, t, n);
                    ...
                    null !== c &&
                      l.set(i.queryId, { oq: i, lastDiff: n, diff: t });
                  }
                },
              }),
            l.size &&
        ...
        (e.prototype.fetchQueryByPolicy = function (e, t, i) {
          var r = this,
            ...
            p = e.networkStatus;
          e.init({ document: o, variables: s, networkStatus: i });
          var f = function () {
              return e.getDiff(s);
            },
            v = function (t, i) {
              void 0 === i && (i = e.networkStatus || Ga.loading);
              var a = t.result;
              !__DEV__ || u || Yo(a, {}) || tc(t.missing);
              var c = function (e) {
                return so.of(
                  n(
                    { data: e, loading: Ka(i), networkStatus: i },
                    t.complete ? null : { partial: !0 }
                  )
                );
              };
              return a && r.transform(o).hasForcedResolvers
                ? r.localState
                    .runResolvers({
                      document: o,
                      remoteResult: { data: a },
            ...
            m =
              "no-cache" === a ? 0 : i === Ga.refetch && "merge" !== c ? 1 : 2,
            y = function () {
        ...
        (e.prototype.getQuery = function (e) {
          return (
            e && !this.queries.has(e) && this.queries.set(e, new sc(this, e)),
            this.queries.get(e)
          );
        }),
        (e.prototype.prepareContext = function (e) {
          ...
          return n(n({}, t), { clientAwareness: this.clientAwareness });
        }),
        e
      );
    })(),
  ...
  function hc(e, t) {
    return So(
      e,
      t,
      t.variables && { variables: n(n({}, e.variables), t.variables) }
    );
  }
  var dc = (function () {
      function e(e) {
        ...
        if (
          (_ ||
            (_ = n
              ? new Bo({ uri: n, credentials: i, headers: r })
              : Do.empty()),
          !o)
        )
          throw __DEV__
        ...
        (this.version = "3.5.8"),
          (this.localState = new nc({
            cache: o,
            client: this,
            resolvers: y,
            fragmentMatcher: b,
          })),
          (this.queryManager = new lc({
            cache: this.cache,
            link: this.link,
        ...
        (e.prototype.watchQuery = function (e) {
          return (
            this.defaultOptions.watchQuery &&
              (e = hc(this.defaultOptions.watchQuery, e)),
            !this.disableNetworkFetches ||
              ("network-only" !== e.fetchPolicy &&
                "cache-and-network" !== e.fetchPolicy) ||
              (e = n(n({}, e), { fetchPolicy: "cache-first" })),
            this.queryManager.watchQuery(e)
          );
        }),
        (e.prototype.query = function (e) {
          return (
            this.defaultOptions.query && (e = hc(this.defaultOptions.query, e)),
            __DEV__
              ? On(
                  "cache-and-network" !== e.fetchPolicy,
              ...
              : On("cache-and-network" !== e.fetchPolicy, 8),
            this.disableNetworkFetches &&
              "network-only" === e.fetchPolicy &&
              (e = n(n({}, e), { fetchPolicy: "cache-first" })),
        ...
        (e.prototype.mutate = function (e) {
          return (
            this.defaultOptions.mutate &&
              (e = hc(this.defaultOptions.mutate, e)),
    ...
    return (
      e.definitions.forEach(function (e) {
        if ("FragmentDefinition" === e.kind) {
          var n = e.name.value,
            r = yc((s = e.loc).source.body.substring(s.start, s.end)),
            o = fc.get(n);
          o && !o.has(r)
            ? vc &&
              console.warn(
            ...
            : o || fc.set(n, (o = new Set())),
            o.add(r),
            t.has(r) || (t.add(r), i.push(e));
        } else i.push(e);
        var s;
      }),
      n(n({}, e), { definitions: i })
  ...
  function bc(e) {
    ...
    if (!pc.has(t)) {
      var n = (function (e, t) {
        return new Ni(e, t).parseDocument();
      })(e, {
        experimentalFragmentVariables: mc,
        allowLegacyFragmentVariables: mc,
      });
  ...
  ((xc = wc || (wc = {})).gql = _c),
    (xc.resetCaches = Ec),
    (xc.disableFragmentWarnings = Sc),
    (xc.enableExperimentalFragmentVariables = kc),
    (xc.disableExperimentalFragmentVariables = Tc),
    (wc.default = wc);
  var Cc = Oc;
  function Oc(e) {
    (e = e || {}),
  ...
  (Oc.prototype.duration = function () {
    ...
    (Oc.prototype.setMin = function (e) {
      this.ms = e;
    }),
    (Oc.prototype.setMax = function (e) {
      this.max = e;
    }),
    (Oc.prototype.setJitter = function (e) {
      this.jitter = e;
    });
  var Ac = Ft(function (e) {
    ...
    Object.create &&
      ...
      (a.prototype.emit = function (e, t, i, r, o, s) {
        ...
        if (u.fn) {
          ...
          for (l = 0; l < p; l++)
            switch (
              (u[l].once && this.removeListener(e, u[l].fn, void 0, !0), h)
            ) {
              case 1:
      ...
      (a.prototype.removeListener = function (e, t, i, r) {
        ...
        if (a.fn)
          a.fn !== t || (r && !a.once) || (i && a.context !== i) || s(this, o);
        else {
          for (var c = 0, l = [], u = a.length; c < u; c++)
            (a[c].fn !== t || (r && !a[c].once) || (i && a[c].context !== i)) &&
              l.push(a[c]);
  ...
  var Ic = function (e) {
    ...
    Mc = Object.defineProperty({ default: Ic }, "__esModule", { value: !0 });
  var Pc = function (e) {
      return null !== e && "object" == typeof e;
    },
    Dc = Object.defineProperty({ default: Pc }, "__esModule", { value: !0 });
  var Nc = (function (e) {
      var t,
        n = e.Symbol;
      return (
    ...
    Rc = Object.freeze({ __proto__: null, default: Nc }),
    Lc = Ft(function (e, t) {
    ...
    $c = Object.defineProperty({ default: jc }, "__esModule", { value: !0 }),
    zc = Lt(Yi),
    Vc = Lt(Ji),
    qc = Lt(Rc),
    Uc = Ft(function (e, t) {
      ...
      var s = void 0 !== Rt ? Rt : "undefined" != typeof window ? window : {},
        ...
        c = (function () {
          function e(e, t, n, i) {
            var r = t || {},
              ...
              l = void 0 === c ? {} : c,
              u = r.minTimeout,
              h = void 0 === u ? Fc.MIN_WS_TIMEOUT : u,
              d = r.timeout,
              p = void 0 === d ? Fc.WS_TIMEOUT : d,
              f = r.reconnect,
              v = void 0 !== f && f,
            ...
            (this.wsProtocols = i || Lc.GRAPHQL_WS),
              ...
              (this.reconnect = v),
              (this.reconnecting = !1),
              (this.reconnectionAttempts = y),
              (this.lazy = !!b),
              (this.inactivityTimeout = x),
              (this.closedByUser = !1),
              (this.backoff = new Cc({ jitter: 0.5 })),
              (this.eventEmitter = new Ac.EventEmitter()),
              (this.middlewares = []),
              (this.client = null),
              (this.maxConnectTimeGenerator =
                this.createMaxConnectTimeGenerator()),
              (this.connectionParams = this.getConnectionParams(l)),
              (this.wsOptionArguments = E),
          ...
          return (
              ...
              void 0 === e && (e = !0),
                ...
                null !== this.client &&
                  ...
                  e &&
                    ...
                    this.sendMessage(
                      void 0,
                      $c.default.GQL_CONNECTION_TERMINATE,
                      null
                    )),
                  this.client.close(),
                ...
                this.applyMiddlewares(e)
                  .then(function (e) {
                    n.checkOperationOptions(e, t),
                      n.operations[i] &&
                        ((n.operations[i] = { options: e, handler: t }),
                        n.sendMessage(i, $c.default.GQL_START, e));
                  })
                  .catch(function (e) {
            ...
            (e.prototype.createMaxConnectTimeGenerator = function () {
              var e = this.minWsTimeout,
                t = this.wsTimeout;
              return new Cc({ min: e, max: t, factor: 1.2 });
            }),
            ...
            (e.prototype.checkOperationOptions = function (e, t) {
              ...
              if (
                (!Mc.default(n) && !Vc.getOperationAST(n, r)) ||
                (r && !Mc.default(r)) ||
                (i && !Dc.default(i))
              )
                throw new Error(
                      ...
                      switch (n.label) {
                        ...
                        case 3:
                          return (
                            ...
                            this.sendMessage(
                              void 0,
                              $c.default.GQL_CONNECTION_ERROR,
                              t
                            ),
                            this.flushUnsentMessagesQueue(),
                            [3, 4]
            ...
            (e.prototype.unsubscribe = function (e) {
              this.operations[e] &&
                ...
                this.sendMessage(e, $c.default.GQL_STOP, void 0));
            }),
            e
          );
        })();
    ...
    Bc = (function (e) {
      function n(t) {
        var n = e.call(this) || this;
        return (
          t instanceof Uc.SubscriptionClient
            ? (n.subscriptionClient = t)
            : (n.subscriptionClient = new Uc.SubscriptionClient(
                t.uri,
                t.options,
                t.webSocketImpl
              )),
  ...
  const Qc = {
    ...
    Hc = { name: "mona-lisa", version: "0.0.1" },
    Gc = wc`
...
`,
    Zc = "You are doing this too often",
    el = "Oops, something went wrong";
  class tl {
    handleApiError(e) {
      let t;
      return (
        e.networkError
          ? "statusCode" in e.networkError &&
            ...
            (t = { type: ml.UnauthorizedError, message: e.message })
          : e.graphQLErrors && (t = this.parseGraphQLErrors(e.graphQLErrors)),
        t || (vn(e), { type: ml.GenericError, message: e.message || el })
      );
    }
    ...
    parseGraphQLError(e) {
      ...
      if (
        null === (t = e.extensions) || void 0 === t
          ? void 0
          : t.nextAvailablePixelTs
      )
        return {
          type: ml.PixelRateLimit,
          message: Zc,
          nextAvailablePixelTimestamp: e.extensions.nextAvailablePixelTs,
        };
      if ("429: too many requests" === e.message)
        return { type: ml.SubscribeRateLimit, message: Zc };
      if (e.message) {
        const t =
            null === (n = e.message) || void 0 === n
              ? void 0
              : n.match(/^ratelimit hit, next available: (\d+)$/),
  ...
  class il extends tl {
    constructor({
      ...
      super(),
        ...
        (this.onSubscribeNext = (e) => {
          var t;
          this.onMessage(
            null === (t = e.data) || void 0 === t ? void 0 : t.subscribe.data
          );
        }),
        (this.subscribe = async () => (
          ...
          new Promise((e, t) => {
                ...
                null == r
                  ...
                  : r.subscribe(
                      ...
                      async (n) => {
                        ...
                        if (
                          (this.changeState(nl.Error),
                          i.type === ml.SubscribeRateLimit)
                        ) {
            ...
            (this.subscription = o),
              this.changeState(nl.Subscribed),
              fn(
                `Subscribe to ${this.variables.input.channel.category} (index: ${this.canvasIndex})`
              );
          })
        )),
        (this.canvasIndex = e),
        ...
        (this.query = n),
        (this.variables = {
          input: { channel: Object.assign({ teamOwner: "AFD2022" }, i) },
        }),
        (this.onMessage = r),
    ...
    waitIfRateLimited() {
      return this.isRateLimited
        ? this.attempts >= 6
          ? (vn("Rate limited subscription exceeded max allowed attempts"),
    ...
    unsubscribe() {
      ...
      null === (e = this.subscription) || void 0 === e || e.unsubscribe(),
        this.changeState(nl.Unsubscribed),
        fn("Unsubscribe from", this.variables);
    }
  }
  class rl {
    constructor(e) {
      (this.visibleCanvasIndexList = []),
        ...
        (this.subscribeToConfigUpdates = async (e) => {
          ...
          const t = {
            ...
            client: this.client,
            query: Jc,
            variables: { category: fl.Config },
            onMessage: (t) => e(t),
          };
          (this.subscriptions.config = new il(t)),
            await this.subscriptions.config.subscribe();
        }),
        (this.subscribeToCanvasUpdates = async (e, t) => {
          if ((this.unsubscribeFromCanvasUpdates(t.index), !this.client))
            return;
          const n = t.index;
        ...
        (this.subscribeToVisibleCanvas = async (e) => {
          ...
          this.visibleCanvasIndexList.includes(e) &&
            (await (null === (t = this.subscriptions.canvas.get(e)) ||
            void 0 === t
              ? void 0
              : t.subscribe()));
        }),
        (this.toggleVisibleCanvasListSubscription = (e) => {
          this.visibleCanvasIndexList.join() !== e.join() &&
            ...
            fn("Visibility changed (resubscribe canvases)", e),
    ...
    unsubscribeFromConfigUpdates() {
      var e;
      null === (e = this.subscriptions.config) ||
        void 0 === e ||
        e.unsubscribe(),
        (this.subscriptions.config = void 0);
    }
    createCanvasSubscription(e, t) {
      const n = {
        ...
        client: this.client,
        query: Xc,
        variables: { category: fl.Canvas, tag: e.toString() },
        onMessage: (n) => t(n, e),
      };
      this.subscriptions.canvas.set(e, new il(n));
    }
    unsubscribeFromCanvasUpdates(e) {
      var t;
      void 0 === e
        ? (this.subscriptions.canvas.forEach((e) => e.unsubscribe()),
          this.subscriptions.canvas.clear())
        : this.subscriptions.canvas.has(e) &&
          (null === (t = this.subscriptions.canvas.get(e)) ||
            void 0 === t ||
            t.unsubscribe());
    }
  }
  function ol({ x: e, y: t }) {
    return {
      x: Math.round(Math.min(ut.getState(), Math.max(0, e || 0))),
      y: Math.round(Math.min(lt.getState(), Math.max(0, t || 0))),
    };
  }
  function sl() {
    return ol({ x: it.getState(), y: rt.getState() });
  }
  function al() {
    const { x: e, y: t } = ol({ x: it.getState(), y: rt.getState() });
    return { cx: e, cy: t, px: Math.floor(ot.getState()) };
  }
  function cl(e, t, n, i) {
      ...
      i = (function (e, t, n) {
        return null == n
          ...
          : n.canvasConfigurations.find(
              (i) =>
                e >= i.dx &&
                e < i.dx + n.canvasWidth &&
                t >= i.dy &&
                t < i.dy + n.canvasHeight
            );
      })(e, t, n);
    if (i && n)
      return { x: e % n.canvasWidth, y: t % n.canvasHeight, index: i.index };
  }
  function hl({ x: e, y: t }) {
    const n = ut.getState(),
      i = lt.getState();
            ...
            c - a + 1 > 0 &&
              ...
              n.push(
                Object.assign(
                  ...
                  (d = c % t.canvasHeight),
                  {
                    topLeftCoordinate: { x: l, y: u },
                    bottomRightCoordinate: { x: h, y: d },
                  })
                )
              ),
            n
  ...
  !(function (e) {
    ...
    (function (e) {
      (e.FullFrame = "FullFrameMessageData"),
        ...
        (e.GetUserCooldownResponseMessage =
  ...
  const yl = new (class extends tl {
    constructor() {
      super(),
        (this.subscribeToConfigUpdates = async (e) => {
          var t;
          return null === (t = this.subscriptions) || void 0 === t
            ? void 0
            : t.subscribeToConfigUpdates(e);
        }),
        (this.subscribeToCanvasUpdates = async (e, t) => {
          var n;
          return null === (n = this.subscriptions) || void 0 === n
            ? void 0
            : n.subscribeToCanvasUpdates(e, t);
        }),
        window.addEventListener("pagehide", () => {
          this.destroy();
        });
    ...
    setAuthHeaders(e, t, n = !1) {
      (this.headers = e),
        n
          ? this.createReadonlyClient()
          : (this.createClient(t), this.createSubscriptions());
    }
          ...
          options: Object.assign(Object.assign({}, Qc), {
            ...
            connectionCallback: function (t) {
              Array.isArray(t) && (t = t[0]),
                t
                  ? "401: 401 Unauthorized" === t.message ||
                    "request is missing authentication data" === t.message
                    ? e({ type: ml.UnauthorizedError, message: t.message })
                    : (vn("Failed to establish a websocket connection", t),
                      e({ type: ml.GenericError, message: t.message }))
                  : e({ type: ml.Success, data: void 0 });
            },
          }),
        }),
        i = No(
    ...
    createSubscriptions() {
      ...
      this.client &&
        (this.subscriptions &&
          (null === (e = this.subscriptions) ||
            void 0 === e ||
            e.unsubscribeFromConfigUpdates(),
          null === (t = this.subscriptions) ||
            void 0 === t ||
            t.unsubscribeFromCanvasUpdates()),
        (this.subscriptions = new rl(this.client)));
    }
    async makeRequest(e, t, n) {
      ...
      try {
        ...
        if (null == r ? void 0 : r.errors) {
          ...
          return (
            e ||
            (vn(`Failed to fetch ${t.actionName}`, r.errors[0]),
            { type: ml.GenericError, message: el })
          );
        }
        if (!(null == r ? void 0 : r.data))
          return { type: ml.GenericError, message: el };
        const o = n(r.data);
        return { type: ml.Success, data: o };
      } catch (e) {
        ...
        ? this.makeRequest(
            ...
            (e) => {
              ...
              for (const n of e.act.data)
                (n.data.__typename !== vl.SetPixelResponseMessage &&
                  n.data.__typename !== vl.GetUserCooldownResponseMessage) ||
                  (t = Object.assign(Object.assign({}, t), n.data));
              return t;
            }
          )
        : (vn(
            `Set Pixel: Failed to convert pixel coordinates to canvas coordinates (${
              "x: " + e.x + ", y: " + e.y
            })`
          ),
          { type: ml.GenericError, message: el });
        ...
        ? this.makeRequest(
            ...
            (e) => {
              for (const t of e.act.data)
                if (t.data.__typename === vl.PixelHistoryResponseMessage)
                  return t.data;
            }
          )
        : (vn(
    ...
    async getUserCooldown() {
      return this.makeRequest(
        ...
        (e) => {
          for (const t of e.act.data)
            if (t.data.__typename === vl.GetUserCooldownResponseMessage)
              return t.data;
        }
      );
    }
    async fetchUserData() {
      try {
        ...
        return 401 === e.status
          ? { type: ml.UnauthorizedError, message: el }
          : 200 !== e.status
          ? (vn(`Failed to fetch user data: ${e.status} ${e.statusText}`),
            { type: ml.GenericError, message: el })
          : { type: ml.Success, data: await e.json() };
      } catch (e) {
        return (
          vn("Failed to fetch user data", e),
          { type: ml.GenericError, message: el }
        );
      }
    }
    ...
    unsubscribeFromCanvasUpdates(e) {
      ...
      null === (t = this.subscriptions) ||
        void 0 === t ||
        t.unsubscribeFromCanvasUpdates(e);
    }
    toggleVisibleCanvasListSubscription(e) {
      var t;
      null === (t = this.subscriptions) ||
        void 0 === t ||
        t.toggleVisibleCanvasListSubscription(e);
    }
  })();
  var gl;
  !(function (e) {
  ...
  const kl = Symbol("mixins/with-app-link");
  const Tl = Symbol("mixins/with-app-link");
  const Cl = Symbol("mixins/with-app-link");
  var Ol = function (e, t) {
      return {
        name: e,
        value: void 0 === t ? -1 : t,
    ...
    Rl = function () {
      return (
        Dl < 0 &&
          ((Dl = window.webVitals.firstHiddenTime) === 1 / 0 && Nl(),
          Ml(function () {
            setTimeout(function () {
              (Dl = "hidden" === document.visibilityState ? 0 : 1 / 0), Nl();
            }, 0);
          })),
        {
          get firstHiddenTime() {
  ...
  function Vl() {
    const e = (function () {
      ...
      const { height: e, width: t } = window.screen,
        n = window.devicePixelRatio;
      return zl.find((i) => n === i.dpi && e === i.height && t === i.width);
    })();
    if (e)
      return {
      ...
      (this._custom = {}),
        ...
        (this.remeasureForBFCacheRestore = (e) => {
          ...
          Object.keys(this._metrics).forEach((e) => {
            this.isKeyCustomMetric(e) ||
              (this._metrics[e] && (t.metrics[e] = 0));
          }),
  ...
  let Hl = class extends Ae {
    constructor() {
      super(...arguments),
        (this._perfMetrics = new Bl((e) => {
          var t;
          const n = null === (t = Vl()) || void 0 === t ? void 0 : t.yearClass,
      ...
      if (this.endpoint) {
        ...
        !(function (e, t) {
          ...
          c &&
            ...
            Ml(function () {
              (o = 0), (jl = -1), (r = Ol("CLS", 0)), (n = Pl(i, r, t));
            }));
          ...
          (function (e, t) {
            var n,
              ...
              s = Al("largest-contentful-paint", o);
            if (s) {
              n = Pl(e, r, t);
              var a = function () {
                $l[r.id] ||
          ...
          })(this.onWebVitalMeasured(Ql.TTFB, Math.ceil)),
                    ...
                    const n = "slot" + (r ? `[name=${r}]` : ":not([name])"),
                      o =
                        null === (e = this.renderRoot) || void 0 === e
                          ...
                          : e.querySelector(n);
                    return null !==
                      (t = null == o ? void 0 : o.assignedNodes(i)) &&
                      void 0 !== t
                      ? t
                      : [];
                  },
  ...
  let Gl = class extends Ae {
    ...
    render() {
      return le` <mona-lisa-icon-button @click="${
        this.toggleErase
      }" .selected="${ht.getState()}"> <icon-edit></icon-edit> </mona-lisa-icon-button>`;
    }
  };
  Gl = r([c("mona-lisa-admin-controls")], Gl);
  var Wl = {
      update: null,
      begin: null,
      loopBegin: null,
  ...
  var tu = {
    ...
    obj: function (e) {
      return Zl(Object.prototype.toString.call(e), "Object");
    },
    pth: function (e) {
      return tu.obj(e) && e.hasOwnProperty("totalLength");
    },
    svg: function (e) {
    ...
    col: function (e) {
      return tu.hex(e) || tu.rgb(e) || tu.hsl(e);
    },
    key: function (e) {
      return (
        !Wl.hasOwnProperty(e) &&
  ...
  function iu(e, t) {
    var n = nu(e),
      i = Xl(tu.und(n[0]) ? 1 : n[0], 0.1, 100),
      r = Xl(tu.und(n[1]) ? 100 : n[1], 0.1, 100),
      o = Xl(tu.und(n[2]) ? 10 : n[2], 0.1, 100),
      s = Xl(tu.und(n[3]) ? 0 : n[3], 0.1, 100),
      a = Math.sqrt(r / i),
      c = o / (2 * Math.sqrt(r * i)),
    ...
    function h(e) {
      ...
      return (
        (n =
          c < 1
            ? Math.exp(-n * c * a) * (1 * Math.cos(l * n) + u * Math.sin(l * n))
            : (1 + u * n) * Math.exp(-n * a)),
        0 === e || 1 === e ? e : 1 - n
      );
    }
  ...
  function ru(e) {
    return (
      void 0 === e && (e = 10),
      function (t) {
        return Math.ceil(Xl(t, 1e-6, 1) * e) * (1 / e);
      }
    );
  }
  var ou,
    ...
    cu =
      ...
      Object.keys(su).forEach(function (e) {
        var t = su[e];
        (ou["easeIn" + e] = t),
          (ou["easeOut" + e] = function (e, n) {
            return function (i) {
              return 1 - t(e, n)(1 - i);
            };
          }),
          (ou["easeInOut" + e] = function (e, n) {
            return function (i) {
              return i < 0.5 ? t(e, n)(2 * i) / 2 : 1 - t(e, n)(-2 * i + 2) / 2;
            };
          }),
          (ou["easeOutIn" + e] = function (e, n) {
            return function (i) {
              return i < 0.5
                ? (1 - t(e, n)(1 - 2 * i)) / 2
                : (t(e, n)(2 * i - 1) + 1) / 2;
  ...
  function du(e) {
    return e.reduce(function (e, t) {
      return e.concat(tu.arr(t) ? du(t) : t);
    }, []);
  }
  function pu(e) {
    return tu.arr(e)
  ...
  function yu(e, t) {
    var n = vu(e);
    for (var i in t) n[i] = tu.und(e[i]) ? t[i] : e[i];
    return n;
  }
  function gu(e) {
    return tu.rgb(e)
  ...
  function wu(e, t) {
    return tu.fnc(e) ? e(t.target, t.id, t.total) : e;
  }
  function xu(e, t) {
    return e.getAttribute(t);
  }
  function _u(e, t, n) {
    if (fu([n, "deg", "rad", "turn"], bu(t))) return t;
    var i = Jl.CSS[t + n];
    if (!tu.und(i)) return i;
  ...
  function Su(e, t) {
    return tu.dom(e) && !tu.inp(e) && (!tu.nil(xu(e, t)) || (tu.svg(e) && e[t]))
      ? "attribute"
      : tu.dom(e) && fu(Yl, t)
      ? "transform"
      : tu.dom(e) && "transform" !== t && Eu(e, t)
      ? "css"
      : null != e[t]
      ? "object"
      : void 0;
  ...
  function Tu(e, t, n, i) {
    var r = Zl(t, "scale")
        ...
        : 0 +
          (function (e) {
            return Zl(e, "translate") || "perspective" === e
              ? "px"
              : Zl(e, "rotate") || Zl(e, "skew")
              ? "deg"
              : void 0;
          })(t),
      o = ku(e).get(t) || r;
  ...
  function Pu(e) {
    ...
    switch (e.tagName.toLowerCase()) {
      case "circle":
        return (function (e) {
          return 2 * Math.PI * xu(e, "r");
        })(e);
      case "rect":
        return (function (e) {
          return 2 * xu(e, "width") + 2 * xu(e, "height");
        })(e);
      case "line":
        return (function (e) {
          return Iu(
      ...
      case "polygon":
        return (function (e) {
          var t = e.points;
          return Mu(e) + Iu(t.getItem(t.numberOfItems - 1), t.getItem(0));
        })(e);
    }
  }
  function Du(e, t) {
    var n = t || {},
      i =
        n.el ||
        (function (e) {
          for (var t = e.parentNode; tu.svg(t) && tu.svg(t.parentNode); )
            t = t.parentNode;
          return t;
        })(e),
  ...
  function Ru(e, t) {
    var n = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
      i = Au(tu.pth(e) ? e.totalLength : e, t) + "";
    return {
      original: i,
      numbers: i.match(n) ? i.match(n).map(Number) : [0],
      strings: tu.str(e) || t ? i.split(n) : [],
    };
  }
  function Lu(e) {
    return hu(e ? du(tu.arr(e) ? e.map(pu) : pu(e)) : [], function (e, t, n) {
  ...
  function Fu(e) {
    ...
    return t.map(function (e, n) {
      return { target: e, id: n, total: t.length, transforms: { list: ku(e) } };
    });
  }
  function ju(e, t) {
    var n = vu(t);
    if ((/^spring/.test(n.easing) && (n.duration = iu(n.easing)), tu.arr(e))) {
      var i = e.length;
      2 === i && !tu.obj(e[0])
        ? (e = { value: e })
        : tu.fnc(t.duration) || (n.duration = t.duration / i);
    }
    var r = tu.arr(e) ? e : [e];
    return r
      .map(function (e, n) {
        var i = tu.obj(e) && !tu.pth(e) ? e : { value: e };
        return (
          tu.und(i.delay) && (i.delay = n ? 0 : t.delay),
          tu.und(i.endDelay) &&
  ...
  function $u(e, t) {
            ...
            var t = hu(
              ...
              i = function (i) {
                ...
                n[r] = e.map(function (e) {
                  var t = {};
                  for (var n in e)
                    tu.key(n) ? n == r && (t.value = e[n]) : (t[n] = e[n]);
                  return t;
                });
              },
              r = 0;
    ...
    t))
      tu.key(r) && n.push({ name: r, tweens: ju(t[r], e) });
    return n;
  }
  function zu(e, t) {
    var n;
    return e.tweens.map(function (i) {
      ...
      return (
        ...
        (r.easing = lu(r.easing, r.duration)),
        (r.isPath = tu.pth(o)),
        (r.isPathTargetInsideSVG = r.isPath && tu.svg(t.target)),
        (r.isColor = tu.col(r.from.original)),
        r.isColor && (r.round = 1),
        (n = r),
        r
      );
  ...
  var Hu = [],
    Gu = (function () {
      var e;
      function t(n) {
        for (var i = Hu.length, r = 0; r < i; ) {
          var o = Hu[r];
          o.paused ? (Hu.splice(r, 1), i--) : (o.tick(n), r++);
        }
      ...
      return (
        ...
        function () {
          e ||
            (Wu() && Ku.suspendWhenDocumentHidden) ||
            !(Hu.length > 0) ||
  ...
  function Ku(e) {
    ...
    function l() {
      var e = c.direction;
      "alternate" !== e &&
        (c.direction = "normal" !== e ? "normal" : "reverse"),
    ...
    function h() {
      (n = 0), (i = u(c.currentTime) * (1 / Ku.speed));
    }
    function d(e, t) {
    ...
    function p(e) {
      for (var t = 0, n = c.animations, i = n.length; t < i; ) {
        ...
        for (
          var u = Xl(e - l.start - l.delay, 0, l.duration) / l.duration,
          ...
          (g = l.isPath
            ? Nu(l.value, h * b, l.isPathTargetInsideSVG)
            : w + h * (b - w)),
            p && ((l.isColor && y > 2) || (g = Math.round(g * p) / p)),
            f.push(g);
        }
        var x = d.length;
        if (x) {
        ...
        Vu[r.type](o.target, r.property, m, o.transforms),
          (r.currentValue = m),
          t++;
      }
    }
    ...
    function v(e) {
      ...
      (c.progress = Xl((y / h) * 100, 0, 100)),
        ...
        !c.loopBegan &&
          c.currentTime > 0 &&
          ((c.loopBegan = !0), f("loopBegin")),
        y <= v && 0 !== c.currentTime && p(0),
        ((y >= m && c.currentTime !== h) || !h) && p(h),
        y > v && y < m
          ? (c.changeBegan ||
              ((c.changeBegan = !0),
              (c.changeCompleted = !1),
    ...
    return (
      ...
      (c.play = function () {
        c.paused &&
          (c.completed && c.reset(), (c.paused = !1), Hu.push(c), h(), Gu());
      }),
      (c.reverse = function () {
  ...
  function Yu(e, t) {
    for (var n = t.length; n--; )
      fu(e, t[n].animatable.target) && t.splice(n, 1);
  }
  function Ju(e, t) {
    var n = t.animations,
      i = t.children;
    ...
    for (var r = i.length; r--; ) {
      var o = i[r],
        s = o.animations;
      Yu(e, s), s.length || o.children.length || i.splice(r, 1);
    }
    n.length || i.length || t.pause();
  }
  (Ku.version = "3.2.1"),
    (Ku.speed = 1),
    (Ku.suspendWhenDocumentHidden = !0),
    (Ku.running = Hu),
    (Ku.remove = function (e) {
      for (var t = Lu(e), n = Hu.length; n--; ) {
        Ju(t, Hu[n]);
      }
    }),
    (Ku.get = Cu),
    (Ku.set = qu),
    (Ku.convertPx = _u),
    (Ku.path = function (e, t) {
      var n = tu.str(e) ? uu(e)[0] : e,
        i = t || 100;
      return function (e) {
        return {
          property: e,
          el: n,
          svg: Du(n),
          totalLength: Pu(n) * (i / 100),
        };
      };
    }),
    (Ku.setDashoffset = function (e) {
      var t = Pu(e);
      return e.setAttribute("stroke-dasharray", t), t;
    }),
    (Ku.stagger = function (e, t) {
      void 0 === t && (t = {});
      var n = t.direction || "normal",
        i = t.easing ? lu(t.easing) : null,
        r = t.grid,
        o = t.axis,
        s = t.from || 0,
        a = "first" === s,
      ...
      return function (e, t, y) {
        if (
          (a && (s = 0), c && (s = (y - 1) / 2), l && (s = y - 1), !v.length)
        ) {
          for (var g = 0; g < y; g++) {
            if (r) {
      ...
      return (
        ...
        (t.add = function (n, i) {
          ...
          (c.autoplay = !1),
            ...
            (c.timelineOffset = tu.und(i) ? l : Ou(i, l)),
            s(t),
    ...
    class extends bn {
      ...
      update(e, [t]) {
        ...
        for (const e in t) {
          ...
          null != i &&
            (this.ct.add(e),
            e.includes("-") ? n.setProperty(e, i) : (n[e] = i));
        }
        return he;
      }
    }
  );
  let Zu = class extends Ae {
    constructor() {
      super(),
        (this.name = ""),
        (this.isOpen = !1),
    ...
    render() {
      return !Je.getState() || st.getState() < Be.Optimal
        ? ""
        : le`<div class="tooltip"> <slot></slot> </div>`;
    }
  };
  r([u({ type: String, reflect: !0 })], Zu.prototype, "name", void 0),
    r([u({ type: Boolean, reflect: !0 })], Zu.prototype, "isOpen", void 0),
    r([u({ type: Boolean })], Zu.prototype, "small", void 0),
    (Zu = r([c("mona-lisa-tooltip")], Zu));
  const eh = { rootMargin: "200px" },
    th = new Map();
  function nh(e, t) {
    return (
      !th.has(e) &&
          ...
          (function (e) {
            return new IntersectionObserver((e) => {
              for (const t of e) {
                const e = t.target;
                t.isIntersecting
                  ? e.observerIsIntersectingCallback(t)
                  : e.observerIsNotIntersectingCallback(t);
              }
            }, e);
          })(t)
        ),
  ...
  const ih = Symbol("mixins/observer");
  const rh = Symbol("mixins/user-action");
  let oh = class extends (function (e) {
    if (rh in e) return e;
    class t extends e {
      constructor() {
        super(...arguments),
      ...
      class t extends e {
        ...
        enableObserver(e = eh) {
          if (!this._observerConfigObserved) {
            ...
            const t = nh(this._observerConfigObserved, e);
            t && t.observe(this);
          }
        }
        disableObserver() {
          if (this._observerConfigObserved) {
            const e = nh(this._observerConfigObserved);
    ...
    connectedCallback() {
      super.connectedCallback(),
        this.img ||
          (this.loading === w.Lazy
            ? this.enableObserver()
            : this.loading === w.Action
            ? this.enableUserActions()
            : this.loading === w.Eager && this.loadContent());
    }
    ...
    render() {
      ...
      let t = le` <slot name="${pn(e ? "loading" : void 0)}"></slot> `;
      return (
        this.img &&
          (t = this.objectfit
            ? le` <img src="${this.src}" alt="${pn(this.alt)}" style="${Xu({
                objectFit: encodeURIComponent(this.objectfit),
              })}"> `
            : le` <img src="${this.src}" alt="${pn(this.alt)}"> `),
        le` <div class="${this.img ? "loaded" : "placeholder"}" style="${Xu({
          width: this.width ? this.width + "px" : "inherit",
          height: this.height ? this.height + "px" : "inherit",
        })}" tabindex="${pn(this.isActionable ? 0 : void 0)}"> ${t} </div> `
      );
    }
  };
  r([u({ type: String })], oh.prototype, "src", void 0),
    r([u({ type: String })], oh.prototype, "loading", void 0),
    r([u({ type: Number })], oh.prototype, "width", void 0),
    r([u({ type: Number })], oh.prototype, "height", void 0),
    r([u({ type: String })], oh.prototype, "perfmark", void 0),
    r([u({ type: String })], oh.prototype, "objectfit", void 0),
    r([u({ type: String })], oh.prototype, "alt", void 0),
    (oh = r([c("faceplate-img")], oh));
  const sh = ["[blocked user]"];
  function ah(e, t, n = Date.now()) {
    return { when: n, where: { x: e, y: t } };
  }
  let ch = class extends on(Ae) {
    constructor() {
      super(),
        (this.pixelX = -1),
        (this.pixelY = -1),
          ...
          if (((this.movePathDistance = 0), 1 === e.targetTouches.length)) {
            ...
            (this.isDragging = !0),
              (this.firstTouch = this.lastTouch =
                ah((t.clientX + n.clientX) / 2, (t.clientY + n.clientY) / 2));
          }
        })),
        (this.onMouseDown = at((e) => {
          (this.movePathDistance = 0),
            0 === e.button &&
              ((this.isDragging = !0),
              (this.lastMouseDown = ah(e.clientX, e.clientY)));
        })),
        (this.onTouchMove = at((e) => {
          if (this.camera && e.composedPath().includes(this.camera)) {
            if (
              ...
              if (t) {
                ...
                if (this.isDragging && e) {
                  const e =
                      t.clientX -
                      (this.lastTouch.where.x || this.lastMouseDown.where.x),
                    n =
                      t.clientY -
                      (this.lastTouch.where.y || this.lastMouseDown.where.y);
                  (e || n) &&
                    (this.moveBy(e, n),
                    (this.movePathDistance += cl(0, 0, e, n))),
                    (this.lastTouch = ah(t.clientX, t.clientY));
                }
              }
            }
            if (2 === e.targetTouches.length) {
              const t = e.targetTouches[0],
                n = e.targetTouches[1];
              if (t && n) {
                const e = cl(t.clientX, t.clientY, n.clientX, n.clientY),
                ...
                if (this.isDragging) {
                  ...
                  (e || t) &&
                    (this.moveBy(e, t),
                    (this.movePathDistance += cl(0, 0, e, t))),
                    (this.lastTouch = ah(i, r));
                }
        ...
        (this.onMouseMove = at((e) => {
          this.camera &&
            e.composedPath().includes(this.camera) &&
            (e.preventDefault(),
            e.stopPropagation(),
            this.showColorPicker || this.trackEraseToolThrottled(e),
            this.isDragging &&
              "number" == typeof e.movementX &&
              "number" == typeof e.movementY &&
              (e.movementX || e.movementY) &&
              (this.moveBy(e.movementX, e.movementY),
              (this.movePathDistance += cl(0, 0, e.movementX, e.movementY))));
        })),
        (this.trackEraseTool = at((e) => {
          var t;
          if (
            ht.getState() &&
            (null === (t = dt.getState()[0]) || void 0 === t ? void 0 : t.x)
          ) {
            const t = this.clientToCanvas(e);
            if (!t) return;
            dt.updateState([dt.getState()[0], t]);
          }
        })),
        (this.trackEraseToolThrottled = un(50, !1, this.trackEraseTool)),
        (this.onTouchStop = at(() => {
          (this.isDragging = !1),
            (this.prevVectorDiff = 0),
            this.isPinching &&
              ((this.isPinching = !1), (this.pinchEndedTimestamp = Date.now()));
        })),
        (this.onMouseUp = at((e) => {
          if (
            ((this.isDragging = !1),
          ...
          if (this.firstTouch.when > 0) {
            ...
            if (
              cl(t.x, t.y, e.clientX, e.clientY) >= 5 ||
              Date.now() - n >= 300
            )
              return;
          ...
          if (
            this.movePathDistance >= 5 ||
            Date.now() - this.pinchEndedTimestamp < 300
          )
            return;
          const t = this.clientToCanvas(e);
          t &&
        ...
        (this.fetchPixelHistoryDebounced = hn(50, this.fetchPixelHistory)),
        (this.onWheel = at((e) => {
        ...
        (this.animatePositionDebounced = un(300, !1, this.animatePosition)),
        (this.animateScheduledPositionDebounced = hn(
          50,
          !1,
    ...
    initialize() {
      ...
      if (
        ...
        (this.prevVectorDiff = 0),
        null === (e = this.cameraAnimation) || void 0 === e || e.pause(),
        null === (t = this.showTooltipAnimation) || void 0 === t || t.pause(),
        (this.tooltipName = ""),
        !Ze.getState())
      ) {
        const e = this.calculateZoomFromPx();
        e && ((this.zoom = e), st.updateState(this.zoom));
      }
      this.updateCameraDimensions(),
        ...
        this.camera &&
          (null === (n = this.resizeObserver) ||
            void 0 === n ||
            n.unobserve(this.camera),
          (this.resizeObserver = new ResizeObserver(this.onCameraResize)),
          null === (i = this.resizeObserver) ||
            void 0 === i ||
            i.observe(this.camera)),
        Ke.getState().camera ||
          Ke.updateState(
            Object.assign(Object.assign({}, Ke.getState()), { camera: !0 })
          );
    }
    clientToCamera(e) {
      var t;
    ...
    moveBy(e, t) {
      ...
      (this.nextCx = void 0),
        (this.nextCy = void 0),
        (this.nextZoom = void 0),
        this.applyPosition({ x: this.cx - e * n, y: this.cy - t * n });
    }
    selectPixel(e) {
      st.updateState(this.zoom);
      const t = g("click-canvas", e);
      this.dispatchEvent(t);
    }
    getTooltipOverride({ x: e, y: t }) {
      var n;
      const i = pt.getState();
      if ((null == i ? void 0 : i.x) === e && (null == i ? void 0 : i.y) === t)
        return null === (n = et.getState()) || void 0 === n ? void 0 : n.name;
    }
    async fetchPixelHistory(e) {
      if (
        ((this.lastFetchedHistoryPixel = e),
        (this.tooltipName = ""),
        !this.showPixelHistory || !this.isTileHistoryEnabled || !Je.getState())
      )
        return;
      const t = this.getTooltipOverride(e);
      if (t) return (this.tooltipName = t), void this.showTooltip();
      const n = { x: e.x, y: e.y },
        i = await yl.getPixelHistory(n),
        r = sl();
      if (e.x === r.x && e.y === r.y)
        if (i.type === ml.Success) {
          const { data: t } = i;
          (this.tooltipName =
            this.getTooltipOverride(e) ||
            (t && Number.isInteger(t.lastModifiedTimestamp)
              ? t.userInfo.username
              : "")),
            this.showTooltip();
        } else
          i.type === ml.UnauthorizedError &&
            this.dispatchEvent(g("api-error", i));
    }
    zoomAt(e, t) {
      var n;
    ...
    getRandomCenter() {
      ...
      const n = this.calculateZoomFromPx() || this.zoom,
        ...
        r =
          (null === (e = this.cameraRect) || void 0 === e ? void 0 : e.width) ||
          0,
        o =
          (null === (t = this.cameraRect) || void 0 === t
            ? void 0
            : t.height) || 0,
        s = ut.getState(),
        a = lt.getState(),
      ...
      return {
        x:
          r >= s * n
            ? s / 2
            : Math.min(Math.max(Math.ceil(i.x), c.x), Math.floor(s - i.x)),
        y:
          o >= a * n
            ? a / 2
            : Math.min(Math.max(Math.ceil(i.y), c.y), Math.floor(a - i.y)),
      };
    }
    renderCurrentPosition() {
      var e, t;
      if (this.zoomContainer) {
        const e = this.zoom / Ge().max;
      ...
      if (this.pixel) {
        ...
        (this.pixel.style.transform = `translateX(${o}px) translateY(${s}px)`),
          this.showPixelHistory &&
            ...
            ((null === (e = this.lastFetchedHistoryPixel) || void 0 === e
              ? void 0
              : e.x) !== i.x ||
              (null === (t = this.lastFetchedHistoryPixel) || void 0 === t
                ? void 0
                : t.y) !== i.y) &&
            ((this.tooltipName = ""),
            Je.getState() &&
              st.getState() >= Be.Optimal &&
              this.fetchPixelHistoryDebounced(i));
      }
    }
    applyPosition({
      x: e = this.cx,
      ...
      const i = Ge();
      (this.zoom = Math.max(i.min, Math.min(n, i.max))),
        this.updateCameraBoundaries(),
        this.updateVisiblePixels(),
        (this.cx = Math.max(0, Math.min(e, ut.getState() - 1))),
        (this.cy = Math.max(0, Math.min(t, lt.getState() - 1))),
        this.renderCurrentPosition(),
        this.sendMoveCameraEvent();
    }
    schedulePosition({
      x: e = this.cx,
      y: t = this.cy,
      ...
      (this.nextCx = Math.max(0, Math.min(e, ut.getState() - 1))),
        (this.nextCy = Math.max(0, Math.min(t, lt.getState() - 1)));
      const i = Ge();
    ...
    animatePosition({
      ...
      null === (r = this.cameraAnimation) || void 0 === r || r.pause(),
        Je.getState()
          ? (this.schedulePosition({ x: e, y: t, zoom: n }),
            this.animateScheduledPosition({ zoomEasing: i }))
          : this.applyPosition({ x: e, y: t, zoom: n });
    }
    animateScheduledPosition({ zoomEasing: e = "easeInQuint" }) {
      const t = { x: this.cx, y: this.cy },
        n = { zoom: this.zoom };
      this.cameraAnimation = Ku.timeline({
        delay: 0,
        update: () => {
    ...
    updateVisiblePixels() {
      if (this.cameraBoundaries) {
        ...
        this.dispatchEvent(g("update-visible-pixels", { px: e }));
      }
    }
    sendMoveCameraEvent() {
      this.cameraRect &&
        this.dispatchEvent(g("move-camera", { x: this.cx, y: this.cy }));
    }
    getVisibilityRect() {
      if (!this.cameraRect) return;
      const { width: e, height: t } = this.cameraRect;
      return (function (e, t, n, i, r) {
        const o = ol({ x: Math.floor(e), y: Math.floor(t) }),
          s = ol({ x: Math.ceil(e + n / r), y: Math.ceil(t + i / r) });
    ...
    handleProfileClick(e) {
      e.preventDefault(),
        e.stopPropagation(),
        sh.includes(this.tooltipName) ||
          (this.trackEvent(
            Zt({ source: en.HotPotato, action: tn.Click, noun: nn.Username })
          ),
          this.dispatchEvent(
            g("host-communication", {
              type: $t.OpenProfile,
              data: { profileName: this.tooltipName },
            })
          )),
        (this.tooltipName = "");
    }
              ...
              ${
                this.showPixelHistory
                  ? le`
                    ...
                    >
                      <button class="profile-button" @mousedown=${
  ...
  r([u({ type: Boolean, attribute: "is-ios" })], ch.prototype, "isIOS", void 0),
    r(
      [u({ type: Boolean, attribute: "is-safari" })],
      ch.prototype,
      "isSafari",
      void 0
    ),
    r(
      [u({ type: Boolean, attribute: "is-show-color-picker" })],
      ch.prototype,
      "showColorPicker",
      void 0
    ),
    r(
      [u({ type: Boolean, attribute: "show-pixel-history" })],
      ch.prototype,
      "showPixelHistory",
      void 0
    ),
    r(
      [u({ type: Number, attribute: "pixel-x" })],
      ch.prototype,
      "pixelX",
      void 0
    ),
    r(
      [u({ type: Number, attribute: "pixel-y" })],
      ch.prototype,
      "pixelY",
      void 0
    ),
    r([h()], ch.prototype, "tooltipName", void 0),
    r([p(".camera")], ch.prototype, "camera", void 0),
    r([p(".zoom-container")], ch.prototype, "zoomContainer", void 0),
    r([p(".position-container")], ch.prototype, "positionContainer", void 0),
    r([p(".pixel")], ch.prototype, "pixel", void 0),
    r([p("mona-lisa-tooltip")], ch.prototype, "tooltip", void 0),
    (ch = r([c("mona-lisa-camera")], ch));
  let lh = class extends Ae {
    ...
    drawPixel({ x: e, y: t, colorIndex: n }) {
      ...
      const r =
        null === (i = this.canvas) || void 0 === i
          ? void 0
          : i.getContext("2d");
      r && ((r.fillStyle = Et(n) || "transparent"), r.fillRect(e, t, 1, 1));
    }
    getPixelColor(e) {
      try {
    ...
    initialize() {
      ...
      let n;
      try {
        n = t.getImageData(0, 0, ut.getState(), lt.getState());
      } catch (e) {
        vn(e);
      }
      (this.canvas.height = lt.getState()),
        (this.canvas.width = ut.getState()),
        n && t.putImageData(n, 0, 0),
        Ke.getState().canvas ||
          Ke.updateState(
            Object.assign(Object.assign({}, Ke.getState()), { canvas: !0 })
          );
    }
    getImageData(e, t, n, i) {
      ...
      return null ===
        (o =
          null === (r = this.canvas) || void 0 === r
            ? void 0
            : r.getContext("2d")) || void 0 === o
        ? void 0
        : o.getImageData(e, t, n, i);
    }
    render() {
      const e = Ge();
      return le` <div class="container" style="${Xu(
  ...
  r([u({ type: Boolean, attribute: "is-ios" })], lh.prototype, "isIOS", void 0),
    r(
      [u({ type: Boolean, attribute: "is-safari" })],
      lh.prototype,
      "isSafari",
    ...
    r([p("canvas")], lh.prototype, "canvas", void 0),
    (lh = r([c("mona-lisa-canvas")], lh)),
    an(
      "icon-close",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M18.442 2.442l-.884-.884L10 9.116 2.442 1.558l-.884.884L9.116 10l-7.558 7.558.884.884L10 10.884l7.558 7.558.884-.884L10.884 10l7.558-7.558z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M18.707 2.707l-1.414-1.414L10 8.586 2.707 1.293 1.293 2.707 8.586 10l-7.293 7.293 1.414 1.414L10 11.414l7.293 7.293 1.414-1.414L11.414 10l7.293-7.293z"/></svg>`
    );
  let uh = class extends Ae {
    ...
    handleClose() {
      Je.updateState(!1),
        this.dispatchEvent(g("host-communication", { type: $t.Close }));
    }
    render() {
      return le` <mona-lisa-icon-button @click="${this.handleClose}"> <icon-close></icon-close> </mona-lisa-icon-button>`;
    }
  };
  (uh = r([c("mona-lisa-close-button")], uh)),
    an(
      "icon-checkmark",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M7.5 15.583a.72.72 0 01-.513-.212L1.558 9.942l.884-.884L7.5 14.116 18.058 3.558l.884.884L8.013 15.371a.72.72 0 01-.513.212z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M7.5 15.958a1.1 1.1 0 01-.778-.322l-5.429-5.429 1.414-1.414L7.5 13.586 17.793 3.293l1.414 1.414L8.278 15.636a1.1 1.1 0 01-.778.322z"/></svg>`
    );
  const hh = `${CLIENT_CONFIG.REDDIT_ORIGIN}/r/place`;
  function dh(e) {
    const t = new URL(
        e
          ? "https://reddit.app.link/place"
          : hh
      ),
      n = sl();
    t.searchParams.set(Ue.CX, `${n.x}`),
      t.searchParams.set(Ue.CY, `${n.y}`),
      t.searchParams.set(Ue.PX, `${Math.floor(ot.getState())}`),
      t.searchParams.set(Ue.UTMSource, "share");
    const i = (function () {
      var e, t;
      return Ht()
        ? "ios_app"
        ...
        ? null ===
            (t =
              null === (e = tt.getState()) || void 0 === e ? void 0 : e.app) ||
          void 0 === t
          ? void 0
          : t.name
        : void 0;
  ...
  an(
    "icon-history",
    ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M13.558 14.442l-4.183-4.183V4h1.25v5.741l3.817 3.817-.884.884z"/><path d="M10 19.625A9.625 9.625 0 1119.625 10 9.636 9.636 0 0110 19.625zm0-18A8.375 8.375 0 1018.375 10 8.384 8.384 0 0010 1.625z"/></svg>`,
    ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M10 .375A9.625 9.625 0 1019.625 10 9.636 9.636 0 0010 .375zm3.47 14.155l-4.22-4.219V4h1.5v5.689l3.78 3.781z"/></svg>`
  );
  let ph = class extends Ae {
    constructor() {
      super(...arguments),
        (this.userData = vt(this, et)),
        (this.isEraseToolOn = vt(this, ht));
    }
    static get styles() {
    ...
    onSignInClick() {
      this.dispatchEvent(
        g("host-communication", { type: $t.SignIn, data: { dest: dh(!1) } })
      );
    }
    onPlaceATileClick() {
      this.dispatchEvent(
        g("click-canvas", { x: it.getState(), y: rt.getState() })
      );
    }
    render() {
      var e;
      if (
        !(null === (e = this.userData.state()) || void 0 === e
          ? void 0
          : e.canParticipate)
      )
        return le`<button @click="${this.onSignInClick}"> <div class="pill"> Log in to place a tile </div> </button>`;
      if (this.nextTileAvailableIn) {
        const e = `${Math.floor(this.nextTileAvailableIn / 3600)}`.padStart(
            2,
            "0"
          ),
          t = `${Math.floor((this.nextTileAvailableIn % 3600) / 60)}`.padStart(
            2,
            "0"
          ),
      ...
      return this.isEraseToolOn.state()
        ? le` <div class="pill"> Select area to erase </div> `
        : le` <button @click="${this.onPlaceATileClick}"> <div class="pill"> Place a tile </div> </button> `;
    }
  };
  r(
    [u({ type: Number, attribute: "next-tile-available-in" })],
    ph.prototype,
    "nextTileAvailableIn",
    void 0
  ),
    (ph = r([c("mona-lisa-status-pill")], ph));
...
.color-container {
  position: relative;
  height: 32px;
  flex: 0 0 var(--colors-min-width, 12.5%);
}
@media (min-width: 460px) {
  .color-container {
    flex: 0 0 calc(100% / var(--colors-multiplier, 16) * 2);
  }
}
@media (min-width: 800px) {
  .color-container {
...
`
    ...
    updated(e) {
      ...
      const n =
        null === (t = ct.getState()) || void 0 === t
          ? void 0
          : t.colorPalette.colors;
      this.isVisible &&
        !this.isLocked &&
        1 === n.length &&
        this.selectColor(n[0].index),
        super.updated(e);
    }
    disconnectedCallback() {
      var e;
    ...
    selectColor(e) {
      this.selectedColor !== e &&
        this.dispatchEvent(g("select-color", { color: e }));
    }
    renderContent() {
      var e, t;
      const n =
          !!this.nextTileAvailableIn ||
          !(null === (e = et.getState()) || void 0 === e
            ? void 0
            : e.canParticipate),
        i = ht.getState() || (!this.isLocked && !n),
        r =
          null === (t = ct.getState()) || void 0 === t
            ? void 0
            : t.colorPalette.colors,
        o = null == this.selectedColor;
      return le` <div class="palette"> ${
        null == r
          ? void 0
          : r.map((e) => {
              const t = i && this.selectedColor === e.index,
                n = ((o = e.index), St[o]);
              var o;
              return le` <div class="color-container" style="${Xu({
                "--colors-multiplier": `${Math.max(r.length, 2)}`,
                "--colors-min-width": `${Math.max(12.5, 100 / r.length)}%`,
              })}"> <button class="color ${wn({ selected: t })}" data-color="${
                e.index
              }" @click="${this.onColorClick}"> <div style="${Xu({
                backgroundColor: e.hex,
                border: `1px solid ${kt(e.hex) && !t ? "#E9EBED" : e.hex}`,
              })}"></div> </button> ${
                n
                  ? le` <mona-lisa-tooltip isOpen small> <div class="color-name">${n}</div> </mona-lisa-tooltip> `
                  : ""
              } </div> `;
            })
      } ${
        i
          ? ""
          : le` <div class="overlay"> ${
              n
                ? le` <mona-lisa-status-pill next-tile-available-in="${pn(
                    this.nextTileAvailableIn
                  )}"></mona-lisa-status-pill> `
                : ""
            } </div> `
      } </div> <div class="actions"> <button class="cancel" @click="${
        this.cancelPixel
      }"> <icon-close></icon-close> </button> ${
        i
          ? le` <button class="confirm ${wn({
              disabled: o,
            })}" ?disabled="${o}" @click="${
              this.confirmPixel
            }"> <icon-checkmark></icon-checkmark> </button>`
          : ""
      } </div> `;
    }
    render() {
      ...
      })}"> <div class="layout">${this.renderContent()}</div> </div> `;
    }
  };
  r(
    [u({ type: Number, attribute: "color" })],
    fh.prototype,
    "selectedColor",
    void 0
  ),
    r(
      [u({ type: Boolean, attribute: "is-visible" })],
      fh.prototype,
      "isVisible",
      void 0
    ),
    r(
      [u({ type: Boolean, attribute: "is-locked" })],
      fh.prototype,
      "isLocked",
      void 0
    ),
    ...
    r([h()], fh.prototype, "contentHeight", void 0),
    r([p(".layout")], fh.prototype, "layout", void 0),
    (fh = r([c("mona-lisa-color-picker")], fh));
  let vh = class extends Ae {
    constructor() {
      super(),
        (this.syncCoordinatesToHost = un(500, !1, () => {
          const { cx: e, cy: t, px: n } = al();
          this.dispatchEvent(
            g("host-communication", {
              type: $t.SyncCoordinates,
              data: { cx: e, cy: t, px: n },
            })
          );
        })),
  ...
  yh = r([c("mona-lisa-help-button")], yh);
  let gh = class extends Ae {
    ...
    render() {
      const e = pl(),
        t = this.calculateDimension("y", dt.getState(), e),
        n = this.calculateDimension("x", dt.getState(), e);
      return le` <div class="pixel" style="${Xu({
        height: `${t}%`,
        width: `${n}%`,
  ...
  r([u({ type: Number, reflect: !0 })], gh.prototype, "color", void 0),
    (gh = r([c("mona-lisa-erasure-preview")], gh)),
    an(
      "icon-external-link",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M15.838 16.5a1.377 1.377 0 01-1.375 1.375h-11A1.377 1.377 0 012.088 16.5v-11a1.377 1.377 0 011.375-1.375H7.11v-1.25H3.463A2.629 2.629 0 00.838 5.5v11a2.629 2.629 0 002.625 2.625h11a2.629 2.629 0 002.625-2.625v-3.6h-1.25z"/><path d="M18.5.875h-5v1.25h3.491l-8.433 8.433.884.884 8.433-8.433V6.5h1.25v-5A.625.625 0 0018.5.875z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M15 16a1 1 0 01-1 1H3.926a1 1 0 01-1-1V6a1 1 0 011-1h3.3V3h-3.3a3 3 0 00-3 3v10a3 3 0 003 3H14a3 3 0 003-3v-3.225h-2z"/><path d="M18 1.375h-5a.625.625 0 00-.442 1.067l1.793 1.793-6.058 6.058 1.414 1.414 6.058-6.058 1.793 1.793a.625.625 0 00.442.183.64.64 0 00.239-.047.626.626 0 00.386-.578V2A.625.625 0 0018 1.375z"/></svg>`
    );
  let bh = class extends Ae {
    ...
    render() {
      return le` <div class="overlay" @click="${
        ...
        this.handleModalClose
      }"></icon-close> </div> <div class="modal-content"> <slot></slot> </div> <div class="modal-footer"> <mona-lisa-mute-button></mona-lisa-mute-button> ${
        this.showHelpLink
          ? le` <a class="help-link" target="_blank" href="https://www.reddit.com/r/place/comments/ttqdrt/welcome_to_rplace/" rel="noopener nofollow"> <div class="help-link-layout"> <icon-external-link></icon-external-link> </div> </a> `
          : ""
      } <img alt="Place Logo" src="${
        CLIENT_CONFIG.STATIC_BASE_URL
      }assets/img/place-logo.svg" height="40" width="40"> </div> </div>`;
    }
  };
  r([u({ type: String, reflect: !0 })], bh.prototype, "name", void 0),
    r([u({ type: String })], bh.prototype, "header", void 0),
    r([u({ type: Boolean, reflect: !0 })], bh.prototype, "isOpen", void 0),
    r(
      [u({ type: Boolean, attribute: "show-help-link" })],
      bh.prototype,
      "showHelpLink",
      void 0
    ),
    (bh = r([c("mona-lisa-modal")], bh)),
    an(
      "icon-volume",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M10.543.5a1.12 1.12 0 00-1.182.117L3.789 4.875h-1.8A1.127 1.127 0 00.868 6v8a1.127 1.127 0 001.125 1.125h1.8l5.572 4.258a1.117 1.117 0 00.681.232 1.128 1.128 0 001.127-1.126V1.511A1.119 1.119 0 0010.543.5zm-.624 17.736l-5.708-4.361H2.118v-7.75h2.093l5.708-4.361zM13 3.375v1.25a5.375 5.375 0 010 10.75v1.25a6.625 6.625 0 000-13.25z"/><path d="M16.125 10A3.129 3.129 0 0013 6.875v1.25a1.875 1.875 0 010 3.75v1.25A3.129 3.129 0 0016.125 10z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M10.543.5a1.12 1.12 0 00-1.182.117L3.789 4.875h-1.8A1.127 1.127 0 00.868 6v8a1.127 1.127 0 001.125 1.125h1.8l5.572 4.258a1.117 1.117 0 00.681.232 1.128 1.128 0 001.127-1.126V1.511A1.119 1.119 0 0010.543.5zM13 3v2a5 5 0 010 10v2a7 7 0 000-14z"/><path d="M16.5 10A3.5 3.5 0 0013 6.5v2a1.5 1.5 0 010 3v2a3.5 3.5 0 003.5-3.5z"/></svg>`
    ),
    an(
      "icon-volume-mute",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M19.442 7.442l-.884-.884L16.5 8.616l-2.058-2.058-.884.884L15.616 9.5l-2.058 2.058.884.884 2.058-2.058 2.058 2.058.884-.884L17.384 9.5l2.058-2.058zM10.543.5a1.12 1.12 0 00-1.182.117L3.789 4.875h-1.8A1.127 1.127 0 00.868 6v8a1.127 1.127 0 001.125 1.125h1.8l5.572 4.258a1.117 1.117 0 00.681.232 1.128 1.128 0 001.127-1.126V1.511A1.119 1.119 0 0010.543.5zm-.624 17.736l-5.708-4.361H2.118v-7.75h2.093l5.708-4.361z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M19.707 7.707l-1.414-1.414L16.5 8.086l-1.793-1.793-1.414 1.414L15.086 9.5l-1.793 1.793 1.414 1.414 1.793-1.793 1.793 1.793 1.414-1.414L17.914 9.5l1.793-1.793zM10.543.5a1.12 1.12 0 00-1.182.117L3.789 4.875h-1.8A1.127 1.127 0 00.868 6v8a1.127 1.127 0 001.125 1.125h1.8l5.572 4.258a1.117 1.117 0 00.681.232 1.128 1.128 0 001.127-1.126V1.511A1.119 1.119 0 0010.543.5z"/></svg>`
    );
  let wh = class extends Ae {
    constructor() {
    ...
    toggleMute() {
      (this.audioIsMuted = !this.audioIsMuted), bl(wl)(this.audioIsMuted);
      try {
        localStorage.setItem(
          "ml-muted-state",
          JSON.stringify(this.audioIsMuted)
        );
      } catch (e) {
        vn(e);
      }
    ...
    connectedCallback() {
      super.connectedCallback();
      try {
        (this.audioIsMuted = JSON.parse(
          `${localStorage.getItem("ml-muted-state")}`
        )),
          bl(wl)(this.audioIsMuted);
      } catch (e) {
        vn(e);
      }
    }
    render() {
      return le` <mona-lisa-icon-button class="${wn({
        muted: !this.audioIsMuted,
      })}" @click="${this.toggleMute}"> ${
        this.audioIsMuted
          ? le`<icon-volume-mute></icon-volume-mute>`
          : le`<icon-volume></icon-volume>`
      } </mona-lisa-icon-button> `;
    }
  };
  r([h()], wh.prototype, "audioIsMuted", void 0),
    (wh = r([c("mona-lisa-mute-button")], wh));
  ...
  r([u({ type: String })], xh.prototype, "height", void 0),
    r([u({ type: String })], xh.prototype, "width", void 0),
    (xh = r([c("mona-lisa-target")], xh));
  let _h = class extends Ae {
    ...
    render() {
      return le` <div class="pixel" style="${Xu({
        backgroundColor: Et(this.color),
      })}"> ${
        "number" != typeof this.color
          ? le`<mona-lisa-target height="120%" width="120%"></mona-lisa-target>`
          : ""
      } </div> `;
    }
  };
  r([u({ type: Number, reflect: !0 })], _h.prototype, "color", void 0),
    (_h = r([c("mona-lisa-pixel-preview")], _h)),
    an(
      "icon-share-android",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M15.5 13.375a3.108 3.108 0 00-2.295 1.025l-5.769-3.369a2.907 2.907 0 000-2.062L13.205 5.6a3.113 3.113 0 10-.83-2.1 3.075 3.075 0 00.189 1.031L6.8 7.9a3.125 3.125 0 100 4.208l5.769 3.365a3.075 3.075 0 00-.189 1.031 3.125 3.125 0 103.12-3.129zm0-11.75A1.875 1.875 0 1113.625 3.5 1.877 1.877 0 0115.5 1.625zm-11 10.25A1.875 1.875 0 116.375 10 1.877 1.877 0 014.5 11.875zm11 6.5a1.875 1.875 0 111.875-1.875 1.877 1.877 0 01-1.875 1.875z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M15.5 13.375a3.109 3.109 0 00-2.131.852L7.574 10.5a3.083 3.083 0 00.051-.5 3.083 3.083 0 00-.051-.5l5.8-3.725a3.116 3.116 0 10-.999-2.275 3.083 3.083 0 00.051.5L6.631 7.727a3.125 3.125 0 100 4.546L12.426 16a3.083 3.083 0 00-.051.5 3.125 3.125 0 103.125-3.125z"/></svg>`
    ),
    an(
      "icon-share-ios",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M17.875 11v5.5a1.377 1.377 0 01-1.375 1.375h-13A1.377 1.377 0 012.125 16.5V11H.875v5.5A2.629 2.629 0 003.5 19.125h13a2.629 2.629 0 002.625-2.625V11z"/><path d="M9.375 3.009V14h1.25V3.009l2.933 2.933.884-.884-4-4a.625.625 0 00-.884 0l-4 4 .884.884z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M17 11v5a1 1 0 01-1 1H4a1 1 0 01-1-1v-5H1v5a3 3 0 003 3h12a3 3 0 003-3v-5z"/><path d="M9 4.414V13h2V4.414l2.293 2.293 1.414-1.414-4-4a1 1 0 00-1.414 0l-4 4 1.414 1.414z"/></svg>`
    );
  const Eh = on(Ae);
  let Sh = class extends Eh {
    constructor() {
      super(...arguments),
        (this.isAndroid = Qt() || navigator.userAgent.match(/Android/i));
    }
    static get styles() {
      return R`icon-share-android,icon-share-ios{display:inline-flex}`;
    }
    openShareSheet() {
      this.dispatchEvent(g("toggle-share-sheet", { isVisible: !0 })),
        this.trackEvent(
          Zt({ source: en.HotPotato, action: tn.Click, noun: nn.Share })
        );
    }
    render() {
      return le` <mona-lisa-icon-button @click="${this.openShareSheet}"> ${
        this.isAndroid
          ? le`<icon-share-android></icon-share-android>`
          : le`<icon-share-ios></icon-share-ios>`
      } </mona-lisa-icon-button> `;
    }
  };
  function kh(e) {
  ...
  function Ih(e) {
    ...
    return (
      (Ih = function (e) {
        ...
        function i() {
          return Ah(e, arguments, Ch(this).constructor);
        }
        return (
          (i.prototype = Object.create(e.prototype, {
            constructor: {
  ...
  Sh = r([c("mona-lisa-share-button")], Sh);
  var Mh = {
    ...
    function i(t) {
      ...
      if ("production" === process.env.NODE_ENV)
        ...
        for (
          ...
          r[o - 1] = arguments[o];
        n = e.call(this, Ph.apply(void 0, [Mh[t]].concat(r))) || this;
      }
      return kh(n);
    }
    return (
  ...
  function Rh(e, t, n) {
    return Nh(e) + "," + Nh(t) + "," + Nh(n);
  }
  function Lh(e, t, n, i) {
    if ((void 0 === i && (i = Rh), 0 === t)) return i(n, n, n);
  ...
  var jh,
    ...
    Vh = /^#[a-fA-F0-9]{3}$/,
    qh = /^#[a-fA-F0-9]{4}$/,
    Uh = /^rgb\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*\)$/i,
    Bh =
  ...
  function Gh(e) {
    if ("string" != typeof e) throw new Dh(3);
    var t = (function (e) {
    ...
    var o = Bh.exec(t.substring(0, 50));
    if (o)
      return {
        red: parseInt("" + o[1], 10),
    ...
    var l = Hh.exec(t.substring(0, 50));
    if (l) {
      var u =
          "rgb(" +
          Lh(
  ...
  r([u({ type: Number })], Kh.prototype, "height", void 0),
    r([u({ type: Number })], Kh.prototype, "width", void 0),
    (Kh = r([c("mona-lisa-logo")], Kh)),
    an(
      "icon-download",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M17.875 11v5.5a1.377 1.377 0 01-1.375 1.375h-13A1.377 1.377 0 012.125 16.5V11H.875v5.5A2.629 2.629 0 003.5 19.125h13a2.629 2.629 0 002.625-2.625V11z"/><path d="M9.741 14.583H10l.33-.029 4.112-4.112-.884-.884-2.933 2.933V1h-1.25v11.491L6.442 9.558l-.884.884 3.929 3.929.254.212z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M17.5 11v5.5a1 1 0 01-1 1h-13a1 1 0 01-1-1V11h-2v5.5a3 3 0 003 3h13a3 3 0 003-3V11z"/><path d="M9.586 14.958H10l.485-.029 4.222-4.222-1.414-1.414L11 11.586V1H9v10.586L6.707 9.293l-1.414 1.414 3.929 3.929.364.322z"/></svg>`
    ),
    an(
      "icon-location",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M10 .375A8.134 8.134 0 001.875 8.5c0 5.569 6.932 10.445 7.721 10.981a.716.716 0 00.4.126.7.7 0 00.4-.125c.791-.537 7.723-5.413 7.723-10.982A8.134 8.134 0 0010 .375zm0 17.861c-1.378-1-6.875-5.257-6.875-9.736a6.875 6.875 0 0113.75 0c0 4.477-5.493 8.736-6.875 9.736z"/><path d="M10 4.264a4.181 4.181 0 104.181 4.18A4.185 4.185 0 0010 4.264zm0 7.111a2.931 2.931 0 112.931-2.931A2.934 2.934 0 0110 11.375z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M10 .375A8.134 8.134 0 001.875 8.5c0 5.569 6.932 10.445 7.721 10.981a.716.716 0 00.4.126.7.7 0 00.4-.125c.791-.537 7.723-5.413 7.723-10.982A8.134 8.134 0 0010 .375zM10 12a3.556 3.556 0 113.556-3.556A3.556 3.556 0 0110 12z"/></svg>`
    ),
    an(
      "icon-image-post",
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M17.5.875h-15A1.627 1.627 0 00.875 2.5v15A1.627 1.627 0 002.5 19.125h15a1.627 1.627 0 001.625-1.625v-15A1.627 1.627 0 0017.5.875zM2.125 17.5v-2.741l2.7-2.7a2.377 2.377 0 013.358 0l5.812 5.812H2.5a.375.375 0 01-.375-.371zm15.75 0a.375.375 0 01-.375.375h-1.741l-6.7-6.7a3.629 3.629 0 00-5.126 0l-1.808 1.816V2.5a.375.375 0 01.375-.375h15a.375.375 0 01.375.375z"/><path d="M13 3.875A3.125 3.125 0 1016.125 7 3.129 3.129 0 0013 3.875zm0 5A1.875 1.875 0 1114.875 7 1.877 1.877 0 0113 8.875z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" data-name="icons final" viewBox="0 0 20 20"><path d="M8.179 12.063a2.377 2.377 0 00-3.358 0L.942 15.942l-.067-.067V17.5A1.627 1.627 0 002.5 19.125h12.741z"/><circle cx="13" cy="7" r="1.875"/><path d="M17.5.875h-15A1.627 1.627 0 00.875 2.5v11.741l3.062-3.062a3.629 3.629 0 015.126 0l7.879 7.879-.067.067h.625a1.627 1.627 0 001.625-1.625v-15A1.627 1.627 0 0017.5.875zm-4.5 9.25A3.125 3.125 0 1116.125 7 3.129 3.129 0 0113 10.125z"/></svg>`
    );
  let Yh = class extends Ae {
    constructor() {
      super(...arguments), (this.isPending = !1), (this.mode = jh.Image);
    }
    static get styles() {
      return Ve(
        `.cancel,
...
`
    ...
    onCancelClick() {
      this.dispatchEvent(g("toggle-share-sheet", { isVisible: !1 }));
    }
    async onShareClick() {
      this.dispatchEvent(g("share", { mode: this.mode }));
    }
    changeMode(e) {
      (this.mode = e.target.value),
        this.dispatchEvent(g("change-share-mode", { mode: this.mode }));
    }
    render() {
      return le` <div class="controls"> <button class="cancel" @click="${
        this.onCancelClick
      }"> <icon-close></icon-close> </button> <div class="modes"> ${[
        jh.Image,
        jh.Coordinates,
      ].map(
        (e) =>
          ...
          })}"> <input type="radio" name="mode" value="${e}" ?checked="${
            e === this.mode
          }" @change="${this.changeMode}"> ${
            e === jh.Coordinates
              ? le`<icon-location></icon-location>`
              : e === jh.Image
              ? le`<icon-image-post></icon-image-post>`
              : ""
          } </label> `
      )} </div> <button class="share" @click="${
        this.onShareClick
      }" ?disabled="${this.isPending}"> ${
        this.isPending
          ? le`<mona-lisa-loader></mona-lisa-loader>`
          : le`<icon-checkmark></icon-checkmark>`
      } </button> </div> `;
    }
  };
  r(
    [u({ type: Boolean, attribute: "is-pending" })],
    Yh.prototype,
    "isPending",
    void 0
  ),
    r([u({ type: String })], Yh.prototype, "mode", void 0),
    (Yh = r([c("mona-lisa-share-sheet")], Yh));
  const Jh = on(Ae);
  let Xh = class extends Jh {
    constructor() {
      super(),
        (this.isSafari = !1),
        (this.isSheetOpen = !1),
        ...
        (this.isSharing = !1),
        (this._events = new Le(this)),
        (this.onRegisterCamera = this._events.define("register-camera", (e) => {
        ...
        (this.onChangeShareMode = this._events.define(
          "change-share-mode",
          (e) => {
        ...
        (this.renderCoordinates = (e) => {
          ...
          return le` <div class="shadow ${wn({
            selected: e,
          })}"> <div class="coordinates"> <div class="backdrop" style="${Xu({
            backgroundColor: n,
            color: n && (Wh(n) < 0.5 ? "#fff" : "#000"),
          })}"> <span>${`${t.x}`.padStart(
            4,
            "0"
          )}</span> <span class="coordinate-y">${`${t.y}`.padStart(
            4,
            "0"
          )}</span> </div> <mona-lisa-logo></mona-lisa-logo> </div> </div> `;
        }),
        (this.renderImage = (e) =>
          le` <div class="lense ${wn({ selected: e })}"></div> `),
        vt(this, it),
        vt(this, rt),
        vt(this, Je);
    }
...
`
    ...
    async loadWatermarkImages() {
      ...
      try {
        e = await _l(
          `${CLIENT_CONFIG.STATIC_BASE_URL}assets/img/reddit-logo@3x.png`
        );
      } catch (e) {
        vn(e);
      }
      try {
        t = await _l(
          `${CLIENT_CONFIG.STATIC_BASE_URL}assets/img/r-place-logo@3x.png`
        );
      } catch (e) {
        vn(e);
      }
    ...
    async getFile() {
      if (this.mode === jh.Coordinates) {
        if (!this.coordinates) return;
        try {
          const { toBlob: e } = await import("./es-f0b7f1ca.js"),
        ...
        if (!c) return;
        const { redditLogo: l, rPlaceLogo: u } =
            await this.loadWatermarkImages(),
          h = !!l || !!u,
          d =
            (((null == l ? void 0 : l.width) || 0) +
              ((null == u ? void 0 : u.width) || 0) +
              168) /
            3,
          p = Math.max(Be.Min, 3 * Math.round(Math.max(st.getState(), d / s))),
        ...
        v.putImageData(
          ...
          h &&
            ((v.fillStyle = "#fff"),
            v.fillRect(0, a * p, s * p, 120),
            l && v.drawImage(l, 24, a * p + (120 - l.height) / 2),
            u && v.drawImage(u, s * p - u.width, a * p + (120 - u.height) / 2));
        try {
          ...
          return {
            ...
            file: this.blobToFile(
              e,
              `${Math.max(0, i)}_${Math.max(0, r)}_${Math.min(
                ut.getState(),
                o.x - 1
              )}_${Math.min(lt.getState(), o.y - 1)}.png`
            ),
          };
        } catch (e) {
          vn(e);
    ...
    async share() {
      const e = dh(this.mode === jh.Image),
        t = await this.getFile();
      if (!t) return;
      const { blob: n, file: i } = t;
      try {
        if (Wt()) {
        ...
        vn("Error while trying to share via Native Share API", e);
      }
      var r;
      this.trackEvent(
        ((r = this.mode),
        Zt(
          { source: en.HotPotato, action: tn.Complete, noun: nn.Share },
          { action_info: { reason: r } }
        ))
      );
      try {
        if ("share" in navigator) {
          const t =
            "canShare" in navigator && navigator.canShare({ files: [i] });
          return (
            await navigator.share(
              Object.assign({ url: e }, t ? { files: [i] } : {})
            ),
            void this.closeShareSheet()
          );
        }
      } catch (e) {
        vn("Error while trying to share via WebShare API", e);
      }
      try {
        ...
        vn("Error while trying to share via Clipboard API", e);
      }
    ...
    getCanvasPixelColor({ x: e, y: t }) {
      if (Ke.getState().camera && Ke.getState().canvas && this.canvas)
        return this.canvas.getPixelColor({ x: e, y: t });
    }
    renderShareMode(e, t) {
      const n = this.mode === e;
    ...
    render() {
      return le` <slot></slot> ${
        Je.getState() && this.renderShareUI
          ? le` <div class="share"> <div class="frame"> ${this.renderShareMode(
              jh.Coordinates,
              this.renderCoordinates
            )} ${this.renderShareMode(
              jh.Image,
              this.renderImage
            )} </div> <mona-lisa-share-sheet ?is-pending="${
              this.isSharing
            }" mode="${this.mode}"></mona-lisa-share-sheet> </div> `
          : ""
      } `;
    }
  };
  r(
    ...
    r(
      [u({ type: Boolean, attribute: "is-sheet-open" })],
      Xh.prototype,
      "isSheetOpen",
      void 0
    ),
    r([u({ type: Number })], Xh.prototype, "timestamp", void 0),
    r([h()], Xh.prototype, "mode", void 0),
    r([h()], Xh.prototype, "renderShareUI", void 0),
    r([h()], Xh.prototype, "renderAllFrames", void 0),
    r([h()], Xh.prototype, "isSharing", void 0),
    r([p(".coordinates")], Xh.prototype, "coordinates", void 0),
    r([p(".lense")], Xh.prototype, "lense", void 0),
    (Xh = r([c("mona-lisa-share-container")], Xh));
  let Zh = class extends Ae {
    ...
    updated() {
      this.input && (this.input.value = `${st.getState()}`);
    }
    onRangeInput(e) {
      const t = parseInt(e.currentTarget.value);
      isFinite(t) && this.dispatchEvent(g("change-zoom", { zoom: t }));
    }
    render() {
      const e = st.getState(),
        t = Ge();
      ...
      <div class="slider">
          ...
          <div class="dots">
            ${Array.from({ length: 5 }).map(
              (e, t, n) => le`
                <div
                  class="dot"
                  style=${Xu({ left: (t / (n.length - 1)) * 100 + "%" })}
                ></div>
              `
            )}
          </div>
        ...
        <div
          class="zoom"
          style=${Xu({ fontSize: (e >= Be.Min ? 14 : 12) + "px" })}
        >
          ${We()}x
        </div>
      </div>
  ...
  r([p("input")], Zh.prototype, "input", void 0),
    (Zh = r([c("mona-lisa-zoom-control")], Zh));
  let ed = class extends Ae {
    constructor() {
      super(...arguments),
        (this._handleOutsideClick = (e) => {
          e.composedPath().includes(this.childElements[0]) ||
            this.dispatchEvent(g("click-outside", { event: e }));
        });
    }
    updated(e) {
      e.has("active") && this.active
  ...
  r([u({ type: Boolean })], ed.prototype, "active", void 0),
    r([m({ flatten: !0 })], ed.prototype, "childElements", void 0),
    (ed = r([c("mona-lisa-outside-click-wrapper")], ed)),
    an(
      "icon-search",
      ue`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M19.4 18.6l-4.8-4.8c2.9-3.4 2.5-8.6-.9-11.5S5.2-.2 2.3 3.2s-2.5 8.6.9 11.5c3.1 2.6 7.6 2.6 10.6 0l4.8 4.8.8-.9zM8.5 15.4c-3.8 0-6.9-3.1-6.9-6.9s3.1-6.9 6.9-6.9 6.9 3.1 6.9 6.9c0 3.8-3.1 6.9-6.9 6.9z"/></svg>`,
      ue`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M19.7 18.3l-4.5-4.5c2.9-3.7 2.3-9.1-1.4-12S4.7-.5 1.8 3.2s-2.3 9.1 1.4 12c3.1 2.4 7.5 2.4 10.6 0l4.5 4.5 1.4-1.4zM8.5 15C4.9 15 2 12.1 2 8.5S4.9 2 8.5 2 15 4.9 15 8.5 12.1 15 8.5 15z"/></svg>`
    );
  let td = class extends Ae {
    ...
    toggleZoomControl() {
      (this.isActive = !this.isActive),
        this.dispatchEvent(g("toggle-zoom-control"));
    }
    render() {
      ...
      }"> <div class="zoom-wrapper"> <mona-lisa-icon-button class="${wn({
        visible: !this.showZoomControl,
      })}" @click="${
        this.toggleZoomControl
      }"> <icon-search></icon-search> </mona-lisa-icon-button> ${
        this.showZoomControl
          ? le`<mona-lisa-zoom-control></mona-lisa-zoom-control>`
          : ""
      } </div> </mona-lisa-outside-click-wrapper> `;
    }
  };
  r([u({ type: Boolean })], td.prototype, "showZoomControl", void 0),
    r([h()], td.prototype, "isActive", void 0),
    (td = r([c("mona-lisa-zoom-button")], td));
  const nd = (function (e) {
    if (El in e) return e;
    class t extends e {
      constructor() {
        super(...arguments),
          ...
          (this.onAppInitializationUpdate = () => {
            Ye() && this.stopIdleTimer();
          }),
          (this.stopIdleTimer = () => {
            clearTimeout(this.timeout), (this.timeout = void 0);
          }),
          (this.startIdleTimer = () => {
            if ((this.stopIdleTimer(), !Ye())) return;
            let e;
            document.hidden
              ? (this.hide(), (e = 3e5))
              : (this.wakeUp(), (e = 6e5)),
              this.tickUntil(e + Date.now());
          }),
          (this.tickUntil = (e) => {
            e >= Date.now()
              ? (this.timeout = window.setTimeout(() => this.tickUntil(e), 1e3))
              : this.idle();
          }),
          (this.startIdleTimerThrottled = un(1e3, !1, this.startIdleTimer)),
          (this.registerPageActivityThrottled = () => {
            this.status === Sl.Active
              ? this.startIdleTimerThrottled()
              : this.startIdleTimer();
          }),
          (this.idle = () => {
            this.changeStatus(Sl.Idle) && this.onInactive();
          }),
          (this.wakeUp = () => {
            this.status === Sl.Idle && this.onActive(),
              this.changeStatus(Sl.Active);
          }),
          (this.hide = () => {
            this.changeStatus(Sl.Hidden);
          });
      }
      toggleEvents(e, t) {
        [
          ...this.pageActivityEvents.document,
          ...this.pageVisibilityEvents.document,
        ].forEach((n) => document[e](n, t)),
          [
            ...this.pageActivityEvents.window,
            ...this.pageVisibilityEvents.window,
          ].forEach((n) => window[e](n, t));
      }
      connectedCallback() {
        var e;
        null === (e = super.connectedCallback) || void 0 === e || e.call(this),
          ...
          Ke.subscribe({ requestUpdate: this.onAppInitializationUpdate });
      }
      disconnectedCallback() {
        var e;
        null === (e = super.disconnectedCallback) ||
          void 0 === e ||
          e.call(this),
          this.toggleEvents(
            "removeEventListener",
      ...
      changeStatus(e) {
        return (
          this.status !== e &&
          ((this.status = e), fn(`Page activity status ${e}`), !0)
        );
      }
    }
    return (t[El] = !0), t;
    ...
    (function (e) {
      ...
      class t extends e {
        constructor() {
          super(...arguments),
            ...
            (this.injectAuthHeaders = (e, t) => {
              if (
                (fn("_injectAuthHeaders called"),
                !e || 0 === Object.keys(e).length)
              )
                return void fn("Received empty headers");
              let n = !0;
              this.headers
                ? ((n = JSON.stringify(this.headers) !== JSON.stringify(e)),
                  fn(
                    n
                      ...
                      : "Received identical headers"
                  ))
                : fn("Initializing headers"),
              ...
              i > 0
                ? (fn(
                    "Setting timer to request refresh: " + i.toString() + "ms"
                  ),
            ...
            (this.requestAuthRefresh = () => {
              this.dispatchEvent(
                g("host-communication", { type: $t.RefreshAuth })
              );
            }),
            (this.onInjectAuthHeaders = (e) => {
              if (xl(e.origin) && e.data.type === zt.InjectAuthHeaders)
        ...
        connectedCallback() {
          var e;
          null === (e = super.connectedCallback) ||
            void 0 === e ||
            e.call(this),
          ...
          constructor() {
            super(...arguments),
              (this.hostClient = Qt()
                ...
                ? new Bt()
                : void 0),
              (this.communicateToHost = (e) => {
                var t, n, i, r, o, s;
                e.detail.type !== $t.SyncCoordinates &&
                  fn(`Notifying host apps to ${e.detail.type}`);
                try {
                  switch (e.detail.type) {
                    case $t.Close:
                      null === (t = this.hostClient) ||
                        void 0 === t ||
                        t.close();
                      break;
                    case $t.RefreshAuth:
                      null === (n = this.hostClient) ||
                        void 0 === n ||
                        n.refreshAuth();
                      break;
                    case $t.SignIn:
                      null === (i = this.hostClient) ||
                        void 0 === i ||
                        i.signIn(e.detail.data.dest);
                      break;
                    case $t.Share:
                      null === (r = this.hostClient) ||
                        void 0 === r ||
                        r.share(e.detail.data);
                      break;
                    case $t.SyncCoordinates:
                      null === (o = this.hostClient) ||
                        void 0 === o ||
                        o.syncCoordinates(e.detail.data);
                      break;
                    case $t.OpenProfile:
                      null === (s = this.hostClient) ||
                        void 0 === s ||
                        s.openProfile(e.detail.data);
                  }
                } catch (e) {
                  vn(`Error notifying host client: ${e}`);
                }
              });
          }
        }
          ...
          class t extends e {
            ...
            startTimer(e) {
              (this.startedAt = Date.now()),
                (this.expireAt = this.startedAt + t.INTERVAL * e),
                this.start();
            }
            updateTimer(e) {
              if (
            ...
            start() {
              ...
              const i = () => {
                ...
                this.notify(r),
                  (this.timeoutId =
                    0 !== r
                      ? window.setTimeout(i, Math.max(0, t.INTERVAL - e))
                      : 0);
              };
              this.timeoutId = window.setTimeout(i, t.INTERVAL);
            }
            notify(e) {
              this.dispatchEvent(g("tick-timer", { expireIn: e }));
            }
            getRemainingSeconds() {
              return Math.max(
                0,
                Math.round((this.expireAt - Date.now()) / t.INTERVAL)
              );
            }
          }
          return (t[Cl] = !0), (t.INTERVAL = 1e3), t;
        })(
          on(
            (function (e) {
              if (dn in e) return e;
              class t extends e {
                connectedCallback() {
                  ...
                  for (
                    let e = 0;
                    e < this.constructor._eventListeners.length;
                    e++
                  ) {
                    const t = this.constructor._eventListeners[e],
                      n = t.options.useShadowRoot ? this.shadowRoot : this;
                    t.options.useShadowRoot &&
                      t.options.shouldBindMethod &&
                      ((this[t.method] = this[t.method].bind(this)),
                      (t.options.shouldBindMethod = !1)),
                      n.addEventListener(t.event, this[t.method], t.useCapture);
                  }
                }
                disconnectedCallback() {
                  super.disconnectedCallback && super.disconnectedCallback();
              ...
              return (t[dn] = !0), (t._eventListeners = []), t;
            })(Ae)
          )
        )
      )
  ...
  let id = class extends nd {
    constructor() {
      super(),
        ...
        (this.syncValuesToURL = un(500, !1, () => {
          if (!history) return;
          const e = Ke.getState();
          if (!e.camera || !e.canvas) return;
          const t = new URL(location.href),
            { cx: n, cy: i, px: r } = al();
          t.searchParams.set(Ue.CX, `${n}`),
            t.searchParams.set(Ue.CY, `${i}`),
            t.searchParams.set(Ue.PX, `${r}`),
            history.replaceState({}, "", t.toString());
        })),
        (this.cleanSynchronizeConfigurationTimeout = () => {
          this.synchronizeConfigurationTimeout &&
            (clearTimeout(this.synchronizeConfigurationTimeout),
            (this.synchronizeConfigurationTimeout = void 0));
        }),
        (this.cleanReleaseSyncLockTimeout = () => {
          this.releaseSyncLockTimeout &&
            (clearTimeout(this.releaseSyncLockTimeout),
            (this.releaseSyncLockTimeout = void 0));
        }),
        (this.cleanRestoreAuthTimeout = () => {
          this.restoreAuthTimeout &&
            (clearTimeout(this.restoreAuthTimeout),
            (this.restoreAuthTimeout = void 0));
        }),
        (this.cleanReleaseAuthLockTimeout = () => {
          this.releaseAuthLockTimeout &&
            (clearTimeout(this.releaseAuthLockTimeout),
            (this.releaseAuthLockTimeout = void 0));
        }),
        (this.onEmbedHostMessage = (e) => {
          if (Wt() || xl(e.origin))
            if (e.data.type === zt.SetFullScreen)
              this.setFullScreen(e.data.state);
            else if (e.data.type === zt.InjectTelemetryDefaults) {
        ...
        (this.setFullScreen = (e) => {
          if (
            ...
            (this.helpModalOpen = !1),
              ...
              (this.showColorPicker = !1);
          else if (Ze.getState() && !this.isGameOver && Ze.getState()) {
            const e = { x: it.getState(), y: rt.getState() },
              t = ul(e);
        ...
        (this.onConfigurationUpdateMessage = async (e) => {
          var t;
          switch ((fn("Received configuration message", e), e.__typename)) {
            case vl.ConfigurationUpdate: {
              const n = i(e, ["__typename"]),
                { width: r, height: o } = ll(
                  n.canvasConfigurations,
                  n.canvasWidth,
                  n.canvasHeight
                );
              if (r === ut.getState() && o === lt.getState())
                ct.updateState(n),
                  this.isRestoringAfterInactive && this.expandCanvas(n);
              else if (Ye())
                if (r < ut.getState() || o < lt.getState())
                  this.shrinkCanvas(n);
                else {
                  ...
                  ct.updateState(
                    Object.assign(Object.assign({}, ct.getState()), e)
                  ),
                    this.scheduleCanvasExpansion(n),
                    this.isRestoringAfterInactive &&
                      this.expandCanvas(ct.getState());
                }
              else
                this.expandCanvas(n),
                  (null === (t = et.getState()) || void 0 === t
                    ? void 0
                    : t.readonlyMode) && yl.unsubscribeFromConfigUpdates();
              this.isRestoringAfterInactive &&
                (this.isRestoringAfterInactive = !1);
              break;
            }
            default:
              vn(
                `Unsupported message data received over configuration channel ${e.__typename}`
              );
          }
        }),
        (this.expandCanvas = async (e) => {
          ct.updateState(e),
            this.updateCanvasSize(e),
        ...
        (this.subscribeToCanvasUpdates = async (e) => {
          try {
            const t = e ? [e] : ct.getState().canvasConfigurations;
            await Promise.all(
              t.map((e) => yl.subscribeToCanvasUpdates(this.onCanvasMessage, e))
            );
          } catch (e) {
            const t = g("faceplate-alert", {
              level: b.error,
            ...
            vn("Error while expanding canvas", e), this.dispatchEvent(t);
          }
        }),
        (this.onCanvasMessage = async (e, t) => {
          var n, i, r;
          if ((fn("Received canvas message", t, e), this.canvas)) {
            switch (e.__typename) {
              case vl.FullFrame:
                if (
                  (this.drawCanvasImage(e.name, t),
                  (this.canvasStateById[t] = { isTainted: !1 }),
                  Ze.getState() && Je.getState())
                ) {
                  const e = { x: it.getState(), y: rt.getState() },
                    n = ul(e);
                  t === (null == n ? void 0 : n.index) && this.selectPixel(e);
                }
                (null === (n = et.getState()) || void 0 === n
                  ? void 0
                  : n.readonlyMode) && yl.unsubscribeFromCanvasUpdates(t),
              ...
              case vl.DiffFrame: {
                ...
                (n.previousDiffTimestamp = e.currentTimestamp),
                  this.drawCanvasImage(e.name, t);
                const s = pt.getState();
                s && s.timestamp > e.currentTimestamp
                  ? this.canvas.drawPixel(s)
                  : pt.updateState(null);
                break;
              }
              default:
                vn(
                  "Unsupported API message data received over canvas subscription",
                  e
                );
            }
            (null === (r = et.getState()) || void 0 === r
              ? void 0
              : r.readonlyMode) &&
              ct
                .getState()
                .canvasConfigurations.every(
                  (e) => this.canvasStateById[e.index]
                ) &&
              (yl.createReadonlyClient(),
              fn(
                "Websocket connection severed, reinstantiated w/ readonly client"
              ));
          }
        }),
        (this.drawCanvasImage = async (e, t) => {
          ...
          if (this.canvas && n)
            try {
              const t = await _l(e);
              this.canvas.drawImage({ image: t, x: n.dx, y: n.dy });
            } catch (e) {
              vn(e);
            }
        }),
        (this.onUpdateVisiblePixels = this._events.define(
          "update-visible-pixels",
          (e) => {
            ot.updateState(e.detail.px);
          }
        )),
          ...
          const { x: n, y: i } = e.detail,
            r =
              null === (t = this.canvas) || void 0 === t
                ? void 0
                : t.getPixelColor({ x: n, y: i });
          this.trackEvent(
            (({ x: e, y: t, color: n }) =>
              Zt(
                { source: en.HotPotato, action: tn.Click, noun: nn.Pixel },
        ...
        (this.onChangeZoom = this._events.define("change-zoom", (e) => {
          ...
          st.updateState(n),
            null === (t = this.camera) || void 0 === t || t.zoomIn(n);
        })),
        (this.onConfirmPixel = this._events.define(
          "confirm-pixel",
          async () => {
            var e, t;
            if (
            ...
            if (ht.getState())
              return (
                this.dispatchEvent(g("confirm-erase")), void this.cancelPixel()
              );
            if (
              !this.canvas ||
              !this.showColorPicker ||
              "number" != typeof this.selectedColor ||
              this.nextTileAvailableIn
            )
              return;
            const n = {
            ...
            this.canvas.drawPixel(n),
              pt.updateState(
                Object.assign(Object.assign({}, n), { timestamp: Date.now() })
              ),
              null === (t = this.camera) || void 0 === t || t.refreshTooltip(),
              this.trackEvent(
                (({ x: e, y: t, colorIndex: n }) =>
                  Zt(
                    { source: en.HotPotato, action: tn.Click, noun: nn.Submit },
                    {
                      action_info: {
                        setting_value: Et(n) || "",
                        reason: [e, t].join(","),
            ...
            const i = await yl.setPixel(n);
            if (i.type === ml.Success) {
              const { data: e } = i;
              (null == e ? void 0 : e.nextAvailablePixelTimestamp) &&
                this.startTimer(
                  Math.ceil((e.nextAvailablePixelTimestamp - Date.now()) / 1e3)
                );
              const t = pt.getState();
              t &&
                ...
                (this.showColorPicker = !1),
                (this.selectedColor = void 0);
            } else if (i.type === ml.PixelRateLimit) {
              const e = g("faceplate-alert", { level: b.warning, message: el });
              this.dispatchEvent(e),
                this.startTimer(
                  Math.ceil((i.nextAvailablePixelTimestamp - Date.now()) / 1e3)
                );
            } else this.handleFailedResponse(i), pt.updateState(null);
            this.isPlacingPixel = !1;
          }
        )),
        ...
        (this.onMoveCamera = this._events.define("move-camera", (e) => {
          if (ht.getState() && dt.getState().length) return;
          const t = ol(e.detail);
          it.updateState(t.x),
            rt.updateState(t.y),
            this.updateVisibleCanvasIndexListThrottled();
        })),
        (this.updateVisibleCanvasIndexList = () => {
          var e;
          const t =
            null === (e = this.camera) || void 0 === e
              ? void 0
              : e.getVisibilityRect();
          if (!t) return;
          const n = (function (e, t) {
            if (1 === t.canvasConfigurations.length)
              return [t.canvasConfigurations[0].index];
            const { width: n, height: i } = ll(
              t.canvasConfigurations,
              t.canvasWidth,
              t.canvasHeight
            );
            return dl(
          ...
          yl.toggleVisibleCanvasListSubscription(n);
        }),
        (this.updateVisibleCanvasIndexListThrottled = un(
          1e3,
          !1,
          this.updateVisibleCanvasIndexList
        )),
        (this.onMouseMove = this._events.define("mousemove", (e) => {
          var t;
          null === (t = this.cursor) ||
            void 0 === t ||
            t.move(e.clientX, e.clientY);
        })),
        (this.onFaceplateRequest = this._events.define(
          "faceplate-request",
          (e) => {
        ...
        (this.onRegisterCamera = this._events.define(
          "register-camera",
          async (e) => {
            this.camera = e.detail;
          }
        )),
        (this.onRegisterCanvas = this._events.define(
          "register-canvas",
          async (e) => {
            this.canvas = e.detail;
          }
        ...
        (this.onWebSocketConnection = (e) => {
          e.type === ml.Success
            ...
            : e.type === ml.GenericError &&
              this.haltAndAskToReload(
                "Failed to instantiate a connection to the Realtime API"
              );
        }),
        (this.onToggleZoomButton = this._events.define(
          "toggle-zoom-control",
          () => {
        ...
        (this.onToggleShareSheet = this._events.define(
          "toggle-share-sheet",
          (e) => {
            (this.isSharing = e.detail.isVisible),
              this.isSharing && (this.showColorPicker = !1);
          }
        )),
        (this.onToggleEraseTool = this._events.define(
          "toggle-admin-erase-tool",
          () => {
            const e = ht.getState();
            e && dt.updateState([]),
              e || this.dispatchEvent(g("cancel-pixel")),
              ht.updateState(!e);
          }
        )),
        (this.onConfirmErase = this._events.define("confirm-erase", () => {
          ...
          let { x: r, y: o } = e[1];
          t && ((r = n), (o = i));
          const s = dl({ x1: n, y1: i, x2: r, y2: o }, ct.getState());
          s
            ? (s.forEach(async (e) => {
                const t = await yl.setRect(
                ...
                t.type !== ml.Success && this.handleFailedResponse(t);
              }),
              this.trackEvent(
                ((e, t, n, i) =>
                  Zt(
              ...
              this.dispatchEvent(g("toggle-admin-erase-tool")))
            : vn("Failed to split the area into canvas rectangles");
        })),
        (this.onHostCommunication = this._events.define(
          "host-communication",
          this.communicateToHost
        )),
        (this.onApiError = this._events.define("api-error", (e) => {
          this.handleFailedResponse(e.detail);
        })),
        (this.onHelpButtonClick = () => {
          (this.helpModalOpen = !0),
            this.trackEvent(
              Zt({ source: en.HotPotato, action: tn.View, noun: nn.Tutorial })
            );
        }),
        this._setViewportCustomProperty(),
        vt(this, it),
        ...
        vt(this, Ke);
      const e = He();
      Je.updateState(e.fullscreen),
        Xe.updateState(CLIENT_CONFIG.USE_DEBUG || e.debug);
    }
    static get styles() {
      return Ve(
        `:host {
...
`
    ...
    _handleZooming() {
      ...
      if (e != this.pxRatio) {
        ...
        const t = g("faceplate-alert", {
          level: b.warning,
          message:
            "For the best experience 100% browser zoom is recommended, consider using our zoom tool instead.",
        });
        this.dispatchEvent(t);
      }
    }
    connectedCallback() {
      super.connectedCallback(),
        ...
        (this.setVHUnitInterval = window.setInterval(
          this._setViewportCustomProperty,
          1e3
        ));
    }
    firstUpdated(e) {
      this.user && et.updateState(this.user),
        nt.updateState(this.shouldZoomOut),
        super.firstUpdated(e);
    }
    update(e) {
      const t = [];
      try {
        e.has("showColorPicker") &&
          ...
          ((e.has("nextTileAvailableIn") &&
            ...
            (0 === e.get("nextTileAvailableIn") ||
              void 0 === e.get("nextTileAvailableIn"))) ||
            ((wl["close-pallette"].currentTime = 0),
            t.push(wl["close-pallette"].play()))),
          e.has("selectedPixel") &&
            this.selectedPixel !== e.get("selectedPixel") &&
            (this.nextTileAvailableIn > 0
              ? ((wl.invalid.currentTime = 0), t.push(wl.invalid.play()))
              : ((wl.highlight.currentTime = 0), t.push(wl.highlight.play()))),
          e.has("selectedColor") &&
            this.selectedColor !== e.get("selectedColor") &&
            void 0 !== this.selectedColor &&
            (this.nextTileAvailableIn > 0
              ? ((wl.invalid.currentTime = 0), t.push(wl.invalid.play()))
              : ((wl["select-color"].currentTime = 0),
                t.push(wl["select-color"].play()))),
          e.has("nextTileAvailableIn") &&
            (0 === this.nextTileAvailableIn &&
              1 === e.get("nextTileAvailableIn") &&
              t.push(wl["cooldown-end"].play()),
            this.nextTileAvailableIn > 0 &&
              (0 === e.get("nextTileAvailableIn") ||
                void 0 === e.get("nextTileAvailableIn")) &&
              t.push(wl["cooldown-start"].play()));
      } catch (e) {}
    ...
    initializeCamera() {
      ...
      const i = He();
      ot.updateState(null !== (e = i.px) && void 0 !== e ? e : ot.getState());
      const r = {
          x: null !== (t = i.cx) && void 0 !== t ? t : -1,
          y: null !== (n = i.cy) && void 0 !== n ? n : -1,
        },
        o = !hl(r);
      Ze.updateState(i.edit && o);
      const s = ol(o ? r : this.camera.getRandomCenter());
      it.updateState(s.x), rt.updateState(s.y), this.camera.initialize();
    }
    initializeCanvas() {
      var e;
    ...
    scheduleCanvasExpansion(e) {
      ...
      if (((this.nextCanvasConfig = e), this.synchronizeConfigurationTimeout))
        return;
      const t = Math.round(9e5 * Math.random());
      fn(`Scheduled a config update in ${t}ms`),
        (this.synchronizeConfigurationTimeout = window.setTimeout(async () => {
          (this.synchronizeConfigurationTimeout = void 0),
            this.nextCanvasConfig
              ? ((this.isSynchronizingConfiguration = !0),
                await this.updateComplete,
                this.expandCanvas(this.nextCanvasConfig))
              : vn(
                  "Should not happen: Missing canvas config when trying to apply a scheduled config"
                );
        }, t));
    }
    updateCanvasSize(e) {
      const { width: t, height: n } = ll(
        e.canvasConfigurations,
        e.canvasWidth,
        e.canvasHeight
      );
      ut.updateState(t), lt.updateState(n), this.initializeCanvas();
    }
    onActive() {
      Je.getState() && this.reactivateAfterInactive();
    }
    reactivateAfterInactive() {
      this.isRestoringAfterInactive &&
        !this.isGameOver &&
        (fn("Page active. Enable the connection"),
        (this.isRestoringAuthorization = !1),
        this.cleanRestoreAuthTimeout(),
        this.lockUIAndRefreshAuth());
    }
    onInactive() {
      fn("Page inactive. Destroy the connection"),
        this.isGameOver || (yl.destroy(), (this.isRestoringAfterInactive = !0));
    }
    async shrinkCanvas(e) {
      ...
      for (const e of ct.getState().canvasConfigurations)
        n.has(e.index) ||
          (delete this.canvasStateById[e.index],
          yl.unsubscribeFromCanvasUpdates(e.index));
      this.updateCanvasSize(e), ct.updateState(e);
      const i = ol({ x: it.getState(), y: rt.getState() });
      (i.x === it.getState() && i.y === rt.getState()) ||
        (it.updateState(i.x),
        rt.updateState(i.y),
        null === (t = this.camera) || void 0 === t || t.initialize()),
        this.releaseSyncLock();
    }
    releaseSyncLock() {
      var e;
      ct.getState()
        ? (null === (e = ct.getState()) || void 0 === e
            ? void 0
            : e.canvasConfigurations.find(
                (e) =>
                  !this.canvasStateById[e.index] ||
                  this.canvasStateById.isTainted
              )) ||
          this.releaseSyncLockTimeout ||
        ...
        : vn(
            "Should not happen: Missing global config when trying to release the lock"
          );
    }
    getCanvasConfig(e) {
      const t = ct.getState();
      return null == t
        ? void 0
        : t.canvasConfigurations.find((t) => t.index === e);
    }
    cancelPixel() {
      (this.showColorPicker = !1),
        (this.selectedColor = void 0),
        ht.getState() && dt.updateState([]);
    }
    selectPixel(e) {
      var t, n, i, r;
      if (!this.isSharing) {
        if (
          ...
          null === (n = this.camera) || void 0 === n || n.moveTo(e);
        else {
          const t = Math.max(st.getState(), Be.Optimal);
          st.updateState(t),
            null === (i = this.camera) || void 0 === i || i.moveTo(e, t);
        }
        if (ht.getState()) {
          return 2 === dt.getState().length
            ? void (this.showColorPicker = !0)
            : void dt.updateState([e]);
        }
        (this.selectedPixel = e),
          (null === (r = et.getState()) || void 0 === r
            ? void 0
            : r.readonlyMode) || (this.showColorPicker = !0);
      }
    }
    ...
    handleFailedResponse(e) {
      if (e.type === ml.UnauthorizedError) this.lockUIAndRefreshAuth();
      else if (e.type === ml.PixelRateLimit)
        this.startTimer(
          Math.ceil((e.nextAvailablePixelTimestamp - Date.now()) / 1e3)
        );
      else {
        const t = g("faceplate-alert", { level: b.error, message: e.message });
        this.dispatchEvent(t),
          e.type !== ml.GenericError &&
            vn(`Error while making an API request: ${e.message}`, e);
      }
    }
    async onUpdateAuthHeaders(e, t) {
      ...
      const i =
        ...
        ct
          .getState()
          .canvasConfigurations.every((e) => this.canvasStateById[e.index]) &&
        Ye();
      yl.setAuthHeaders(e, this.onWebSocketConnection, i);
      try {
        await Promise.all([
          yl.subscribeToConfigUpdates(this.onConfigurationUpdateMessage),
          this.fetchUserData(),
          this.initializeCooldownTimer(),
        ]);
      } catch (e) {
        const t = g("faceplate-alert", { level: b.error, message: e.message });
        vn("Error while updating auth headers", e), this.dispatchEvent(t);
      }
    }
    async fetchUserData() {
      if (!et.getState())
        try {
          const e = await yl.fetchUserData();
          e.type === ml.Success
            ? et.updateState(e.data)
            : this.handleFailedResponse(e);
        } catch (e) {
          vn("Error while fetching user data", e);
        }
    }
    async initializeCooldownTimer() {
      var e, t, n;
      if (!Ke.getState().cooldown) {
        if (
          null === (e = et.getState()) || void 0 === e
            ? void 0
            : e.canParticipate
          ...
          try {
            const e = await yl.getUserCooldown();
            if (e.type === ml.Success) {
              if (
                null === (t = e.data) || void 0 === t
                  ? void 0
                  : t.nextAvailablePixelTimestamp
              ) {
                const t =
                  ((null === (n = e.data) || void 0 === n
                    ? void 0
                    : n.nextAvailablePixelTimestamp) -
                    Date.now()) /
                  1e3;
                this.startTimer(t);
              }
            } else e.type !== ml.GenericError && this.handleFailedResponse(e);
          } catch (e) {
            vn("Error while fetching user cooldown", e);
          }
        Ke.updateState(
          Object.assign(Object.assign({}, Ke.getState()), { cooldown: !0 })
        );
      }
    }
    render() {
      ...
      const n = Ye(),
        ...
        o =
          null === (e = et.getState()) || void 0 === e
            ...
            : e.readonlyMode;
      return le` ${
        this.isAdminOverride && n && !r && i
          ? le`<mona-lisa-admin-controls></mona-lisa-admin-controls>`
          : ""
      } <div class="layout"> <mona-lisa-share-container ?is-safari="${
        this.isSafari
      }" ?is-sheet-open="${this.isSharing}"> <mona-lisa-camera ?is-ios="${
        this.isIOS
      }" ?is-safari="${this.isSafari}" ?is-show-color-picker="${
        this.showColorPicker
      }" ?show-pixel-history="${
        this.showPixelHistory
      }"> <mona-lisa-canvas ?is-ios="${this.isIOS}" ?is-safari="${
        this.isSafari
      }"></mona-lisa-canvas> ${
        i && !ht.getState()
          ? le` <mona-lisa-pixel-preview slot="pixel" color="${pn(
              this.selectedColor
            )}"></mona-lisa-pixel-preview> `
          : ""
      } ${
        ht.getState() &&
        (null === (t = dt.getState()) || void 0 === t ? void 0 : t.length)
          ? le`<mona-lisa-erasure-preview slot="pixel" color="${pn(
              this.selectedColor
            )}"></mona-lisa-erasure-preview>`
          : ""
      } </mona-lisa-camera> ${
        i
          ? le` <div class="top-shadow"></div> <div class="bottom-shadow"></div> <div class="top-controls"> ${
              this.isSharing
                ? ""
                : le`<mona-lisa-coordinates></mona-lisa-coordinates>`
            } ${
              this.isSharing
                ? ""
                : le`<mona-lisa-help-button @click="${this.onHelpButtonClick}"></mona-lisa-help-button>`
            } </div> `
          : ""
      } <div class="bottom-controls"> ${
        i ? le`<mona-lisa-share-button></mona-lisa-share-button>` : ""
      } ${
        o
          ? ""
          : le` <mona-lisa-status-pill next-tile-available-in="${pn(
        ...
        i
          ? le`<mona-lisa-zoom-button ?showzoomcontrol="${this.showZoomControl}"></mona-lisa-zoom-button> `
          : ""
      } </div> ${
        i && !o
          ? le` <mona-lisa-color-picker color="${pn(
              this.selectedColor
            )}" ?is-visible="${this.showColorPicker}" ?is-locked="${
              this.isPlacingPixel || !!this.nextTileAvailableIn
            }" next-tile-available-in="${pn(
              this.nextTileAvailableIn
            )}"></mona-lisa-color-picker> `
          : ""
      } </mona-lisa-share-container> </div> <mona-lisa-modal name="${
        this.helpModalName
      }" header="Place" ?isOpen="${this.helpModalOpen}" ?show-help-link="${
        this.showHelpLink
      }"> <div class="help-modal"> <p> There is an empty canvas. </p> <p> You may place a tile upon it, but you must wait to place another. </p> <p> Individually you can create something. </p> <p> Together you can create something more. </p> </div> </mona-lisa-modal> <faceplate-perfmark name="${
        mn.FIRST_CONTENTFUL_PAINT
      }"></faceplate-perfmark> ${
        n
          ? le` <faceplate-perfmark name="${mn.FIRST_MEANINGFUL_PAINT}"></faceplate-perfmark> `
          : ""
      } <slot></slot> <mona-lisa-overlay type="${pn(
        (this.isGameOver && En.GameOver) ||
          (!n && En.Init) ||
          (this.isSynchronizingConfiguration && En.Sync) ||
          (this.isRestoringAuthorization && En.Auth) ||
          void 0
      )}"></mona-lisa-overlay> ${
        i && !this.isSharing
          ? le`<mona-lisa-close-button></mona-lisa-close-button>`
          : ""
      } `;
    }
  };
  r([u({ type: Boolean, attribute: "is-ios" })], id.prototype, "isIOS", void 0),
    r(
      [u({ type: Boolean, attribute: "is-safari" })],
      id.prototype,
      "isSafari",
    ...
    r(
      [u({ type: Boolean, attribute: "is-admin-override" })],
      id.prototype,
      "isAdminOverride",
      void 0
    ),
    ...
    r(
      [u({ type: Boolean, attribute: "game-over-on-error" })],
      id.prototype,
      "shouldGameOverOnError",
      void 0
    ),
    r(
      [u({ type: Boolean, attribute: "should-zoom-out" })],
      id.prototype,
      "shouldZoomOut",
      void 0
    ),
    r([u({ type: Object })], id.prototype, "user", void 0),
    r([h()], id.prototype, "selectedColor", void 0),
    r([h()], id.prototype, "nextTileAvailableIn", void 0),
    r([h()], id.prototype, "selectedPixel", void 0),
    r([h()], id.prototype, "showZoomControl", void 0),
    r([h()], id.prototype, "isSharing", void 0),
    r([h()], id.prototype, "canvasStateById", void 0),
    r([h()], id.prototype, "isPlacingPixel", void 0),
    r([h()], id.prototype, "showColorPicker", void 0),
    r([h()], id.prototype, "helpModalOpen", void 0),
    r([h()], id.prototype, "isSynchronizingConfiguration", void 0),
    r([h()], id.prototype, "isRestoringAuthorization", void 0),
    r([h()], id.prototype, "isRestoringAfterInactive", void 0),
    r([h()], id.prototype, "isGameOver", void 0),
    (id = r([c("mona-lisa-embed")], id));
  //# sourceMappingURL=index-ac109d6f.js.map
}
/*
     FILE ARCHIVED ON 18:24:00 Apr 04, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 04:14:10 Aug 21, 2022.
...
/*
playback timings (ms):
  captures_list: 188.101
  exclusion.robots: 116.906
  exclusion.robots.policy: 116.896
  xauthn.identify: 73.015
  xauthn.chkprivs: 43.654
  RedisCDXSource: 0.991
  esindex: 0.01
  LoadShardBlock: 50.683 (3)
  PetaboxLoader3.datanode: 87.86 (4)
  CDXLines.iter: 17.065 (3)
  load_resource: 85.615
  PetaboxLoader3.resolve: 29.788
*/
